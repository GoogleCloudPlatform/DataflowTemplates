...
/** Unit tests for {@link PubSubToSentinel}. */
public class PubsubToSentinelTest {
  ...
  public void testStringPubsubMessage() {
    ...
    String formattedPubsubMessage = PubSubToSentinel.formatPubsubMessage(pubsubMessage);

    assertThat(formattedPubsubMessage).contains(PubSubToSentinel.PUBSUB_MESSAGE_DATA_FIELD);
    assertThat(formattedPubsubMessage).contains(PubSubToSentinel.PUBSUB_MESSAGE_ATTRIBUTE_FIELD);

    JsonObject messageJson = GSON.fromJson(formattedPubsubMessage, JsonObject.class);
    assertThat(messageJson.get(PubSubToSentinel.PUBSUB_MESSAGE_DATA_FIELD).getAsString())
        .isEqualTo(payload);
  }
  ...
  public void testJsonPubsubMessage() {
    ...
    JsonObject messageJson = GSON.fromJson(formattedPubsubMessage, JsonObject.class);
    assertThat(messageJson.getAsJsonObject(PubSubToSentinel.PUBSUB_MESSAGE_DATA_FIELD).toString())
        .isEqualTo(payload);
  }
  ...
  public void testPubsubMessageWithComplexAttributes() {
    ...
    JsonObject attributesJson =
        messageJson.getAsJsonObject(PubSubToSentinel.PUBSUB_MESSAGE_ATTRIBUTE_FIELD);

...
public class PubsubToBigQueryTest {
  ...
  /**
   * Tests {@link PubSubToBigQuery#getDeadletterTableSchemaJson()} successfully retrieves the schema
   * JSON file from the resources directory.
   */
  @Test
  public void testGetDeadletterTableSchemaJson() {
    // Retrieve the schema JSON.
    String schemaJSON = PubSubToBigQuery.getDeadletterTableSchemaJson();

...
/**
 * Tests import of avro files (not exported from Cloud Spanner).
 */
public class ImportFromAvroTest {
  ...
  private void runTest(Schema schema, String spannerSchema, List<GenericRecord> records)
    ...
    Files.write(JsonFormat.printer().print(exportProto), new File(tmpDir + "/spanner-export.json"),
        Charsets.UTF_8);
    ...
    importPipeline.apply("Import", new ImportTransform(
        sourceConfig, ValueProvider.StaticValueProvider.of(tmpDir),

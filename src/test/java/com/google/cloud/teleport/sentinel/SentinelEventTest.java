...
/** Unit tests for {@link SentinelEvent} class. */
public class SentinelEventTest {

  /** Test whether a {@link SentinelEvent} created via its builder can be compared correctly. */
  @Test

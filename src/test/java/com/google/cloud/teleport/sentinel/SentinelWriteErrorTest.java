...
/** Unit tests for {@link SentinelWriteError} class. */
public class SentinelWriteErrorTest {

  /** Test whether a {@link SentinelWriteError} created via its builder can be compared correctly. */
  @Test

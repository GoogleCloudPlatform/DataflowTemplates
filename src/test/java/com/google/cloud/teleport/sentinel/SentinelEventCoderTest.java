...
/** Unit tests for {@link com.google.cloud.teleport.sentinel.SentinelEventCoder} class. */
public class SentinelEventCoderTest {

  /**
   * Test whether {@link SentinelEventCoder} is able to encode/decode a {@link SentinelEvent} correctly.
   *
   * @throws IOException
   */
  @Test
  ...
  /**
   * Test whether {@link SentinelEventCoder} is able to encode/decode a {@link SentinelEvent} with
   * metadata 'fields'.
   *
   * @throws IOException
   */
  ...
  public void testEncodeDecodeFields() throws IOException {
    ...
    SentinelEvent actualEvent = SentinelEvent.newBuilder().withEvent(event).withFields(fields).build();
  ...
  /**
   * Tests whether {@link SentinelEventCoder} is able to decode a {@link SentinelEvent} encoded using
  ...
  public void testBackwardsCompatibility_canDecodeVersion1() throws IOException, DecoderException {
    ...
    SentinelEvent actualEvent = SentinelEventCoder.of().decode(fromHex(hex));

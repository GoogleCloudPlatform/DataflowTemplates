...
public class NewRelicConfigTest {
    ...
    public void shouldParseConfigurationCorrectly() {
        // Given
        final NewRelicPipelineOptions pipelineOptions = getPipelineOptions(SOME_LOGS_API_URL, SOME_LICENSE_KEY, SOME_BATCH_COUNT, SOME_PARALLELISM, SOME_USE_COMPRESSION, SOME_DISABLE_CERTIFICATE_VALIDATION);
    ...
    public void shouldUseCorrectDefaultValues() {
        // Given
        final NewRelicPipelineOptions pipelineOptions = getPipelineOptions(null, SOME_LICENSE_KEY, null, null, null, null);
    ...
    public void shouldThrowAnErrorIfLicenseKeyNotSpecified() {
        // Given
        final NewRelicPipelineOptions pipelineOptions = getPipelineOptions(null, null, null, null, null, null);

        // When - Then
        NewRelicConfig.fromPipelineOptions(pipelineOptions);
    }

    private static NewRelicPipelineOptions getPipelineOptions(final String logsApiUrl, final String licenseKey, final Integer batchCount, final Integer parallelism, final Boolean useCompression, final Boolean disableCertificateValidation) {

...
/**
 * A {@link org.apache.beam.sdk.coders.Coder} for {@link NewRelicLogRecord} objects. It allows
 * serializing and deserializing {@link NewRelicLogRecord} objects, which can then be transmitted
 * through a Beam pipeline using PCollection/PCollectionTuple objects.
 */
public class NewRelicLogRecordCoder extends AtomicCoder<NewRelicLogRecord> {
  ...
  private static final TypeDescriptor<NewRelicLogRecord> TYPE_DESCRIPTOR =
      new TypeDescriptor<NewRelicLogRecord>() {};
  ...
  @Override
  public void encode(final NewRelicLogRecord newRelicLogRecord, final OutputStream out)
      throws IOException {
  ...
  public void verifyDeterministic() throws NonDeterministicException {
    throw new NonDeterministicException(
        this, "NewRelicLogRecord can hold arbitrary instances, which may be non-deterministic.");
  }
}

...
public class NewRelicConfig {
  ...
  /**
   * Factory method to build a {@link NewRelicConfig} out of the supplied {@link NewRelicPipelineOptions}
   * supplied by the user. The method takes care of configuring the default values if the user provided
   * a null value for any of them.
   *

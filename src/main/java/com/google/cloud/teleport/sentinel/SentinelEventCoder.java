...
/** A {@link org.apache.beam.sdk.coders.Coder} for {@link SentinelEvent} objects. */
public class SentinelEventCoder extends AtomicCoder<SentinelEvent> {

    private static final SentinelEventCoder Sentinel_EVENT_CODER = new SentinelEventCoder();
  
    private static final TypeDescriptor<SentinelEvent> TYPE_DESCRIPTOR =
        new TypeDescriptor<SentinelEvent>() {};
    ...
    public static SentinelEventCoder of() {
      return Sentinel_EVENT_CODER;
    }
  
    @Override
    public void encode(SentinelEvent value, OutputStream out) throws CoderException, IOException {
      out.write(VERSION_3);
    ...
    @Override
    public SentinelEvent decode(InputStream in) throws CoderException, IOException {
      SentinelEvent.Builder builder = SentinelEvent.newBuilder();
    ...
    private void decodeWithVersion(int version, InputStream in, SentinelEvent.Builder builder)
        throws IOException {
    ...
    private void decodeVersion1or2(ByteArrayInputStream in, SentinelEvent.Builder builder)
        throws IOException {
    ...
    private void decodeCommonFields(InputStream in, SentinelEvent.Builder builder) throws IOException {
    ...
    @Override
    public TypeDescriptor<SentinelEvent> getEncodedTypeDescriptor() {
    ...
    public void verifyDeterministic() throws NonDeterministicException {
      throw new NonDeterministicException(
          this, "SentinelEvent can hold arbitrary instances, which may be non-deterministic.");
    }
  }

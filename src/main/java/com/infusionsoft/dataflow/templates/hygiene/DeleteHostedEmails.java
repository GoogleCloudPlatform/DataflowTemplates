    ...
    pipeline
        .apply("Find Emails", DatastoreIO.v1().read()
            ...
            .withLiteralGqlQuery(NestedValueProvider.of(options.getAccountId(),
                (SerializableFunction<String, String>) accountId -> String.format("SELECT __key__ FROM Email WHERE accountUid = '%s'", accountId))))

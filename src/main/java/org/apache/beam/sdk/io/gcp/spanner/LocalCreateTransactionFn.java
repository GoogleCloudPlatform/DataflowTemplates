...
class LocalCreateTransactionFn extends DoFn<Object, Transaction> {
  ...
  private final LocalSpannerIO.CreateTransaction config;

  LocalCreateTransactionFn(LocalSpannerIO.CreateTransaction config) {
    this.config = config;
  }
  ...
  public void setup() throws Exception {
    spannerAccessor = ExposedSpannerAccessor.create(config.getSpannerConfig());
  }

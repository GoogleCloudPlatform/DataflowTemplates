 ...
 * Apply {@link LocalSpannerIO#createTransaction()} transform, that lazily creates a transaction.
 * The result of this transformation can be passed to read operation using {@link

...
```shell
<#if flex>
  <#if spec.metadata.module! == "yaml" || spec.metadata.module! == "python">
    <#assign tf_path = spec.metadata.module!>
  <#else>
    <#assign tf_path = "v2/" + spec.metadata.module!>
  </#if>
<#else>
  <#assign tf_path = "v1">
</#if>
cd ${tf_path}/terraform/${spec.metadata.internalName}
terraform init
terraform apply
```

 ...
 * the License.
 */
package com.google.cloud.teleport.it.gcp.dlp;
...
public class DlpResourceManager implements ResourceManager {
   ...
   */
  public static DlpResourceManager.Builder builder(String project) {
    return new DlpResourceManager.Builder(project);
  }

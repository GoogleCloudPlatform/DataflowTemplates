...
import static com.google.cloud.teleport.it.gcp.artifacts.ArtifactUtils.createGcsClient;
import static com.google.cloud.teleport.it.gcp.artifacts.ArtifactUtils.getFullGcsPath;
...
import com.google.cloud.teleport.it.gcp.launcher.AbstractPipelineLauncher;
import com.google.cloud.teleport.it.gcp.launcher.PipelineLauncher;
...
import com.google.cloud.teleport.it.gcp.launcher.PipelineOperator;
import com.google.cloud.teleport.it.gcp.launcher.PipelineOperator.Config;
import com.google.cloud.teleport.it.utils.IORedirectUtil;
import com.google.cloud.teleport.it.utils.PipelineUtils;
...
public abstract class TemplateTestBase {
  ...
  protected AbstractPipelineLauncher launcher() {
  ...
  protected LaunchInfo launchTemplate(LaunchConfig.Builder options, boolean setupShutdownHook)
    ...
    AbstractPipelineLauncher pipelineLauncher = launcher();
  ...
  static class CancelJobShutdownHook implements Runnable {
    ...
    private final AbstractPipelineLauncher pipelineLauncher;
    private final LaunchInfo launchInfo;

    public CancelJobShutdownHook(AbstractPipelineLauncher pipelineLauncher, LaunchInfo launchInfo) {

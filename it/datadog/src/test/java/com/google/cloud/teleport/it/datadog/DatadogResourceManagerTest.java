...
public class DatadogResourceManagerTest {
  ...
  public void testGetEventsShouldThrowErrorWhenServiceClientFailsToExecuteRequest() {
    doThrow(SocketConnectionException.class).when(serviceClient).retrieveRecordedRequests(null);

    assertThrows(SocketConnectionException.class, () -> testManager.getEntries());
  }
  ...
  public void testGetEventsShouldReturnTrueIfDatadogDoesNotThrowAnyError() {
    ...
    when(serviceClient.retrieveRecordedRequests(null))

 ...
 *
 * <p>TODO - Remove when Beam 2.55 is released - https://github.com/apache/beam/pull/30200
 */
public class CustomSplunkResourceManager extends TestContainerResourceManager<SplunkContainer>
    implements ResourceManager {

  private static final Logger LOG = LoggerFactory.getLogger(CustomSplunkResourceManager.class);
  ...
  private CustomSplunkResourceManager(Builder builder) {
    this(
   ...
   * @param builder The CustomSplunkResourceManager.Builder to extract config info from.
  ...
  /** Builder for {@link CustomSplunkResourceManager}. */
  public static final class Builder
      extends TestContainerResourceManager.Builder<CustomSplunkResourceManager> {

...
class FileV1beta1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsInstancesService(base_api.BaseApiService):
    ...
    def Restore(self, request, global_params=None):
      r"""Restores an existing instance's file share from a backup. The instance's file share capacity will be set to the backup's capacity or the minimum capacity of the tier, whichever is larger.

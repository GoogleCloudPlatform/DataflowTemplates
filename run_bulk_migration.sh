...
export BUCKET_NAME=iamsandeep-bucket-ck-001
...
### Required
export SOURCE_CONFIG_URL="gs://${BUCKET_NAME}/shardConfig_ea_101_108.json"
export INSTANCE_ID=iamsandeep-test-instance
...
gcloud dataflow flex-template run "iamsandeep-sourcedb-to-spanner-flex-job-014" \
  --project "$PROJECT" \
  --region "$REGION" \

...
/** Integration test for {@link PostgreSQLToBigQuery} Flex template PostgreSQL_to_BigQuery. */
@Category(TemplateIntegrationTest.class)
@TemplateIntegrationTest(PostgreSQLToBigQuery.class)
@RunWith(JUnit4.class)
public class PostgreSQLToBigQueryIT extends TemplateTestBase {
  ...
  public void testPostgresToBigQueryBrand() throws IOException {
    ...
    LaunchConfig.Builder options =
        LaunchConfig.builder(testName, specPath)
            .addParameter("connectionURL", postgresResourceManager.getUri())

...
variable "javaScriptIsDeleteFnGcsPath" {
  type = string
  description = "Cloud Storage path to JavaScript UDF source for function that will determine if document should be deleted rather than inserted or updated, function should return string value "true" or "false"."
  default = ""
}

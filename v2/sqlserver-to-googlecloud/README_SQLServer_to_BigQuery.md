...
* **connectionURL**: The JDBC connection URL string. Can be passed in as a string that's Base64-encoded and then encrypted with a Cloud KMS key. For example, `jdbc:sqlserver://localhost;databaseName=sampledb`.

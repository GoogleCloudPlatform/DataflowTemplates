...
public class MergeStatementBuildingFnTest {
  ...
  void testFullMergeStatement() {
    ...
    assertThat(fullMergeStatement,
        containsString("WHEN MATCHED THEN UPDATE SET "
  ...
  private static final Schema TABLE_1_SCHEMA = Schema.of(
  ...
  private static final Schema TABLE_1_PK_SCHEMA = Schema.of(
      Schema.Field.of("team", Schema.FieldType.STRING));

  private static final Schema TABLE_2_SCHEMA = Schema.of(
  ...
  private static final Schema TABLE_2_PK_SCHEMA = Schema.of(
      Schema.Field.of("name", Schema.FieldType.STRING),
      Schema.Field.nullable("timestamp", Schema.FieldType.DATETIME));

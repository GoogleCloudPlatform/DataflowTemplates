...
variable "inputSubscriptions" {
  type        = string
  description = "Comma-separated list of Pub/Sub subscriptions where CDC data is available."

}

variable "changeLogDataset" {
  type        = string
  description = "Name of the BigQuery dataset where Staging / Change Log tables are to be kept."

}

variable "replicaDataset" {
  type        = string
  description = "Name of the BigQuery dataset where the Replica tables are to be kept."

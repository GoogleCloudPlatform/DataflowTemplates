...
variable "secretId1" {
  type = string
  description = "First Secret ID containing aws key id"
}

variable "secretId2" {
  type = string
  description = "Second Secret ID containing aws key id"
}
...
variable "kinesisDataStream" {
  type = string
  description = "Name of the Kinesis Data stream to read from. Enter the full name of the Kinesis Data stream"
}

variable "outputPubsubTopic" {
  type = string
...
resource "google_dataflow_flex_template_job" "generated" {
    ...
    parameters = {
        secretId1 = var.secretId1
        secretId2 = var.secretId2
        awsRegion = var.awsRegion
        awsDataFormat = var.awsDataFormat
        kinesisDataStream = var.kinesisDataStream
        outputPubsubTopic = var.outputPubsubTopic
    }

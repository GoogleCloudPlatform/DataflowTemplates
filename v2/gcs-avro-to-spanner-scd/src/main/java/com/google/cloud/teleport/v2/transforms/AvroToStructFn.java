...
public class AvroToStructFn extends SimpleFunction<GenericRecord, Struct> {
  ...
  public Struct apply(GenericRecord record) {
    ...
    avroSchema.getFields().forEach(field -> setStructField(record, field, structBuilder));
    return structBuilder.build();
  }

  static void setStructField(GenericRecord record, Field field, Struct.Builder structBuilder) {

Bigtable CDC to HBase Replicator Template
---
A streaming pipeline that replicates Bigtable change stream data to HBase.

:memo: This is a Google-provided template! Please
check [Provided templates documentation](https://cloud.google.com/dataflow/docs/guides/templates/provided-templates)
on how to use it without having to build from sources using [Create job from template](https://console.cloud.google.com/dataflow/createjob?template=bigtable-cdc-to-hbase).
...
[![Open in Cloud Shell](http://gstatic.com/cloudssh/images/open-btn.svg)](https://console.cloud.google.com/cloudshell/editor?cloudshell_git_repo=https%3A%2F%2Fgithub.com%2FGoogleCloudPlatform%2FDataflowTemplates.git&cloudshell_open_in_editor=/v2/bigtable-cdc-to-hbase/src/main/java/com/google/cloud/teleport/v2/templates/BigtableCdcToHbase.java)
...
```
Flex Template was staged! gs://<bucket-name>/templates/flex/bigtable-cdc-to-hbase
```
...
export TEMPLATE_SPEC_GCSPATH="gs://$BUCKET_NAME/templates/flex/bigtable-cdc-to-hbase"
...
gcloud dataflow flex-template run "bigtable-cdc-to-hbase-job" \
  --project "$PROJECT" \
  --region "$REGION" \
...
-DbucketName="$BUCKET_NAME" \
-Dregion="$REGION" \
-DjobName="bigtable-cdc-to-hbase-job" \
-DtemplateName="bigtable-cdc-to-hbase" \

    ...
    public static Map<String, Map<String, String>> getKafkaCredentialsFromVault(String secretStoreUrl, String token) {
        ...
        if (credentials != null) {
            ...
            if (credentials.has(USERNAME) && credentials.has(PASSWORD)) {
                ...
                LOG.warn("There are no username and/or password for Kafka in Vault." +
            ...
            try {
                ...
                LOG.warn("There is no enough information to configure SSL." +
                        "Trying to initiate an unsecure connection.", e);
            }
        }

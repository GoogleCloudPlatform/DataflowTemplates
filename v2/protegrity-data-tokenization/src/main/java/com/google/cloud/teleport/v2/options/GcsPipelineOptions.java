...
public interface GcsPipelineOptions extends PipelineOptions {
  ...
  @Default.Enum("JSON")
  IoFormats getInputGcsFileFormat();

  void setInputGcsFileFormat(IoFormats inputGcsFileFormat);

  @Description("File format of output files. Supported formats: JSON, CSV")
  @Default.Enum("JSON")
  IoFormats getOutputGcsFileFormat();

  void setOutputGcsFileFormat(IoFormats outputGcsFileFormat);

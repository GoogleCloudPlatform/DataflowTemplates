...
public class MongoDbUtils implements Serializable{
     ...
     * */
    public static TableRow generateTableRow(HashMap<String, Object> document, String userOption){
        TableRow row = new TableRow();
        if(userOption != "FLATTEN"){

            String source_data = document.toString();
            DateTimeFormatter time_format = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.SSS");
            LocalDateTime localdate = LocalDateTime.now(ZoneId.of("UTC"));

            row
                    .set("id",document.get("_id").toString())

...
/** Integration test for {@link OracleToBigQuery} Flex template Oracle_to_BigQuery. */
@Category(TemplateIntegrationTest.class)
@TemplateIntegrationTest(OracleToBigQuery.class)
@RunWith(JUnit4.class)
public class OracleToBigQueryIT extends TemplateTestBase {
  private static final Logger LOG = LoggerFactory.getLogger(OracleToBigQueryIT.class);
  ...
  @Test
  public void testOracleToBigQueryDedicated() throws IOException {
    ...
    oracleResourceManager.createTable(testName, schema);
    oracleResourceManager.write(testName, jdbcData);
    ...
    LaunchConfig.Builder options =
        LaunchConfig.builder(testName, specPath)
            .addParameter("connectionURL", oracleResourceManager.getUri())

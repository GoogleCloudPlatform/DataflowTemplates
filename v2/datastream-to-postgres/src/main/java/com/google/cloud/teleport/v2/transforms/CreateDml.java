...
public class CreateDml {
  ...
  public static CreateDmlFromRecord createDmlObjects(DataSourceConfiguration dataSourceConfiguration) {
  ...
  public static class CreateDmlFromRecord
      extends PTransform<PCollection<FailsafeElement<String, String>>, PCollection<KV<String, DmlInfo>>> {
    ...
    @Override
    public PCollection<KV<String, DmlInfo>> expand(PCollection<FailsafeElement<String, String>> input) {
      ...
      return input
          ...
          .apply("Format to Postgres DML",
            MapElements.into(
                TypeDescriptors.kvs(
                    TypeDescriptors.strings(),
                    TypeDescriptor.of(DmlInfo.class)))

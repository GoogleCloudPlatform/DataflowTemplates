            ...
            .withFormatFunction(
                r ->
                    new TableRow()
                        ...
                        .set(MismatchedRecord.SPANNER_RECORD_KEY_COLUMN_NAME, r.getSpannerRecordKey())
                        .set(MismatchedRecord.SOURCE_RECORD_KEY_COLUMN_NAME, r.getSourceRecordKey())
                ...
                .via(
                    r ->
                        MismatchedRecord.builder()
                            ...
                            .setSpannerRecordKey(formatRecordKey(r.getPrimaryKeyColumns()))
                            .setSourceRecordKey(formatRecordKey(r.getSourcePrimaryKeyColumns()))

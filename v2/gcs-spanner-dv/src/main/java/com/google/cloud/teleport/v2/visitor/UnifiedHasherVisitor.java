...
public class UnifiedHasherVisitor implements IUnifiedVisitor {
  ...
  public void visitString(String s) {
    //String values are encoded with a sentinel byte 1 followed by the length of the string and the string itself
    //This is done to avoid collisions with empty strings, null values and string concatenation across columns.
    markNonNull();
  ...
  public void visitDefault(Value v) {
    //Values which are not supported are encoded with a sentinel byte 1 followed by the value as a string

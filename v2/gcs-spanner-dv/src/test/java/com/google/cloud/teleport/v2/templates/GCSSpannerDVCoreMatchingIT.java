...
//   }
  ...
  public void validationTestWithConfiguredTables() throws Exception {
    GCSSpannerDVAvroSetupHelper.TableDef usersTableDef =
    ...
    LaunchInfo jobInfo =
        launchDataflowJob(
            ...
            null,
            null,
            "[{Users_ConfiguredTables.full_name, Users_ConfiguredTables.user_name}]",
            null,
            java.util.Map.of("tables", "Users_ConfiguredTables"));

...
public class GCSSpannerDVCoreMatchingIT extends GCSSpannerDVITBase {
  ...
  //   /**
  //    * Validates core multi-table matching logic across both healthy and unhealthy tables. Tests
  // all
  //    * fundamental validation scenarios (exactly matching, missing in source, missing in
  // destination,
  //    * and value mismatches) and asserts that the resulting metrics are correctly rolled up into
  // the
  //    * BigQuery tables.
  //    */
  //   @Test
  ...
  //   /**
  //    * Validates the pipeline's handling of duplicate source records in Avro, covering two edge
  // cases:
  //    *
  //    * <ul>
  ...
  //                 /* matchedRowCount= */ 0L,
  //                 /* mismatchRowCount= */ 2L),
  //             // TODO: @aasthabharill investigate a better way to report this as
  // destinationRowCount
  //             // is actually 1.
  //             new TableValidationStatsDto(
  //                 /* schemaName= */ null,

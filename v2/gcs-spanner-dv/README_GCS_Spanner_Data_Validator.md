...
* **tableListFilePath**: A GCS file path containing a list of source tables to validate, with one table name per line. For example, `gs://your-bucket/tables.txt`. Defaults to empty.

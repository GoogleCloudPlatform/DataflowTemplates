...
3. **Manifest File Path:** `v2/gcs-spanner-dv/src/test/manifest.yaml`.
4. **Target Template Path:** `v2/gcs-spanner-dv`
5. **Datatype Test Scenarios:** `dv-datatypes-googlesql`, `dv-datatypes-pgsql`

...
variable "astraToken" {
  type        = string
  description = "The token value or secret resource ID. (Example: AstraCS:abcdefghij)"

}

variable "astraDatabaseId" {
  type        = string
  description = "The database unique identifier (UUID). (Example: cf7af129-d33a-498f-ad06-d97a6ee6eb7)"
...
variable "astraTable" {
  type        = string
  description = "The name of the table inside of the Cassandra database. (Example: my_table)"
...
resource "google_dataflow_flex_template_job" "generated" {
  ...
  parameters = {
    astraToken          = var.astraToken
    astraDatabaseId     = var.astraDatabaseId
    astraKeyspace       = var.astraKeyspace
    astraTable          = var.astraTable
    astraQuery          = var.astraQuery
    astraDatabaseRegion = var.astraDatabaseRegion
    minTokenRangesCount = tostring(var.minTokenRangesCount)

...
jobs = [
  {
    ...
    sourceConfigURL = "jdbc:mysql://127.0.0.1/my-db?autoReconnect=true&maxReconnects=10&unicode=true&characterEncoding=UTF-8"
    username        = "your-db-username"
    password        = "your-db-password"
    outputDirectory = "gs://your-dlq-bucket/dlq1"
    max_workers     = 2
    num_workers     = 2
  },
  {
    ...
    username        = "your-db-username"
    password        = "your-db-password"
    outputDirectory = "gs://your-dlq-bucket/dlq2"
    max_workers     = 2
    num_workers     = 2
  },
]

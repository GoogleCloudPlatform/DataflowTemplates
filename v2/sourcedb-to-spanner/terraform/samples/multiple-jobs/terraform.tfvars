...
jobs = [
  {
    ...
    sourceConfigURL       = "jdbc:mysql://127.0.0.1:3306/my-db?autoReconnect=true&maxReconnects=10&unicode=true&characterEncoding=UTF-8"
    username              = "your-db-username"
    password              = "your-db-password"
    tables                = "table1,table2"
    numPartitions         = 200
    maxConnections        = 50
    outputDirectory       = "gs://your-dlq-bucket/job1-dlq"
  ...
  },
  {
    instanceId            = "your-spanner-instance-id"
    databaseId            = "your-spanner-database-id"
    sourceConfigURL       = "jdbc:mysql://another-db-host:3306/different-db"
    username              = "another-username"
    password              = "another-password"
    tables                = "table1,table2"
    numPartitions         = 200
    maxConnections        = 25
    outputDirectory       = "gs://your-dlq-bucket/job2-dlq"

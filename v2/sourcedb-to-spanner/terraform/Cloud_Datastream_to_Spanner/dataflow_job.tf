...
variable "inputFilePattern" {
  type        = string
  description = "The Cloud Storage file location that contains the Datastream files to replicate. Typically, this is the root path for a stream. Support for this feature has been disabled."
  default     = null
}

variable "inputFileFormat" {
  type        = string
  description = "The format of the output file produced by Datastream. For example `avro,json`. Default, `avro`."
  default     = null
}
...
variable "transformationJarPath" {
  type        = string
  description = "Custom jar location in Cloud Storage that contains the custom transformation logic for processing records in forward migration. Defaults to empty."
  default     = null
}

...
/** Tests of {@link LocalCassandraIO}. */
@RunWith(JUnit4.class)
@SuppressWarnings({
  "rawtypes", // TODO(https://github.com/apache/beam/issues/20447)
})
public class LocalCassandraIOTest implements Serializable {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(LocalCassandraIOTest.class);
  ...
  /**
   * Setup Function for {@link LocalCassandraIOTest}.
  ...
  public static void beforeClass() throws Exception {
    embeddedCassandra = new EmbeddedCassandra("/CassandraUT/beamUTConfig.yaml", null);
    ...
    session = LocalCassandraIOTest.cluster.newSession();
    insertData();
  }
  ...
  */
  ...
  public void testWrapAroundRingRanges() throws Exception {
    PCollection<SimpleData> simpledataPCollection =
        pipeline.apply(
            LocalCassandraIO.<SimpleData>read()
  ...
  public void testRead() throws Exception {
    PCollection<Scientist> output =
        pipeline.apply(
            LocalCassandraIO.<Scientist>read()
                .withHosts(Collections.singletonList(cassandraHost))
                .withPort(cassandraPort)
                .withKeyspace(CASSANDRA_KEYSPACE)
  ...
  private LocalCassandraIO.Read<Scientist> getReadWithQuery(String query) {
    return LocalCassandraIO.<Scientist>read()
        .withHosts(Collections.singletonList(cassandraHost))
        .withPort(cassandraPort)
        .withQuery(query)
  ...
  public void testReadAllQuery() {
    ...
    PCollection<Scientist> output =
        pipeline
            ...
            .apply(
                LocalCassandraIO.<Scientist>readAll().withCoder(SerializableCoder.of(Scientist.class)));
  ...
  public void testWrite() {
    ...
    pipeline
        ...
        .apply(
            LocalCassandraIO.<ScientistWrite>write()
                .withHosts(Collections.singletonList(cassandraHost))
                .withPort(cassandraPort)
                .withKeyspace(CASSANDRA_KEYSPACE)
  ...
  public void testCustomMapperImplDelete() {
    ...
    pipeline
        .apply(Create.of(""))
        .apply(
            LocalCassandraIO.<String>delete()
                .withHosts(Collections.singletonList(cassandraHost))
                .withPort(cassandraPort)
                .withKeyspace(CASSANDRA_KEYSPACE)
                .withMapperFactoryFn(factory)
  ...
  public void testDelete() throws Exception {
    ...
    pipeline
        ...
        .apply(
            LocalCassandraIO.<Scientist>delete()
                .withHosts(Collections.singletonList(cassandraHost))
                .withPort(cassandraPort)
                .withKeyspace(CASSANDRA_KEYSPACE)
                .withEntity(Scientist.class));

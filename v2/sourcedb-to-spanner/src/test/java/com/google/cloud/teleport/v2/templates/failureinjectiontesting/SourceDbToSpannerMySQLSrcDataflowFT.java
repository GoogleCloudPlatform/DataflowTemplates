...
/**
 * A failure injection test for the SourceDB to Spanner template. This test simulates a Dataflow
 * worker failure scenario to ensure the pipeline remains resilient and processes all data.
 */
@Category({TemplateIntegrationTest.class, SkipDirectRunnerTest.class})
@TemplateIntegrationTest(SourceDbToSpanner.class)
@RunWith(JUnit4.class)
public class SourceDbToSpannerMySQLSrcDataflowFT extends SourceDbToSpannerFTBase {

  private static final Logger LOG =
      LoggerFactory.getLogger(SourceDbToSpannerMySQLSrcDataflowFT.class);
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    MySQLSrcDataProvider.writeAuthorRowsInSourceDB(1, 1, sourceDBResourceManager);
    MySQLSrcDataProvider.writeBookRowsInSourceDB(1, 20000, 1, sourceDBResourceManager);

 ...
 * types migration to a Google Standard SQL dialect Spanner instance.
 */
...
public class SQLServerDataTypesIT extends SourceDbToSpannerITBase {
  ...
  private static final String SQLSERVER_DUMP_FILE_RESOURCE =
      "sqlserver/SQLServerDataTypesIT/sqlserver-data-types.sql";

  private static final String SPANNER_DDL_RESOURCE =
      "sqlserver/SQLServerDataTypesIT/sqlserver-spanner-schema.sql";

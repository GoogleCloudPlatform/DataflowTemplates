...
public class CassandraAllDataTypesIT extends SourceDbToSpannerITBase {
      ...
      for (Struct row : rows) {
        ...
        columnNames.forEach(
            colName ->
                rowMapBuilder.put(
                    colName,
                    (row.getValue(colName) == null || row.isNull(colName))
                        ? "NULL"
                        :
  ...
  private Map<String, String> getAllDataTypeNullRow() {
    return ImmutableMap.<String, String>builder()
        .put("uuid_col", "NULL")
        .put("double_float_map_col", "NULL")
        .put("int_col", "NULL")
        .put("decimal_set_col", "NULL")
        .put("date_double_map_col", "NULL")
        .put("uuid_ascii_map_col", "NULL")
        .put("ascii_text_map_col", "NULL")
        .put("timestamp_list_col", "NULL")
        .put("date_col", "NULL")
        .put("int_set_col", "NULL")
        .put("blob_col", "NULL")
        .put("smallint_set_col", "NULL")
        .put("varchar_list_col", "NULL")
        .put("inet_list_col", "NULL")
        .put("bigint_list_col", "NULL")
        .put("tinyint_varint_map_col", "NULL")
        .put("text_set_col", "NULL")
        .put("double_set_col", "NULL")
        .put("time_list_col", "NULL")
        .put("frozen_ascii_list_col", "NULL")
        .put("int_list_col", "NULL")
        .put("ascii_list_col", "NULL")
        .put("date_set_col", "NULL")
        .put("double_inet_map_col", "NULL")
        .put("timestamp_set_col", "NULL")
        .put("ascii_col", "NULL")
        .put("time_tinyint_map_col", "NULL")
        .put("float_col", "NULL")
        .put("bigint_set_col", "NULL")
        .put("varchar_set_col", "NULL")
        .put("timestamp_col", "NULL")
        .put("tinyint_set_col", "NULL")
        .put("time_col", "NULL")
        .put("bigint_boolean_map_col", "NULL")
        .put("text_list_col", "NULL")
        .put("boolean_list_col", "NULL")
        .put("blob_list_col", "NULL")
        .put("timeuuid_set_col", "NULL")
        .put("int_time_map_col", "NULL")
        .put("timeuuid_col", "NULL")
        .put("time_set_col", "NULL")
        .put("boolean_set_col", "NULL")
        .put("bigint_col", "NULL")
        .put("float_set_col", "NULL")
        .put("boolean_col", "NULL")
        .put("ascii_set_col", "NULL")
        .put("uuid_list_col", "NULL")
        .put("varchar_bigint_map_col", "NULL")
        .put("blob_int_map_col", "NULL")
        .put("smallint_col", "NULL")
        .put("varint_blob_map_col", "NULL")
        .put("double_list_col", "NULL")
        .put("float_list_col", "NULL")
        .put("smallint_list_col", "NULL")
        .put("varint_list_col", "NULL")
        .put("text_col", "NULL")
        .put("float_smallint_map_col", "NULL")
        .put("smallint_timestamp_map_col", "NULL")
        .put("text_timeuuid_map_col", "NULL")
        .put("timeuuid_list_col", "NULL")
        .put("decimal_col", "NULL")
        .put("inet_col", "NULL")
        .put("date_list_col", "NULL")
        .put("varint_col", "NULL")
        .put("uuid_set_col", "NULL")
        .put("boolean_decimal_map_col", "NULL")
        .put("primary_key", "a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d")
        .put("blob_set_col", "NULL")
        .put("varchar_col", "NULL")
        .put("inet_text_map_col", "NULL")
        .put("varint_set_col", "NULL")
        .put("tinyint_list_col", "NULL")
        .put("timestamp_uuid_map_col", "NULL")
        .put("decimal_duration_map_col", "NULL")
        .put("tinyint_col", "NULL")
        .put("decimal_list_col", "NULL")
        .put("inet_set_col", "NULL")
        .put("timeuuid_varchar_map_col", "NULL")
        .put("duration_list_col", "NULL")
        .put("double_col", "NULL")
        .put("duration_col", "NULL")
        .put("frozen_ascii_set_col", "NULL")
        .build();
  }

  private Map<String, String> getAllDataTypeMinRow() {
    // Cassandra Driver treats empty collection as Null unless they are frozen.
    // https://github.com/doanduyhai/Achilles/issues/53#issuecomment-41468445
    return ImmutableMap.<String, String>builder()

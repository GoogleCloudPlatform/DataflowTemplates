 ...
 * types migration to Google Standard SQL dialect Spanner.
 */
@Category({TemplateIntegrationTest.class, SkipDirectRunnerTest.class})
@TemplateIntegrationTest(SourceDbToSpanner.class)
@RunWith(JUnit4.class)
public class SQLServerDataTypesIT extends SourceDbToSpannerITBase {
  private static final Logger LOG = LoggerFactory.getLogger(SQLServerDataTypesIT.class);
  ...
  private static final String SPANNER_DDL_RESOURCE = "DataTypesIT/sqlserver-spanner-schema.sql";
  ...
  private Map<String, List<Map<String, Object>>> getExpectedData() {
    ...
    expectedData.put(
        "money",
        createRows(
            "money", "-922337203685477.5808", "922337203685477.5807", "123.45", "0", "NULL"));
    expectedData.put(
        "money_to_float64",
        createRows(
            "money_to_float64",
    ...
    expectedData.put(
        "smallmoney",
        createRows("smallmoney", "-214748.3648", "214748.3647", "50.25", "0", "NULL"));
    expectedData.put(
    ...
    expectedData.put(
        "float_to_numeric",
        createRows(
            "float_to_numeric", "45.56", "123456789.123456", "-123456789.123456", "0", "NULL"));
    ...
    // TODO: Enable once Avro STRING to BYTES conversion is supported in AvroToValueMapper.
    // expectedData.put(
    //     "time_to_bytes",
    //     createRows(
    //         "time_to_bytes",
    ...
    // TODO: Enable once Avro STRING to BYTES conversion is supported in AvroToValueMapper.
    // expectedData.put(
    //     "text_to_bytes", createRows("text_to_bytes", "Cg==", "bG9uZyB0ZXh0IGNvbnRlbnQ=",
    // "NULL"));
    ...
    // TODO: Enable once ROWVERSION/TIMESTAMP dynamic value validation is supported.
    // expectedData.put("rowversion", createRows("rowversion", "placeholder1", "placeholder2"));
    // expectedData.put(
    //     "rowversion_to_bytes", createRows("rowversion_to_bytes", "placeholder1",
    // "placeholder2"));
    // expectedData.put(
    //     "rowversion_to_int64", createRows("rowversion_to_int64", "placeholder1",
    // "placeholder2"));

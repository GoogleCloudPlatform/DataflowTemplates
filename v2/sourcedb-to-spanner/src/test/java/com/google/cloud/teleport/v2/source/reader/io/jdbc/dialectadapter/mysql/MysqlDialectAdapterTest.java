...
public class MysqlDialectAdapterTest {
  ...
  public void testGetReadQuery() {
    ...
    assertThat(new MysqlDialectAdapter(MySqlVersion.DEFAULT).getReadQuery(testTable, cols))
        .isEqualTo(
            "select * from `testTable` WHERE ((? = FALSE) OR (`col_1` >= ? AND (`col_1` < ? OR "
                + "(? = TRUE AND `col_1` = ?)))) AND ((? = FALSE) OR (`col_2` >= ? AND (`col_2` < ? OR "
                + "(? = TRUE AND `col_2` = ?))))");
  }
  ...
  public void testGetCountQuery() {
    ...
    assertThat(
        ...
        .isEqualTo(
            "select /*+ MAX_EXECUTION_TIME(42) */ COUNT(*) from `testTable` WHERE ((? = FALSE) OR "
                + "(`col_1` >= ? AND (`col_1` < ? OR (? = TRUE AND `col_1` = ?)))) AND ((? = FALSE) OR "
                + "(`col_2` >= ? AND (`col_2` < ? OR (? = TRUE AND `col_2` = ?))))");
  }
  ...
  public void testGetBoundaryQuery() {
    ...
    assertThat(
        ...
        .isEqualTo(
            "select MIN(`col3`),MAX(`col3`) from `testTable` WHERE ((? = FALSE) OR "
                + "(`col_1` >= ? AND (`col_1` < ? OR (? = TRUE AND `col_1` = ?)))) AND ((? = FALSE) OR "
                + "(`col_2` >= ? AND (`col_2` < ? OR (? = TRUE AND `col_2` = ?))))");
  }

 ...
 * string-based overrides with a common schema, utilizing Oracle database.
 */
@Category({TemplateIntegrationTest.class, SkipDirectRunnerTest.class})
@TemplateIntegrationTest(SourceDbToSpanner.class)
@RunWith(JUnit4.class)
public class OracleStringOverridesSchemaMapperIT extends SourceDbToSpannerITBase {
  ...
  private static final String ORACLE_DDL_RESOURCE =
      "oracle/OracleStringOverridesSchemaMapperIT/oracle-schema.sql";
  private static final String SPANNER_DDL_RESOURCE =
      "oracle/OracleStringOverridesSchemaMapperIT/oracle-GOOGLE_STANDARD_SQL-spanner-schema.sql";

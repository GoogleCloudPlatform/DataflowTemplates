...
public class OracleSourceDbToSpannerWideRowMaxSizeTableKeyIT extends SourceDbToSpannerITBase {

  private static final String TABLE_NAME = "LargePrimaryKeyTable";
  private static final String ORACLE_DUMP_FILE_RESOURCE =
      "oracle/OracleSourceDbToSpannerWideRowMaxSizeTableKeyIT/oracle-schema.sql";

...
public class MySQLDataTypesIT extends SourceDbToSpannerITBase {
  ...
  public static void setUpClass() {
    mySQLResourceManager = setUpMySQLResourceManager(String.valueOf(MySQLDataTypesIT.class));
    spannerResourceManager = setUpSpannerResourceManager(String.valueOf(MySQLDataTypesIT.class));
  }

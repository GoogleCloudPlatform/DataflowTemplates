 ...
 * the License.
 */
package com.google.cloud.teleport.v2.source.jdbc.uniformsplitter.transforms;
...
import com.google.cloud.teleport.v2.source.jdbc.uniformsplitter.DataSourceProviderImpl;
import com.google.cloud.teleport.v2.source.jdbc.uniformsplitter.range.BoundarySplitterFactory;
import com.google.cloud.teleport.v2.source.jdbc.uniformsplitter.range.PartitionColumn;
import com.google.cloud.teleport.v2.source.jdbc.uniformsplitter.range.Range;
import com.google.cloud.teleport.v2.source.jdbc.uniformsplitter.range.TableIdentifier;
import com.google.cloud.teleport.v2.source.jdbc.uniformsplitter.range.TableReadSpecification;
import com.google.cloud.teleport.v2.source.jdbc.uniformsplitter.range.TableSplitSpecification;
import com.google.cloud.teleport.v2.source.jdbc.uniformsplitter.stringmapper.CollationReference;
import com.google.cloud.teleport.v2.source.mysql.dialectadapter.MysqlDialectAdapter;
import com.google.cloud.teleport.v2.source.mysql.dialectadapter.MysqlDialectAdapter.MySqlVersion;
...
public class ReadWithUniformPartitionsTest implements Serializable {
  ...
  public void testGetTransformName() {
    ReadWithUniformPartitions<String> readWithUniformPartitions =
        getReadWithUniformPartitionsForTest(100L, 10L, null, null, null, "test_table");
    String prefix = readWithUniformPartitions.transformPrefix();

    // 1. tableName is null, stageIdx is null.
    assertThat(readWithUniformPartitions.getTransformName("Type", null, null))
        .isEqualTo(prefix + ".Type");

    // 2. tableName is not null, stageIdx is null.
    assertThat(readWithUniformPartitions.getTransformName("Type", "TableX", null))
        .isEqualTo(prefix + ".Table.TableX.Type");

    // 3. tableName is null, stageIdx is not null.
    assertThat(readWithUniformPartitions.getTransformName("Type", null, 42L))
        .isEqualTo(prefix + ".Type.42");

    // 4. tableName is not null, stageIdx is not null.
    assertThat(readWithUniformPartitions.getTransformName("Type", "TableX", 42L))
        .isEqualTo(prefix + ".Table.TableX.Type.42");
  }
  ...
  public void testGetTransformNameWithCustomPrefix() {
    ...
    assertThat(readWithUniformPartitions.getTransformName("Type", "TableX", 42L))
        .isEqualTo("CustomPrefix.Table.TableX.Type.42");
  }
  ...
  public void testValidateParameters_emptyTableSplitSpecifications() {
    ...
    TableReadSpecification<String> readSpec =
        TableReadSpecification.<String>builder()
            ...
            .build();
    ReadWithUniformPartitions.Builder<String> builder =
        ReadWithUniformPartitions.<String>builder()
            .setTableSplitSpecifications(ImmutableList.of())
            .setTableReadSpecifications(ImmutableMap.of(tableIdentifier, readSpec));

    IllegalStateException exception =
        assertThrows(IllegalStateException.class, builder::validateParameters);
    assertThat(exception).hasMessageThat().contains("tableSplitSpecifications cannot be empty");
  }
  ...
  public void testValidateParameters_emptyTableReadSpecifications() {
    ...
    IllegalStateException exception =
        assertThrows(IllegalStateException.class, builder::validateParameters);
    assertThat(exception).hasMessageThat().contains("tableReadSpecifications cannot be empty");
  }
  ...
  public void testValidateParameters_sizeMismatch() {
    ...
    TableReadSpecification<String> readSpec2 =
        TableReadSpecification.<String>builder()
            .setTableIdentifier(tableIdentifier2)
            .setRowMapper(rs -> rs.getString(1))
            .build();
    ...
    ReadWithUniformPartitions.Builder<String> builder =
        ReadWithUniformPartitions.<String>builder()
            ...
            .setTableReadSpecifications(
                ImmutableMap.of(tableIdentifier1, readSpec1, tableIdentifier2, readSpec2));

    IllegalStateException exception =
        assertThrows(IllegalStateException.class, builder::validateParameters);
    assertThat(exception)
        .hasMessageThat()
        .contains("Size of tableSplitSpecifications and tableReadSpecifications must match");
  }
  ...
  public void testValidateParameters_valid() {
    ...
    builder.validateParameters(); // Should not throw
  }

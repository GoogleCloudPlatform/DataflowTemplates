...
public class OracleSourceDBToSpannerWideRowMaxColumnAndTableSizeIT extends SourceDbToSpannerITBase {
  ...
  private static final String ORACLE_DUMP_FILE_RESOURCE =
      "oracle/OracleSourceDBToSpannerWideRowMaxColumnAndTableSizeIT/oracle-schema.sql";
  private static final String SPANNER_SCHEMA_FILE_RESOURCE =
      "oracle/OracleSourceDBToSpannerWideRowMaxColumnAndTableSizeIT/oracle-spanner-schema.sql";
  ...
  public void wideRowMaxSizeString() throws Exception {
    ...
    // Increase timeout since wait is longer

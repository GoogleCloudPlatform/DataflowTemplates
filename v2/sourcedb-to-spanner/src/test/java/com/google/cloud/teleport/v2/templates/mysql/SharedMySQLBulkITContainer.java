...
public class SharedMySQLBulkITContainer {
  private static final Logger LOG = LoggerFactory.getLogger(SharedMySQLBulkITContainer.class);
  ...
  public static synchronized MySQLResourceManager createResourceManager(String testId) {
    if (singletonBase == null) {
      singletonBase = MySQLResourceManager.builder("mysql-bulk-base").build();

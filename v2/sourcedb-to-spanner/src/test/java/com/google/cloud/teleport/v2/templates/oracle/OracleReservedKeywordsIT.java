 ...
 * a simple schema with Oracle reserved keywords.
 */
@Category({TemplateIntegrationTest.class, SkipDirectRunnerTest.class})
@TemplateIntegrationTest(SourceDbToSpanner.class)
@RunWith(JUnit4.class)
public class OracleReservedKeywordsIT extends SourceDbToSpannerITBase {
  ...
  private static final String ORACLE_DDL_RESOURCE =
      "oracle/OracleReservedKeywordsIT/oracle-schema.sql";
  private static final String SPANNER_DDL_RESOURCE =
      "oracle/OracleReservedKeywordsIT/oracle-GOOGLE_STANDARD_SQL-spanner-schema.sql";
  ...
  public void reservedKeywordsTest() throws Exception {
    ...
    // Explicitly pass --jdbcDriverJars since this is Oracle

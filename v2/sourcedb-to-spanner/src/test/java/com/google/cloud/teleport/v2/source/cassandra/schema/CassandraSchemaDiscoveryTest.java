 ...
 * the License.
 */
package com.google.cloud.teleport.v2.source.cassandra.schema;

import static com.google.cloud.teleport.v2.source.cassandra.testutils.BasicTestSchema.BASIC_TEST_TABLE_SCHEMA;
import static com.google.cloud.teleport.v2.source.cassandra.testutils.BasicTestSchema.LIST_TEST_TABLE_SCHEMA;
import static com.google.cloud.teleport.v2.source.cassandra.testutils.BasicTestSchema.MAP_TEST_TABLE_SCHEMA;
import static com.google.cloud.teleport.v2.source.cassandra.testutils.BasicTestSchema.SET_TEST_TABLE_SCHEMA;
...
import static com.google.cloud.teleport.v2.source.cassandra.testutils.BasicTestSchema.TEST_TABLES;
...
import com.google.cloud.teleport.v2.source.jdbc.iowrapper.JdbcDataSource;
                ...
                CassandraDataSourceOss.builder()
                    ...
                    .setContactPoints(
                        sharedEmbeddedCassandra.getInstance().getContactPoints().stream()
                            .map(
                                addr ->
                                    new InetSocketAddress(addr.getAddress(), /* Reserved Port */ 0))

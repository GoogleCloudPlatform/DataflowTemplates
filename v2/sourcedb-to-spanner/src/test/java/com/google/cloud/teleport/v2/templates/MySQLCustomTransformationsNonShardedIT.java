...
public class MySQLCustomTransformationsNonShardedIT extends SourceDbToSpannerITBase {
  ...
  public static void setUpClass() {
    mySQLResourceManager =
        setUpMySQLResourceManager(String.valueOf(MySQLCustomTransformationsNonShardedIT.class));
    spannerResourceManager =
        setUpSpannerResourceManager(String.valueOf(MySQLCustomTransformationsNonShardedIT.class));
  }

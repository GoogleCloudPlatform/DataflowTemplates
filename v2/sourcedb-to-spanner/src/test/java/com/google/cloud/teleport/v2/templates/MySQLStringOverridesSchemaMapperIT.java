...
public class MySQLStringOverridesSchemaMapperIT extends SourceDbToSpannerITBase {
  ...
  public static void setUpClass() {
    mySQLResourceManager =
        setUpMySQLResourceManager(String.valueOf(MySQLStringOverridesSchemaMapperIT.class));
    spannerResourceManager =
        setUpSpannerResourceManager(String.valueOf(MySQLStringOverridesSchemaMapperIT.class));
  }

...
public class OracleIdentitySchemaMapperIT extends SourceDbToSpannerITBase {
  ...
  private static final String ORACLE_DDL_RESOURCE =
      "oracle/OracleIdentitySchemaMapperIT/oracle-schema.sql";
  private static final String SPANNER_DDL_RESOURCE =
      "oracle/OracleIdentitySchemaMapperIT/oracle-GOOGLE_STANDARD_SQL-spanner-schema.sql";
  ...
  @Test
  public void testOracleIdentitySchemaMapping() throws Exception {
    ...
    jobInfo =
        launchDataflowJob(
            ...
            Map.of("jdbcDriverJars", oracleDriverGCSPath()),
            null);

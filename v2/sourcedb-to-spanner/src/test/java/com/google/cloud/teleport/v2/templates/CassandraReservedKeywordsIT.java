...
public class CassandraReservedKeywordsIT extends SourceDbToSpannerITBase {
  private static PipelineLauncher.LaunchInfo jobInfo;

  public static CassandraResourceManager cassandraResourceManager;
  public static SpannerResourceManager spannerResourceManager;

  private static final String CASSANDRA_DDL_RESOURCE = "ReservedKeywordsIT/cassandra-schema.cql";
  ...
  public void reservedKeywordsTest() throws Exception {
    loadCQLFileResource(cassandraResourceManager, CASSANDRA_DDL_RESOURCE);

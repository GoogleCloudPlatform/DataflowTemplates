...
public class PostgreSQLDataTypesPGDialectIT extends SourceDbToSpannerITBase {
  ...
  private Map<String, List<Map<String, Object>>> getExpectedData() {
    ...
    result.put("decimal", createRows("decimal", "0.120000000", "NULL"));
    ...
    result.put(
        "json", createRows("json", "{\"duplicate_key\": 2}", "{\"null_key\": null}", "NULL"));
    result.put(
        "json_to_string",
        createRows(
            "json_to_string",
    ...
    result.put("numeric", createRows("numeric", "4.560000000", "NULL"));
    ...
    result.put("money_pk", createRows("money_pk", "-99999.99", "0.00", "99999.99"));

...
public class OracleSourceDBToSpannerWideRowMaxRowSizeIT extends SourceDbToSpannerITBase {
  ...
  private static final String ORACLE_SCHEMA_FILE_RESOURCE =
      "oracle/OracleSourceDBToSpannerWideRowMaxRowSizeIT/oracle-schema.sql";
  private static final String SPANNER_SCHEMA_FILE_RESOURCE =
      "oracle/OracleSourceDBToSpannerWideRowMaxRowSizeIT/oracle-spanner-schema.sql";
  private static final String PG_DIALECT_SPANNER_SCHEMA_FILE_RESOURCE =
      "oracle/OracleSourceDBToSpannerWideRowMaxRowSizeIT/oracle-pg-dialect-spanner-schema.sql";

  private static final String TABLE = "WideRowTable";

  @Before
  public void setUp() throws Exception {
    synchronized (OracleSourceDBToSpannerWideRowMaxRowSizeIT.class) {
      if (!initialized) {
      ...
      if (!dataLoaded) {
        loadOracleSQLFileResource(oracleResourceManager, ORACLE_SCHEMA_FILE_RESOURCE);
        dataLoaded = true;
      }
    }
  }
  ...
  public static void cleanUp() throws Exception {
    ResourceManagerUtils.cleanResources(
        oracleResourceManager, spannerResourceManager, pgDialectSpannerResourceManager);
  }
  ...
  public void wideRowMaxRowSizePGDialect() throws Exception {
    ...
    ImmutableList<Struct> wideRowData =
        pgDialectSpannerResourceManager.readTableRecords("WideRowTable", "id");
    SpannerAsserts.assertThatStructs(wideRowData).hasRows(1);
  }
}

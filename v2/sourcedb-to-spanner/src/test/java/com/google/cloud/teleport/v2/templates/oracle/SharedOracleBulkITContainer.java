...
public class SharedOracleBulkITContainer {
  private static final Logger LOG = LoggerFactory.getLogger(SharedOracleBulkITContainer.class);

  private static OracleResourceManager instance;

  public static synchronized OracleResourceManager getInstance() {
    if (instance == null) {
      instance = OracleResourceManager.builder("oracle-bulk-db").build();
      try {

  ...
  public void testBuildDataSource() {
    ...
    try (MockedStatic mockFileReader = mockStatic(JarFileReader.class)) {
      ...
      DataSource dataSource =
          CassandraIOWrapperHelper.buildDataSource(testGcsPath, null, CassandraDialect.OSS);
      ...
      assertThat(
              CassandraIOWrapperHelper.buildDataSource(testGcsPath, 42, CassandraDialect.OSS)
                  .cassandra()
                  .oss()
                  .numPartitions())
          .isEqualTo(42);

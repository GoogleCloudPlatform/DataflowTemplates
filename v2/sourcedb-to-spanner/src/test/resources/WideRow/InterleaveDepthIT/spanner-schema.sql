CREATE TABLE parent (
	...
	name STRING(255) NOT NULL , -- From: name varchar(255)
) PRIMARY KEY (id);

CREATE TABLE child1 (
	id INT64 NOT NULL ,         -- From: id int(10)
	parent_id INT64 NOT NULL ,  -- From: parent_id int(10)
	name STRING(255) NOT NULL , -- From: name varchar(255)
) PRIMARY KEY (id);
...
CREATE TABLE child2 (
	id INT64 NOT NULL ,         -- From: id int(10)
	child1_id INT64 NOT NULL ,  -- From: child1_id int(10)
	name STRING(255) NOT NULL , -- From: name varchar(255)
) PRIMARY KEY (id);
...
CREATE TABLE child3 (
	id INT64 NOT NULL ,         -- From: id int(10)
	child2_id INT64 NOT NULL ,  -- From: child2_id int(10)
	name STRING(255) NOT NULL , -- From: name varchar(255)
) PRIMARY KEY (id);
...
CREATE TABLE child4 (
	id INT64 NOT NULL ,         -- From: id int(10)
	child3_id INT64 NOT NULL ,  -- From: child3_id int(10)
	name STRING(255) NOT NULL , -- From: name varchar(255)
) PRIMARY KEY (id);
...
CREATE TABLE child5 (
	id INT64 NOT NULL ,         -- From: id int(10)
	child4_id INT64 NOT NULL ,  -- From: child4_id int(10)
	name STRING(255) NOT NULL , -- From: name varchar(255)
) PRIMARY KEY (id);
...
CREATE TABLE child6 (
	id INT64 NOT NULL ,         -- From: id int(10)
	child5_id INT64 NOT NULL ,  -- From: child5_id int(10)
	name STRING(255) NOT NULL , -- From: name varchar(255)
) PRIMARY KEY (id);
...
CREATE TABLE child7 (
	id INT64 NOT NULL ,         -- From: id int(10)
	child6_id INT64 NOT NULL ,  -- From: child6_id int(10)
	name STRING(255) NOT NULL , -- From: name varchar(255)
) PRIMARY KEY (id);

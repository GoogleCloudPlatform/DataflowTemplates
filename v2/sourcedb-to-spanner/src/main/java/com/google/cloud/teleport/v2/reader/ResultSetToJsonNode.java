    ...
    for (int i = 1; i <= metaData.getColumnCount(); i++) {
      ...
      switch (metaData.getColumnType(i)) {
        ...
        case Types.TIMESTAMP_WITH_TIMEZONE:
          ...
          // Replace spaces with T if any. JDBC returns 2 different formats for
          // java.sql.Types.Timestamp.
          // For mysql type Datetime, format is 1998-01-23T12:45:56 while for MySQL timestamp,
          // format is 2022-08-05 08:23:11.0.
        ...
        case Types.LONGVARBINARY:
          ...
          break;
        default:
          // TODO: Handle MySQL BIT correctly. BIT and other booleans have the same java.sql.Type
          // but the former should be read as bytes while the latter should be read as bools.

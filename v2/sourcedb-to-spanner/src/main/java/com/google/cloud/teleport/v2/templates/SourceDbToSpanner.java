...
public class SourceDbToSpanner {
  ...
  static PipelineResult run(SourceDbToSpannerOptions options) {
    ...
    ISourceConnector connector = SourceConnectorFactory.create(options);
    DbConfigContainer dbConfigContainer = connector.getDbConfigContainer(options);
    return PipelineController.executeMigration(options, pipeline, spannerConfig, dbConfigContainer);
  }

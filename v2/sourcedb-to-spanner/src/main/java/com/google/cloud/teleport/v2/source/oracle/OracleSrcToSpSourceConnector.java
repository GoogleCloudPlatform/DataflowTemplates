...
public class OracleSrcToSpSourceConnector extends AbstractJdbcSrcToSpSourceConnector {
  ...
  private static final ImmutableMap<String, UnifiedTypeMapping> MAPPING =
      ImmutableMap.<String, UnifiedMappingProvider.Type>builder()
          ...
          .put("ROWID", UnifiedMappingProvider.Type.STRING)
          .put("UROWID", UnifiedMappingProvider.Type.STRING)
          .put("BFILE", UnifiedMappingProvider.Type.BYTES)
          .put("LONG RAW", UnifiedMappingProvider.Type.BYTES)
          .put("LONG", UnifiedMappingProvider.Type.STRING)

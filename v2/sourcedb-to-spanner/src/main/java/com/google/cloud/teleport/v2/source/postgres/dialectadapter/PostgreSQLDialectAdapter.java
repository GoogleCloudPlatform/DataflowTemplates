 ...
 * the License.
 */
package com.google.cloud.teleport.v2.source.postgres.dialectadapter;

import static com.google.cloud.teleport.v2.source.jdbc.JdbcCommonConstants.UUID_TYPE;
import static com.google.cloud.teleport.v2.source.jdbc.dialectadapter.ResourceUtils.CHARSET_REPLACEMENT_TAG;
import static com.google.cloud.teleport.v2.source.jdbc.dialectadapter.ResourceUtils.COLLATION_REPLACEMENT_TAG;
import static com.google.cloud.teleport.v2.source.jdbc.dialectadapter.ResourceUtils.RETURN_TYPE_REPLACEMENT_TAG;
import static com.google.cloud.teleport.v2.source.jdbc.dialectadapter.ResourceUtils.replaceTagsAndSanitize;
import static com.google.cloud.teleport.v2.source.jdbc.dialectadapter.ResourceUtils.resourceAsString;
...
import com.google.cloud.teleport.v2.source.jdbc.uniformsplitter.stringmapper.CollationOrderRow;
...
public class PostgreSQLDialectAdapter implements DialectAdapter {
   ...
   *     com.google.cloud.teleport.v2.source.jdbc.uniformsplitter.transforms.ReadWithUniformPartitions

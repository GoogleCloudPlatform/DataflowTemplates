...
public abstract class TableReadSpecification<T> implements Serializable {
  ...
  /**
   * Default fetch-size if not set by caller. This is same as the single table reader's constant as
   * defined in @link{JdbcIO}
   */
  ...
  public static <T> Builder<T> builder() {
    return new AutoValue_TableReadSpecification.Builder<T>().setFetchSize(DEFAULT_FETCH_SIZE);
  }

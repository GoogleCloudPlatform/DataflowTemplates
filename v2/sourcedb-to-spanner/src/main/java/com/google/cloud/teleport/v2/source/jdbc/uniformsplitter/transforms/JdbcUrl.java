 ...
 *
 * <p>It extracts key components like scheme, host, port, and database name, which are essential for
 * accurate <b>Data Lineage Reporting</b>. By decomposing the JDBC URL, this class provides the
 * structured metadata required by the Apache Beam {@link org.apache.beam.sdk.metrics.Lineage} API
 * to track data provenance across the pipeline.
 *
 * <p>It supports various JDBC URL formats, including those for MySQL, PostgreSQL, Oracle, and
 * Derby.
 */
@AutoValue

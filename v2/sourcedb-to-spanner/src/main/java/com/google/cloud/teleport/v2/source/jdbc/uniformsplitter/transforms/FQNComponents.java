 ...
 * metadata.
 *
 * <p><b>Data Lineage Reporting</b>
 *
 * <p>These components are used to report accurate data lineage to the Dataflow service. Data
 * lineage is a feature that tracks the "provenance" or movement of data from its source to its
 * destination. By reporting lineage, Dataflow enables users to:
 *
 * <ul>
 *   <li><b>Audit Data Flow:</b> Understand exactly which source tables and databases contributed to
 *       the data in a specific destination.
 *   <li><b>Governance & Compliance:</b> Provide a verifiable record of data movement for regulatory
 *       requirements.
 *   <li><b>Troubleshooting:</b> Quickly identify the source of data quality issues by tracing data
 *       backwards through the pipeline.
 *   <li><b>Impact Analysis:</b> Understand which downstream systems will be affected by changes to
 *       a source schema.
 * </ul>
 *
 * <p>In the context of this template, lineage is reported using the Apache Beam {@code Lineage}
 * metrics API. This information is then surfaced in the Google Cloud Console under the "Lineage"
 * tab of the Dataflow job monitoring UI, and integrated with Google Cloud Dataplex for
 * organization-wide data governance.
 *
 * @see <a href="https://docs.cloud.google.com/dataplex/docs/about-data-lineage">About Data
 *     Lineage</a>
 * @see <a href="https://beam.apache.org/documentation/runtime/observability/#data-lineage">Apache
 *     Beam Data Lineage</a>
 */
@AutoValue

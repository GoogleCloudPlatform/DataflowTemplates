 ...
 */
@AutoValue
public abstract class CassandraDataSourceOss {
  /** Options Map. * */
  ...
  public static Builder builder() {
    return new AutoValue_CassandraDataSourceOss.Builder().setNumPartitions(null);
  }
  ...
  public abstract static class Builder {
    ...
    abstract CassandraDataSourceOss autoBuild();

    public CassandraDataSourceOss build() {
      return autoBuild();
    }
  }
}

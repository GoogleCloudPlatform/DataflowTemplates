...
public final class JdbcIoWrapper implements IoWrapper {
  ...
  static SourceSchema getSourceSchema(
    ...
    ImmutableMap<String, ImmutableList<SourceColumnIndexInfo>> tableIndexes = schemaDiscovery
        .discoverTableIndexes(dataSource, config.sourceSchemaReference(), tables);

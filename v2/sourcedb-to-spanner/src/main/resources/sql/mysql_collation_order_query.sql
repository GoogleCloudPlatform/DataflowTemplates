...
FROM (
    -- 4-byte codepoints: full enumeration of all 4-byte sequences.
    SELECT charset_char FROM (
        SELECT CONVERT(UNHEX(CONCAT(n1.n, n2.n, n3.n, n4.n, n5.n, n6.n, n7.n, n8.n)) USING charset_replacement_tag) AS charset_char
        FROM
            ...
            CROSS JOIN (SELECT '0' AS n UNION ALL SELECT '1' UNION ALL SELECT '2' UNION ALL SELECT '3' UNION ALL SELECT '4' UNION ALL SELECT '5' UNION ALL SELECT '6' UNION ALL SELECT '7' UNION ALL SELECT '8' UNION ALL SELECT '9' UNION ALL SELECT 'a' UNION ALL SELECT 'b' UNION ALL SELECT 'c' UNION ALL SELECT 'd' UNION ALL SELECT 'e' UNION ALL SELECT 'f') AS n7

...
public class DatastreamToDMLTest {
  ...
  /**
     * Test whether {@link DatastreamToPostgresDML#convertJsonToHstoreLiteral(String)}
    ...
    /**
     * Test whether {@link DatastreamToPostgresDML#getValueSql(JsonNode, String, Map)}
     * correctly handles null and empty JSON for HSTORE types.
     */
    @Test
    ...
    /**
     * Test whether {@link DatastreamToPostgresDML#getValueSql(JsonNode, String, Map)}
     * correctly handles a null value for LTREE types.
     */
    @Test
  ...
  public void testLtreeTypeCoercion_handlesNullString() {
    ...
    /**
     * Test whether {@link DatastreamToPostgresDML#getValueSql(JsonNode, String, Map)}
     * correctly handles ENUM types, treating empty strings as NULL.
     */
    @Test
  ...
  /**
     * Test whether {@link DatastreamToPostgresDML#getValueSql(JsonNode, String, Map)}
     * correctly handles a valid ENUM value.
     */
    @Test

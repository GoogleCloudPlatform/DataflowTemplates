...
variable "inputSubscription" {
  type        = string
  description = "The Pub/Sub subscription to read the input from, in the format projects/<PROJECT_ID>/subscriptions/<SUBSCRIPTION_ID>. (Example: projects/your-project-id/subscriptions/your-subscription-name)"

}

variable "redisHost" {
  type        = string
  description = "The Redis database host. (Example: your.cloud.db.redislabs.com). Defaults to: 127.0.0.1."
  default     = "127.0.0.1"
}

variable "redisPort" {
  type        = number
  description = "The Redis database port. (Example: 12345). Defaults to: 6379."
  default     = 6379
}
...
variable "redisSinkType" {
  type        = string
  description = "The Redis sink. Supported values are `STRING_SINK, HASH_SINK, STREAMS_SINK, and LOGGING_SINK`. (Example: STRING_SINK). Defaults to: STRING_SINK."
  default     = null
}

variable "connectionTimeout" {
  type        = number
  description = "The Redis connection timeout in milliseconds.  (Example: 2000). Defaults to: 2000."
  default     = null
}
...
resource "google_dataflow_flex_template_job" "generated" {
  ...
  parameters = {
    ...
    redisPort                                    = tostring(var.redisPort)
    redisPassword                                = var.redisPassword

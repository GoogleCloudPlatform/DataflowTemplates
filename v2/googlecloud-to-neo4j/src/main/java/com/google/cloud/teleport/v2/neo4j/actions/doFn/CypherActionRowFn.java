...
public class CypherActionRowFn extends org.apache.beam.sdk.transforms.DoFn<Integer, org.apache.beam.sdk.values.PCollection<org.apache.beam.sdk.values.Row>> {

    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(com.google.cloud.teleport.v2.neo4j.actions.doFn.CypherActionRowFn.class);
    ...
    public CypherActionRowFn(com.google.cloud.teleport.v2.neo4j.model.job.ActionContext context) {
    ...
    public void processElement(org.apache.beam.sdk.transforms.DoFn.ProcessContext context) throws InterruptedException {

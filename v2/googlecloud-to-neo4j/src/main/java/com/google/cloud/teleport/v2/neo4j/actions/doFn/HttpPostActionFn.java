...
public class HttpPostActionFn extends org.apache.beam.sdk.transforms.DoFn<Integer, Void> {
    ...
    public void processElement(@org.apache.beam.sdk.transforms.DoFn.Element org.apache.beam.sdk.values.Row row, org.apache.beam.sdk.transforms.DoFn.OutputReceiver<org.apache.beam.sdk.values.Row> outputReceiver) {
        ...
        try {
            org.apache.http.client.methods.CloseableHttpResponse response =
                    com.google.cloud.teleport.v2.neo4j.utils.HttpUtils.getHttpResponse(true, uri, context.action.options, context.action.headers);
            LOG.info("Executing http_post {} transform, returned: {}", context.action.name, com.google.cloud.teleport.v2.neo4j.utils.HttpUtils.getResponseContent(response));

...
public class SourceMapperTest {
  ...
  public void parses_BigQuery_source() {
    ...
    var options = OverlayTokenParser.parse("{\"table\": \"placeholder-table\"}");
  ...
  public void parses_external_text_source() {
    ...
    var options = OverlayTokenParser.parse("{\"ext\": \"com\"}");
  ...
  public void parses_minimal_inline_text_source() {
    ...
    var source = SourceMapper.parse(json, new OverlayTokens(Map.of()));

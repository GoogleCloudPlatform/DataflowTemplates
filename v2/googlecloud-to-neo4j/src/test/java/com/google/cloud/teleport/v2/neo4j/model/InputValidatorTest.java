  ...
  public void rejectsCustomQueryTargetWithNonDefaultTransform() {
    ...
    public void invalidatesSpecWithConflictingMappingsOfActiveNodeTargets() {
        ...
        assertThat(errorMessages)
                .isEqualTo(
                        List.of(
                                "The target placeholder_node_target defines conflicting mappings for property duplicateTargetProperty: it is mapped to source_field_1, source_field_2"));
    }

    @Test
    public void invalidatesSpecWithConflictingMappingsOfActiveRelTargets() {
        Mapping mapping1 = new Mapping();
        ...
        assertThat(errorMessages)
                .isEqualTo(
                        List.of(
                                "The target placeholder_edge_target defines conflicting mappings for property duplicateTargetProperty: it is mapped to source_field_1, source_field_2"));
    }
    ...
    private static List<Mapping> edgeMappings() {
        ...
        return new ArrayList<>(List.of(key, type, source, target));
    }

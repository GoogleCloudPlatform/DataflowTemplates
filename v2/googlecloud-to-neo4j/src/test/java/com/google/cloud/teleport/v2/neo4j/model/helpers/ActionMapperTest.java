...
public class ActionMapperTest {
  ...
  public void parses_HTTP_GET_action() {
    ...
    var options = OverlayTokenParser.parse("{\"ext\": \"com\", \"secret\": \"a-secret-value\"}");
  ...
  public void parses_minimal_BigQuery_action() {
    ...
    var actions = ActionMapper.parse(json, new OverlayTokens(Map.of()));
  ...
  public void parses_BigQuery_action() {
    ...
    var options = OverlayTokenParser.parse("{\"table\": \"placeholder_table\", \"limit\": 42}");
  ...
  public void parses_Cypher_action() {
    ...
    var options = OverlayTokenParser.parse("{\"label\": \"Placeholder\", \"limit\": 42}");

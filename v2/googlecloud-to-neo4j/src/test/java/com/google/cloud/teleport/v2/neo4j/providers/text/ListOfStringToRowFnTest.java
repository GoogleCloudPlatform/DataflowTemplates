...
/** Test for transform {@link ListOfStringToRowFn}. */
public class ListOfStringToRowFnTest {
  ...
  public void testTransform() {
    ...
    PCollection<Row> convertedRow =
        pipeline
            .apply(
                Create.of(
                    new ArrayList<Object>(Arrays.asList("1", "Neo4j")),
                    new ArrayList<Object>(Arrays.asList("2", "MySQL"))))
            .apply(ParDo.of(new ListOfStringToRowFn(sourceSchema)))

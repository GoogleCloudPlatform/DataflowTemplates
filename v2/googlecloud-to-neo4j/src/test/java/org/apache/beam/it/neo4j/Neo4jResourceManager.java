...
// TODO: un-fork after upgrading Beam version
public class Neo4jResourceManager extends TestContainerResourceManager<Neo4jContainer<?>>
  ...
  public List<Map<String, Object>> run(String query, String databaseName, Map<String, Object> parameters) {
    try (Session session =
  ...
  public String createTestDatabase() {
    String newDatabaseName = generateDatabaseName("test" + UUID.randomUUID().toString().substring(0, 4));
    try (Session session =

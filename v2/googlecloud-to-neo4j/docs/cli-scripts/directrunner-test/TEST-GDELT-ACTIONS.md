#  Integration Test: Big Query GDelt 
...
* Set environment variables that will be used in the build process.
 ...
 export JOB_NAME="test-gdelt-actions-`date +%Y%m%d-%H%M%S`"
...
* Running this below from the /v2/googlecloud-to-neo4j directory
 ...
 mvn compile exec:java \
   ...
   -Dexec.args="\
     ...
     --maxNumWorkers=2 \
     --jobSpecUri=gs://neo4j-se-dataflow/job-specs/testing/composite/bq-gdelt-postload-actions.json \

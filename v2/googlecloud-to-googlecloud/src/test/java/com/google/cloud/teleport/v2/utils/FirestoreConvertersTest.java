...
import com.google.cloud.teleport.v2.utils.FirestoreConverters.CheckNoKey;
import com.google.cloud.teleport.v2.utils.FirestoreConverters.CheckSameKey;
import com.google.cloud.teleport.v2.utils.FirestoreConverters.EntityJsonPrinter;
import com.google.cloud.teleport.v2.utils.FirestoreConverters.EntityToJson;
import com.google.cloud.teleport.v2.utils.FirestoreConverters.EntityToSchemaJson;
import com.google.cloud.teleport.v2.utils.FirestoreConverters.ErrorMessage;
import com.google.cloud.teleport.v2.utils.FirestoreConverters.JsonToEntity;
import com.google.cloud.teleport.v2.utils.FirestoreConverters.JsonToKey;
...
/** Unit tests for {@link FirestoreConverters}. */
@RunWith(JUnit4.class)
public class FirestoreConvertersTest implements Serializable {
  ...
  /** Unit test for {@link FirestoreConverters.EntityToJson}. */
  @Test
  ...
  /** Unit test for {@link FirestoreConverters.JsonToEntity}. */
  @Test
  ...
  /** Unit test for {@link FirestoreConverters.JsonToKey}. */
  @Test
  ...
  /** Unit test for {@link FirestoreConverters.EntityToSchemaJson}. */
  @Test
  ...
  /** Unit test for {@link FirestoreConverters.CheckSameKey}. */
  @Test
  ...
  /** Test {@link FirestoreConverters.CheckNoKey} with only correct entities. */
  @Test
  @Category(NeedsRunner.class)
  ...
  /** Test {@link FirestoreConverters.CheckNoKey} with only invalid entities. */
  @Test
  @Category(NeedsRunner.class)
  ...
  /** Test {@link FirestoreConverters.CheckNoKey} with both correct and invalid entities. */
  @Test
  @Category(NeedsRunner.class)

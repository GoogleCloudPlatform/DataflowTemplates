...
/**
 * The {@link SpannerChangeStreamsToVertexMEOptions} interface provides the custom execution options
 * passed by the executor at the command-line.
 */
public interface SpannerChangeStreamsToVertexMEOptions extends DataflowPipelineOptions {

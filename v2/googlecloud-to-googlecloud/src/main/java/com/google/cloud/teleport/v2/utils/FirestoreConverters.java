...
public class FirestoreConverters {
  ...
  public interface DatastoreWriteOptions extends PipelineOptions {
    ...
    @TemplateParameter.Text(
        ...
        helpText =
            "Datastore namespace under which entities will be written in the output Google Cloud"
                + " project")
    @Hidden
    @Deprecated
    ...
    @TemplateParameter.Text(
        ...
        helpText =
            "Firestore namespace under which entities will be written in the output Google Cloud"
                + " project")
  ...
  public interface DatastoreDeleteOptions extends PipelineOptions {
    ...
    @TemplateParameter.ProjectId(
        order = 1,
        description =
            "Delete all matching entities from the GQL Query present in this Datastore Project Id"
                + " of",
    ...
    @TemplateParameter.ProjectId(
        order = 3,
        description =
            "Delete all matching entities from the GQL Query present in this Firestore Project Id"
                + " of",
  ...
  public interface FirestoreReadSchemaCountOptions extends FirestoreReadOptions {}
  ...
  public abstract static class ReadJsonEntities extends PTransform<PBegin, PCollection<String>> {
    ...
    public static Builder newBuilder() {
      return new AutoValue_FirestoreConverters_ReadJsonEntities.Builder();
    }
    ...
    public PCollection<String> expand(PBegin begin) {
      return begin
          ...
          .apply("EntityToJson", ParDo.of(new FirestoreConverters.EntityToJson()));
    }
  }
  ...
  public abstract static class WriteJsonEntities
    ...
    public static Builder newBuilder() {
      return new AutoValue_FirestoreConverters_WriteJsonEntities.Builder()
  ...
  public abstract static class CheckSameKey
    ...
    public static Builder newBuilder() {
      return new AutoValue_FirestoreConverters_CheckSameKey.Builder();
    }
  ...
  public abstract static class DatastoreDeleteEntityJson
    ...
    public static Builder newBuilder() {
      return new AutoValue_FirestoreConverters_DatastoreDeleteEntityJson.Builder()
          .setHintNumWorkers(StaticValueProvider.of(500))
          .setThrottleRampup(true); // defaults
    }
  ...
  public abstract static class DatastoreReadSchemaCount
    ...
    public static Builder newBuilder() {
      return new AutoValue_FirestoreConverters_DatastoreReadSchemaCount.Builder();
    }
  ...
  public abstract static class WriteEntities
    ...
    public static Builder newBuilder() {
      return new AutoValue_FirestoreConverters_WriteEntities.Builder()
          .setHintNumWorkers(StaticValueProvider.of(500))
          .setThrottleRampup(true); // defaults
    }
  ...
  public abstract static class CheckNoKey
    ...
    public static Builder newBuilder() {
      return new AutoValue_FirestoreConverters_CheckNoKey.Builder();
    }
  ...
  public abstract static class ErrorMessage<T> {
    public static <T> Builder<T> newBuilder() {
      return new AutoValue_FirestoreConverters_ErrorMessage.Builder<>();
    }

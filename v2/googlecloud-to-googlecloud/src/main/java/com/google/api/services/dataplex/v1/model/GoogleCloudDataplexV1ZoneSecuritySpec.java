...
/**
 * Settings to manage the security policy applied to data in a zone.
 *
...
public final class GoogleCloudDataplexV1ZoneSecuritySpec
    extends com.google.api.client.json.GenericJson {

  /**
   * Optional. Indicates whether the policy overrides the list of groups specified in the policy
   * associated with the parent lake or adds to the parent policy. By default, the policy is
   * additive. If this flag is true, the list of groups must each include at least one entry. The
   ...
   * managed within a zone. By default this is inherited by all assets within the zone. For example,
   ...
   * allows group members to read data being managed within a zone. By default this is inherited by
   * all assets within a zone. For example, yourgroup@yourdomain.com. It cannot be a service
   ...
   * allows group members to update data being managed within a zone. By default this is inherited
   * by all assets within a zone. For example, yourgroup@yourdomain.com. It cannot be a service
   * account, user or another type of identity. The value may be {@code null}.
   */
   ...
   * Optional. Indicates whether the policy overrides the list of groups specified in the policy
   * associated with the parent lake or adds to the parent policy. By default, the policy is
   * additive. If this flag is true, the list of groups must each include at least one entry.
   *
   ...
   */
  public GoogleCloudDataplexV1ZoneSecuritySpec setOverrideParentSpec(
   ...
   */
  public GoogleCloudDataplexV1ZoneSecuritySpec setOwnerGroups(
   ...
   */
  public GoogleCloudDataplexV1ZoneSecuritySpec setReaderGroups(
   ...
   */
  public GoogleCloudDataplexV1ZoneSecuritySpec setWriterGroups(
  ...
  @Override
  public GoogleCloudDataplexV1ZoneSecuritySpec set(String fieldName, Object value) {
    return (GoogleCloudDataplexV1ZoneSecuritySpec) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDataplexV1ZoneSecuritySpec clone() {
    return (GoogleCloudDataplexV1ZoneSecuritySpec) super.clone();
  }
}

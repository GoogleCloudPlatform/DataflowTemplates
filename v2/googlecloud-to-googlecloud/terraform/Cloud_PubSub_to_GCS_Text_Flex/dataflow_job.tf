...
variable "inputTopic" {
  type        = string
  description = "The Pub/Sub topic to read the input from. The topic name should be in the format `projects/<PROJECT_ID>/topics/<TOPIC_NAME>`. If this parameter is provided don't use `inputSubscription`. (Example: projects/your-project-id/topics/your-topic-name)"
  default     = null
}

variable "inputSubscription" {
  type        = string
  description = "The Pub/Sub subscription to read the input from. The subscription name uses the format `projects/<PROJECT_ID>/subscription/<SUBSCRIPTION_NAME>`. If this parameter is provided, don't use `inputTopic`. (Example: projects/your-project-id/subscriptions/your-subscription-name)"
  default     = null
}

variable "outputDirectory" {
  type        = string
  description = "The path and filename prefix to write write output files to. This value must end in a slash. (Example: gs://your-bucket/your-path)"

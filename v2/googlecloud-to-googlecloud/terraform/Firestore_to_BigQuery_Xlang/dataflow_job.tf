...
variable "bigQuerySchemaPath" {
  type        = string
  description = "The Cloud Storage path for the BigQuery JSON schema. If `createDisposition` is not set, or set to CREATE_IF_NEEDED, this parameter must be specified. For example, `gs://your-bucket/your-schema.json`"
  default     = null
}

variable "firestoreReadGqlQuery" {
  type        = string
  description = "Specifies which Firestore entities to read. Ex: ‘SELECT * FROM MyKind’"

}

variable "firestoreReadProjectId" {
  type        = string
  description = "The Google Cloud project ID of the Firestore instance to read from"

}

variable "firestoreReadNamespace" {
  type        = string
  description = "Namespace of requested Firestore entities. Leave blank to use default namespace."
  default     = null
}
...
resource "google_dataflow_flex_template_job" "generated" {
  ...
  parameters = {
    ...
    firestoreReadGqlQuery                   = var.firestoreReadGqlQuery
    firestoreReadProjectId                  = var.firestoreReadProjectId
    firestoreReadNamespace                  = var.firestoreReadNamespace

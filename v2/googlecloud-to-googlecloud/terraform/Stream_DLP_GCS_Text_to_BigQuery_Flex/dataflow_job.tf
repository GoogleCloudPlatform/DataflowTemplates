...
variable "inputFilePattern" {
  type        = string
  description = "The Cloud Storage location of the files you'd like to process. For example, `gs://your-bucket/your-files/*.csv`"

}

variable "deidentifyTemplateName" {
  type        = string
  description = "Cloud DLP template to deidentify contents. Must be created here: https://console.cloud.google.com/security/dlp/create/template. For example, `projects/your-project-id/locations/global/deidentifyTemplates/generated_template_id`"

}

variable "inspectTemplateName" {
  type        = string
  description = "Cloud DLP template to inspect contents. For example, `projects/your-project-id/locations/global/inspectTemplates/generated_template_id`"
  default     = null
}

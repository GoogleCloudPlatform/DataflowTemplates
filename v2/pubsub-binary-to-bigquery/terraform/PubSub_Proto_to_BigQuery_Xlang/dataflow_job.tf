...
variable "bigQueryTableSchemaPath" {
  type        = string
  description = "The Cloud Storage path to the BigQuery schema path. If this value isn't provided, then the schema is inferred from the Proto schema. (Example: gs://MyBucket/bq_schema.json)"
  default     = null
}

variable "udfOutputTopic" {
  type        = string
  description = "The Pub/Sub topic storing the UDF errors. If this value isn't provided, UDF errors are sent to the same topic as `outputTopic`. (Example: projects/your-project-id/topics/your-topic-name)"
  default     = null
}
...
variable "inputSubscription" {
  type        = string
  description = "The Pub/Sub input subscription to read from. (Example: projects/<PROJECT_ID>/subscription/<SUBSCRIPTION_ID>)"
...
variable "outputTopic" {
  type        = string
  description = "The Pub/Sub topic to use for unprocessed records. (Example: projects/<PROJECT_ID>/topics/<TOPIC_NAME>)"

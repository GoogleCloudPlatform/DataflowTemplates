 ...
 * the License.
 */
package com.google.cloud.teleport.v2.templates.changestream.encoder;
...
public class TimestampEncoding extends CustomEncoding<Timestamp> {
  ...
  {
    /*
     * The schema of an Avro Encoded timestamp. It is represented as a record with a {@link Long}

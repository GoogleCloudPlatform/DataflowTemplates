...
CREATE TABLE BoundaryConversionTestTable (
    varchar_column text PRIMARY KEY,
    tinyint_column tinyint,
    min_tinyint_column tinyint,
    smallint_column smallint,
    min_smallint_column smallint,
    int_column int,
    min_int_column int,
    bigint_column bigint,
    min_bigint_column bigint,
    float_column float,
    min_float_column float,
    double_column double,
    min_double_column double,
    decimal_column decimal,
    min_decimal_column decimal,
    bool_column boolean,
    min_bool_column boolean,
    ascii_column ascii,
    text_column text,
    bytes_column blob,
    min_bytes_column blob,
    date_column date,
    min_date_column date,
    time_column time,
    min_time_column time,
    timestamp_column timestamp,
    min_timestamp_column timestamp,

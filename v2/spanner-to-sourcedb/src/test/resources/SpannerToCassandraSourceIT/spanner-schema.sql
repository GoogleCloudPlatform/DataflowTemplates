...
CREATE TABLE IF NOT EXISTS boundaryconversiontesttable (
    varchar_column STRING(20) NOT NULL,
    tinyint_column INT64,
    min_tinyint_column INT64,
    smallint_column INT64,
    min_smallint_column INT64,
    int_column INT64,
    min_int_column INT64,
    bigint_column INT64,
    min_bigint_column INT64,
    float_column FLOAT64,
    min_float_column FLOAT64,
    double_column FLOAT64,
    min_double_column FLOAT64,
    decimal_column NUMERIC,
    min_decimal_column NUMERIC,
    bool_column BOOL,
    min_bool_column BOOL,
    ascii_column STRING(MAX),
    text_column STRING(MAX),
    bytes_column BYTES(MAX),
    min_bytes_column BYTES(MAX),
    date_column STRING(MAX),
    min_date_column STRING(MAX),
    time_column STRING(MAX),
    min_time_column STRING(MAX),
    timestamp_column STRING(MAX),
    min_timestamp_column STRING(MAX),

-- Schema generated 2026-03-27 15:13:27
--
-- Spanner schema for source table AllDataTypes
--
...
--
-- Spanner schema for source table Customers
--
CREATE TABLE Customers (
	CustomerId INT64 NOT NULL ,    -- From: CustomerId int(10)
	CustomerName STRING(255),      -- From: CustomerName varchar(255)
	CreditLimit NUMERIC NOT NULL , -- From: CreditLimit decimal(10,2)
	LoyaltyTier STRING(50),        -- From: LegacyRegion varchar(50)
	migration_shard_id STRING(50),
) PRIMARY KEY (migration_shard_id, CustomerId);

--
-- Spanner schema for source table Orders
--
CREATE TABLE Orders (
	CustomerId INT64 NOT NULL ,       -- From: CustomerId int(10)
	OrderId INT64 NOT NULL ,          -- From: OrderId int(10)

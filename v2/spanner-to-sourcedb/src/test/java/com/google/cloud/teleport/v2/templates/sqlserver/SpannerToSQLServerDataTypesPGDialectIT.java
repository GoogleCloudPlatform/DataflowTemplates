...
public class SpannerToSQLServerDataTypesPGDialectIT extends SpannerToSourceDbITBase {
    ...
    for (Map<String, Object> row : rows) {
      for (Map.Entry<String, Object> entry : row.entrySet()) {
        if (entry.getValue() == null) {
          ...
          entry.setValue(entry.getValue().toString());
        } else if (entry.getValue().getClass().getName().equals("microsoft.sql.DateTimeOffset")) {
          entry.setValue(entry.getValue().toString());
        }
      }
    }
  ...
  private Map<String, List<Value>> getSpannerTableData() {
    ...
    spannerRowData.put(
        "float_to_numeric", List.of(Value.pgNumeric("52.67"), Value.pgNumeric(null)));
    spannerRowData.put(
        "tinyint_to_float",
    ...
    spannerRowData.put(
        ...
        List.of(Value.string("2022-08-05 08:23:11"), Value.string(null)));
    spannerRowData.put(
    ...
    // Primary key tables for all supported indexable data types
    spannerRowData.put("tinyint_pk", List.of(Value.int64(0), Value.int64(255), Value.int64(10)));
    spannerRowData.put(
        "smallint_pk", List.of(Value.int64(-32768), Value.int64(32767), Value.int64(15)));
    spannerRowData.put(
        "int_pk", List.of(Value.int64(-2147483648), Value.int64(2147483647), Value.int64(30)));
    spannerRowData.put(
        "bigint_pk",
        List.of(
            Value.int64(-9223372036854775808L),
            Value.int64(9223372036854775807L),
            Value.int64(40)));
    spannerRowData.put("bit_pk", List.of(Value.bool(false), Value.bool(true)));
    spannerRowData.put(
        "decimal_pk", List.of(Value.string("68.7500"), Value.string("99999999999999.9999")));
    spannerRowData.put(
        "numeric_pk", List.of(Value.string("68.7500"), Value.string("99999999999999.9999")));
    spannerRowData.put(
        "money_pk",
        List.of(Value.string("-922337203685477.5808"), Value.string("922337203685477.5807")));
    spannerRowData.put(
        "smallmoney_pk", List.of(Value.string("-214748.3648"), Value.string("214748.3647")));
    spannerRowData.put(
        "float_pk",
        List.of(Value.float64(52.67), Value.float64(1.79E308), Value.float64(-1.79E308)));
    spannerRowData.put(
        "real_pk", List.of(Value.float64(45.56), Value.float64(3.40E38), Value.float64(-3.40E38)));
    spannerRowData.put(
        "date_pk",
        List.of(
            Value.date(Date.parseDate("2012-09-17")),
            Value.date(Date.parseDate("0001-01-01")),
            Value.date(Date.parseDate("9999-12-31"))));
    spannerRowData.put("time_pk", List.of(Value.string("00:00:00"), Value.string("12:34:56")));
    spannerRowData.put(
        "datetime_pk",
        List.of(
            Value.timestamp(Timestamp.parseTimestampDuration("1998-01-23T12:45:56Z")),
    ...
    spannerRowData.put(
        "datetime2_pk",
        List.of(Value.timestamp(Timestamp.parseTimestampDuration("2022-08-05T08:23:11Z"))));
    spannerRowData.put(
        "smalldatetime_pk",
        List.of(
            Value.timestamp(Timestamp.parseTimestampDuration("1900-01-01T00:00:00Z")),
    ...
    spannerRowData.put(
        "datetimeoffset_pk",
        List.of(Value.timestamp(Timestamp.parseTimestampDuration("2022-08-05T08:23:11Z"))));
    spannerRowData.put("char_pk", List.of(Value.string("a"), Value.string("sample")));
    spannerRowData.put("varchar_pk", List.of(Value.string("abc"), Value.string("x".repeat(100))));
    spannerRowData.put("nchar_pk", List.of(Value.string("a"), Value.string("unicode_char")));
    spannerRowData.put("nvarchar_pk", List.of(Value.string("abc"), Value.string("unicode_val")));
    spannerRowData.put("binary_pk", List.of(Value.bytesFromBase64("eDU4MDA=")));
    spannerRowData.put("varbinary_pk", List.of(Value.bytesFromBase64("eDU4MDA=")));
    spannerRowData.put(
        "uniqueidentifier_pk", List.of(Value.string("6F9619FF-8B86-D011-B42D-00C04FC964FF")));
  ...
  private Map<String, List<Map<String, Object>>> getExpectedData() {
    ...
    expectedData.put(
        ...
        createRows(
            "datetime",
            java.sql.Timestamp.valueOf("1998-01-23 12:45:56"),
            java.sql.Timestamp.valueOf("1753-01-01 00:00:00"),
            null));
    expectedData.put(
        "datetime2",
        createRows("datetime2", java.sql.Timestamp.valueOf("2022-08-05 08:23:11"), null));
    expectedData.put(
        "smalldatetime",
        createRows(
            "smalldatetime",
            java.sql.Timestamp.valueOf("1900-01-01 00:00:00"),
            java.sql.Timestamp.valueOf("2079-06-06 23:59:00"),
            null));
    expectedData.put(
        "datetimeoffset", createRows("datetimeoffset", "2022-08-05 08:23:11 +00:00", null));
    ...
    expectedData.put(
        "datetime_to_string",
        createRows("datetime_to_string", java.sql.Timestamp.valueOf("1998-01-23 12:45:56"), null));
    expectedData.put(
        "datetime2_to_string",
        createRows("datetime2_to_string", java.sql.Timestamp.valueOf("2022-08-05 08:23:11"), null));
    expectedData.put(
        "smalldatetime_to_string",
        createRows(
            "smalldatetime_to_string", java.sql.Timestamp.valueOf("1900-01-01 00:00:00"), null));
    expectedData.put(
        "datetimeoffset_to_string",
        createRows("datetimeoffset_to_string", "2022-08-05 08:23:11 +00:00", null));
    ...
    expectedData.put(
        "uniqueidentifier_to_string",
        createRows("uniqueidentifier_to_string", "6F9619FF-8B86-D011-B42D-00C04FC964FF", null));
    expectedData.put(
        "uniqueidentifier_to_bytes",
    ...
    // Primary key tables expected rows
    expectedData.put("tinyint_pk", createRows("tinyint_pk", (short) 0, (short) 255, (short) 10));
    expectedData.put(
        "smallint_pk", createRows("smallint_pk", (short) -32768, (short) 32767, (short) 15));
    expectedData.put("int_pk", createRows("int_pk", -2147483648, 2147483647, 30));
    expectedData.put(
        "bigint_pk", createRows("bigint_pk", -9223372036854775808L, 9223372036854775807L, 40L));
    expectedData.put("bit_pk", createRows("bit_pk", false, true));
    expectedData.put(
        "decimal_pk",
        createRows("decimal_pk", new BigDecimal("68.7500"), new BigDecimal("99999999999999.9999")));
    expectedData.put(
        "numeric_pk",
        createRows("numeric_pk", new BigDecimal("68.7500"), new BigDecimal("99999999999999.9999")));
    expectedData.put(
        "money_pk",
        createRows(
            "money_pk",
    ...
    expectedData.put(
        "smallmoney_pk",
        createRows("smallmoney_pk", new BigDecimal("-214748.3648"), new BigDecimal("214748.3647")));
    expectedData.put("float_pk", createRows("float_pk", 52.67, 1.79E308, -1.79E308));
    expectedData.put("real_pk", createRows("real_pk", 45.56F, 3.40E38F, -3.40E38F));
    expectedData.put(
        "date_pk",
        createRows(
            "date_pk",
    ...
    expectedData.put(
        "time_pk",
        createRows(
            "time_pk", java.sql.Time.valueOf("00:00:00"), java.sql.Time.valueOf("12:34:56")));
    expectedData.put(
        "datetime_pk",
        createRows(
            "datetime_pk",
    ...
    expectedData.put(
        "datetime2_pk",
        createRows("datetime2_pk", java.sql.Timestamp.valueOf("2022-08-05 08:23:11")));
    expectedData.put(
        "smalldatetime_pk",
        createRows(
            "smalldatetime_pk",
            ...
            java.sql.Timestamp.valueOf("2079-06-06 23:59:00")));
    expectedData.put(
        "datetimeoffset_pk", createRows("datetimeoffset_pk", "2022-08-05 08:23:11 +00:00"));
    expectedData.put("char_pk", createRows("char_pk", "a", "sample"));
    expectedData.put("varchar_pk", createRows("varchar_pk", "abc", "x".repeat(100)));
    expectedData.put("nchar_pk", createRows("nchar_pk", "a", "unicode_char"));
    expectedData.put("nvarchar_pk", createRows("nvarchar_pk", "abc", "unicode_val"));
    expectedData.put("binary_pk", createRows("binary_pk", Base64.getDecoder().decode("eDU4MDA=")));
    expectedData.put(
        "varbinary_pk", createRows("varbinary_pk", Base64.getDecoder().decode("eDU4MDA=")));
    expectedData.put(
        "uniqueidentifier_pk",
        createRows("uniqueidentifier_pk", "6F9619FF-8B86-D011-B42D-00C04FC964FF"));

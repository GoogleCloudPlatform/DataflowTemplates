...
public class CassandraTypeHandlerTest {
  ...
  //
  //    Set<Timestamp> result = CassandraTypeHandler.handleTimestampSetType("timestamps",
  // valuesJson);
  //
  ...
  //    JSONObject newValuesJson = new JSONObject(newValuesString);
  //    String colKey = "ipAddress";
  //    InetAddress actual = CassandraTypeHandler.handleCassandraInetAddressType(colKey,
  // newValuesJson);

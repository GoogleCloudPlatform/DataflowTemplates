...
public class SpannerToSourceDbOrderedWritesMultiShardIT extends TemplateTestBase {

  private static final Logger LOG =
      LoggerFactory.getLogger(SpannerToSourceDbOrderedWritesMultiShardIT.class);

  private static final String SPANNER_DDL_RESOURCE =
      "SpannerToSourceDbOrderedWritesMultiShardIT/spanner-schema.sql";
  private static final String SESSION_FILE_RESOURSE =
      "SpannerToSourceDbOrderedWritesMultiShardIT/session.json";
  private static final String MYSQL_DDL_RESOURCE =
      "SpannerToSourceDbOrderedWritesMultiShardIT/mysql-schema.sql";

  private static HashSet<SpannerToSourceDbOrderedWritesMultiShardIT> testInstances =
      new HashSet<>();
  ...
  public void setUp() throws IOException {
    ...
    synchronized (SpannerToSourceDbOrderedWritesMultiShardIT.class) {
  ...
  public static void cleanUp() throws IOException {
    for (SpannerToSourceDbOrderedWritesMultiShardIT instance : testInstances) {

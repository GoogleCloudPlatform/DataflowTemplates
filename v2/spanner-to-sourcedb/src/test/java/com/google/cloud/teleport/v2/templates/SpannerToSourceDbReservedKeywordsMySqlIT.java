...
public class SpannerToSourceDbReservedKeywordsMySqlIT extends SpannerToSourceDbITBase {

  private static final String SPANNER_DDL_RESOURCE =
      "SpannerToSourceDbReservedKeywordsMySqlIT/spanner-schema.sql";
  private static final String MYSQL_DDL_RESOURCE =
      "SpannerToSourceDbReservedKeywordsMySqlIT/mysql-schema.sql";
  private static final String SESSION_FILE_RESOURCE =
      "SpannerToSourceDbReservedKeywordsMySqlIT/session.json";

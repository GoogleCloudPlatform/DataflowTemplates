...
public class SpannerToOracleTimezoneIT extends SpannerToSourceDbITBase {

  private static final Logger LOG = LoggerFactory.getLogger(SpannerToOracleTimezoneIT.class);

  private static final String SPANNER_DDL_RESOURCE =
      "oracle/SpannerToOracleTimezoneIT/oracle-GOOGLE_STANDARD_SQL-spanner-schema.sql";
  private static final String SESSION_FILE_RESOURCE =
      "oracle/SpannerToOracleTimezoneIT/session.json";
  private static final String ORACLE_SCHEMA_FILE_RESOURCE =
      "oracle/SpannerToOracleTimezoneIT/oracle-schema.sql";

  private static final String TABLE = "Users";
  private static final HashSet<SpannerToOracleTimezoneIT> testInstances = new HashSet<>();
  ...
  public void setUp() throws IOException {
    ...
    synchronized (SpannerToOracleTimezoneIT.class) {
      ...
      if (jobInfo == null) {
        ...
        gcsResourceManager.uploadArtifact(
            "input/session.json",
            Resources.getResource(SpannerToOracleTimezoneIT.SESSION_FILE_RESOURCE).getPath());
  ...
  public static void cleanUp() throws IOException {
    for (SpannerToOracleTimezoneIT instance : testInstances) {
  ...
  private void assertRowInOracle() throws InterruptedException {
    ...
    assertThat(rows.get(0).get("time_colm").toString()).isEqualTo("2024-02-02 10:00:00.0");
    assertThat(rows.get(1).get("id")).isEqualTo(java.math.BigDecimal.valueOf(2));

...
public class SpannerToCassandraReservedKeywordsIT extends SpannerToSourceDbITBase {
  ...
  private static final String CASSANDRA_CONFIG = "cassandrabasic.properties";
  private static final String SESSION_FILE_RESOURCE = "SpannerToSourceDbIT/session.json";

  private static final HashSet<SpannerToCassandraReservedKeywordsIT> testInstances =
      new HashSet<>();
  ...
  public void setUp() throws IOException {
    ...
    synchronized (SpannerToCassandraReservedKeywordsIT.class) {
  ...
  public static void cleanUp() throws IOException {
    for (SpannerToCassandraReservedKeywordsIT instance : testInstances) {
        ...
        pipelineOperator()
            .waitForCondition(
                ...
                () -> {
                  ...
                  return rows.spliterator().getExactSizeIfKnown() == 2;
                });

...
/**
 * Integration test for {@link SpannerToSourceDb} Flex template for basic wide row limits targeting
 * SQL Server.
 */
@Category({TemplateIntegrationTest.class, SkipDirectRunnerTest.class})
@TemplateIntegrationTest(SpannerToSourceDb.class)
@RunWith(JUnit4.class)
public class SpannerToSQLServerWideRowBasicIT extends SpannerToSourceDbITBase {
  ...
  public void testCreateDatabaseAndTableWith1024Columns() throws Exception {
    String databaseName = "rr-main-table-per-columns-" + testName;

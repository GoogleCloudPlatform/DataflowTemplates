...
/** Integration test for reverse replication from Spanner to SQL Server using retryAllDLQ mode. */
@Category({TemplateIntegrationTest.class, SkipDirectRunnerTest.class})
@TemplateIntegrationTest(SpannerToSourceDb.class)
@RunWith(JUnit4.class)
public class SpannerToSourceDBSQLServerRetryAllDLQIT extends SpannerToSourceDbITBase {

  private static final Logger LOG =
      LoggerFactory.getLogger(SpannerToSourceDBSQLServerRetryAllDLQIT.class);
  private static final String SPANNER_DDL_RESOURCE =
      "sqlserver/SpannerToSourceDBSQLServerRetryAllDLQIT/spanner-schema.sql";
  private static final String SQLSERVER_SCHEMA_FILE_RESOURCE =
      "sqlserver/SpannerToSourceDBSQLServerRetryAllDLQIT/sqlserver-schema.sql";
  private static final String OVERRIDES_FILE_RESOURCE =
      "sqlserver/SpannerToSourceDBSQLServerRetryAllDLQIT/overrides.json";

  private static final HashSet<SpannerToSourceDBSQLServerRetryAllDLQIT> testInstances =
      new HashSet<>();
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    synchronized (SpannerToSourceDBSQLServerRetryAllDLQIT.class) {
      testInstances.add(this);
      if (jobInfo == null) {
        spannerResourceManager =
            createSpannerDatabase(SpannerToSourceDBSQLServerRetryAllDLQIT.SPANNER_DDL_RESOURCE);
        ...
        createSQLServerSchema(
            jdbcResourceManager,
            SpannerToSourceDBSQLServerRetryAllDLQIT.SQLSERVER_SCHEMA_FILE_RESOURCE);
  ...
  public static void cleanUp() throws IOException {
    for (SpannerToSourceDBSQLServerRetryAllDLQIT instance : testInstances) {
        ...
        DlqEventsCountCheck.builder(gcsResourceManager, "dlq/retry/")
            ...
            .and(
                DlqEventsCountCheck.builder(gcsResourceManager, "dlq/severe/")
                    ...
                    .setMaxEvents(1)
                    .build())
            .and(JDBCRowsCheck.builder(jdbcResourceManager, "Orders").setMinRows(2).build())
            .and(JDBCRowsCheck.builder(jdbcResourceManager, "AllDataTypes").setMinRows(2).build());

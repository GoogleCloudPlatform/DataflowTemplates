...
public class SpannerToCassandraSourceDbMaxColumnNameWithTableNameIT
  ...
  public void setUp() throws IOException {
    ...
    synchronized (SpannerToCassandraSourceDbMaxColumnNameWithTableNameIT.class) {
  ...
  public static void cleanUp() throws IOException {
    for (SpannerToCassandraSourceDbMaxColumnNameWithTableNameIT instance : testInstances) {

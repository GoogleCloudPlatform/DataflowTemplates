...
public class SpannerToSQLServerWithoutSessionIT extends SpannerToSourceDbITBase {
  ...
  // TODO: Fix UPDATE events on tables with generated PK columns. Currently,
  // DMLGeneratorUtils.getPkColumnValues returns new values for non-PK columns on UPDATE, which
  // causes SQL Server's MERGE ON clause to fail to match the target row and attempt a duplicate
  // INSERT.
  @Ignore(
      "TODO: Fix UPDATE on generated PK columns matching old vs new non-PK values in MERGE ON clause")
  @Test

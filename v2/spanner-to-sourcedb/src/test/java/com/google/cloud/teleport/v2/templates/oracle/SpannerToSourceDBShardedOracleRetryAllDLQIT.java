...
public class SpannerToSourceDBShardedOracleRetryAllDLQIT extends SpannerToSourceDbITBase {

  private static final Logger LOG =
      LoggerFactory.getLogger(SpannerToSourceDBShardedOracleRetryAllDLQIT.class);
  private static final String SPANNER_DDL_RESOURCE =
      "oracle/SpannerToSourceDBShardedOracleRetryAllDLQIT/oracle-GOOGLE_STANDARD_SQL-spanner-schema.sql";
  private static final String MYSQL_SCHEMA_FILE_RESOURCE =
      "oracle/SpannerToSourceDBShardedOracleRetryAllDLQIT/oracle-schema.sql";
  private static final String OVERRIDES_FILE_RESOURCE =
      "oracle/SpannerToSourceDBShardedOracleRetryAllDLQIT/overrides.json";
  private static final HashSet<SpannerToSourceDBShardedOracleRetryAllDLQIT> testInstances =
      new HashSet<>();
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    synchronized (SpannerToSourceDBShardedOracleRetryAllDLQIT.class) {
      testInstances.add(this);
      if (jobInfo == null) {
        spannerResourceManager =
            createSpannerDatabase(SpannerToSourceDBShardedOracleRetryAllDLQIT.SPANNER_DDL_RESOURCE);
  ...
  public static void cleanUp() throws IOException {
    for (SpannerToSourceDBShardedOracleRetryAllDLQIT instance : testInstances) {

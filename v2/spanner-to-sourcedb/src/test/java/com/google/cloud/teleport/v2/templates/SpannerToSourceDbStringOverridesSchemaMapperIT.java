...
public class SpannerToSourceDbStringOverridesSchemaMapperIT extends SpannerToSourceDbITBase {
  private static final Logger LOG =
      LoggerFactory.getLogger(SpannerToSourceDbStringOverridesSchemaMapperIT.class);
  private static final HashSet<SpannerToSourceDbStringOverridesSchemaMapperIT> testInstances =
      new HashSet<>();
  ...
  public void setUp() throws IOException {
    ...
    synchronized (SpannerToSourceDbStringOverridesSchemaMapperIT.class) {
      ...
      if (jobInfo == null) {
        ...
        ADDITIONAL_JOB_PARAMS.put("tableOverrides", "[{source_table1, Target_Table_1}]");
  ...
  public static void cleanUp() throws IOException {
    for (SpannerToSourceDbStringOverridesSchemaMapperIT instance : testInstances) {
  ...
  @Test
  public void testSpannerToMySQLWithStringOverrides() throws Exception {

...
public class SpannerToSQLServerDataTypesIT extends SpannerToSourceDbITBase {
  ...
  private static final String SPANNER_DDL_RESOURCE =
      "SpannerToSQLServerDataTypesIT/spanner-schema.sql";

  private static final String SQLSERVER_SCHEMA_FILE_RESOURCE =
      "SpannerToSQLServerDataTypesIT/sqlserver-schema.sql";
  ...
  public void setUp() throws Exception {
    spannerResourceManager =
        createSpannerDatabase(SpannerToSQLServerDataTypesIT.SPANNER_DDL_RESOURCE);
  ...
  private Map<String, List<Value>> getSpannerTableData() {
    ...
    spannerRowData.put(
        "decimal_table", List.of(Value.numeric(new BigDecimal("68.75")), Value.numeric(null)));
    spannerRowData.put(
        "numeric_table", List.of(Value.numeric(new BigDecimal("68.75")), Value.numeric(null)));
    spannerRowData.put(
        "money_table", List.of(Value.numeric(new BigDecimal("12345.6700")), Value.numeric(null)));
    spannerRowData.put(
        "smallmoney_table",
        List.of(Value.numeric(new BigDecimal("123.4500")), Value.numeric(null)));
    spannerRowData.put(
        "float_table",
        List.of(
            Value.float64(52.67),

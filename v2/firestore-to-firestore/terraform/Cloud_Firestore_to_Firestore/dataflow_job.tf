...
variable "readTime" {
  type = string
  description = "The read time of the Firestore read operations. Uses current timestamp if not set. For example, `2021-10-12T07:20:50.52Z`. Defaults to empty."
  default = null
}

...
public interface MySQLToBigQueryOptions extends JdbcToBigQueryOptions {
  ...
  @TemplateParameter.Text(
      ...
      helpText =
          "The JDBC connection URL string. For example, `jdbc:mysql://some-host:3306/sampledb`. Can be passed in as a string that's Base64-encoded and then encrypted with a Cloud KMS key.",

...
variable "readBootstrapServerAndTopic" {
  type        = string
  description = "Kafka Bootstrap server and topic to read the input from. For example, `localhost:9092;topic1,topic2`"
...
variable "writeBootstrapServerAndTopic" {
  type        = string
  description = "Kafka bootstrap server and topic to write the output to. For example, `bootstrap.<KAFKA_CLUSTER>.<REGION>.managedkafka.<PROJECT>.cloud.goog:9092;<TOPIC>`"

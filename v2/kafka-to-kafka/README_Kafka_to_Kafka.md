...
* **writeBootstrapServerAndTopic**: Kafka bootstrap server and topic to write the output to. For example, `bootstrap.<KAFKA_CLUSTER>.<REGION>.managedkafka.<PROJECT>.cloud.goog:9092;<TOPIC>`.

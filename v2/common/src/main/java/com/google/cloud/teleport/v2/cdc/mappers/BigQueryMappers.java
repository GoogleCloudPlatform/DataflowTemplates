...
public class BigQueryMappers {
  ...
  public static class BigQueryTableMapper extends BigQueryMapper<TableRow, KV<TableId, TableRow>> {

    private String datasetNameTemplate;
    private String tableNameTemplate;

    public BigQueryTableMapper(
        String datasetNameTemplate, String tableNameTemplate, String projectId) {
      super(projectId);

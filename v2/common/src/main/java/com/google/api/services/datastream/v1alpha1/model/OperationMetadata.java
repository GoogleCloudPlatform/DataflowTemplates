...
public final class OperationMetadata extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. Results of executed validations if there are any. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private ValidationResult validationResult;

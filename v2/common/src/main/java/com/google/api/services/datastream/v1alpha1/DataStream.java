...
public class DataStream extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.25.0-SNAPSHOT of the DataStream API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
    ...
    public class Locations {
      ...
      public class ConnectionProfiles {
        ...
        public class List extends DataStreamRequest<com.google.api.services.datastream.v1alpha1.model.ListConnectionProfilesResponse> {
          ...
          /** Maximum number of Connection Profiles to return. The service may return fewer than this value. If
         unspecified, at most 50 Connection Profiles will be returned. The maximum value is 1000; values
        ...
        public class Patch extends DataStreamRequest<com.google.api.services.datastream.v1alpha1.model.Operation> {
          ...
          /** Field mask is used to specify the fields to be overwritten in the ConnectionProfile resource by the
      ...
      public class PrivateConnections {
        ...
        public class List extends DataStreamRequest<com.google.api.services.datastream.v1alpha1.model.ListPrivateConnectionsResponse> {
          ...
          /** Maximum number of Private Connections to return. The service may return fewer than this value. If
         unspecified, at most 50 Private Connections will be returned. The maximum value is 1000; values
         above 1000 will be coerced to 1000.
           */
          public java.lang.Integer getPageSize() {
            return pageSize;
        ...
        public class Routes {
          ...
          /**
           * Use this method to list routes created for a private connection in a project and location.
           *
      ...
      public class Streams {
        ...
        public class List extends DataStreamRequest<com.google.api.services.datastream.v1alpha1.model.ListStreamsResponse> {
          ...
          /** Maximum number of Streams to return. The service may return fewer than this value. If unspecified,
         at most 50 Streams will be returned. The maximum value is 1000; values above 1000 will be coerced
         to 1000.
           */
          public java.lang.Integer getPageSize() {
            return pageSize;
        ...
        public class Patch extends DataStreamRequest<com.google.api.services.datastream.v1alpha1.model.Operation> {
          ...
          /** Required. Field mask is used to specify the fields to be overwritten in the Stream resource by the
         update. The fields specified in the update_mask are relative to the resource, not the full request.
         A field will be overwritten if it is in the mask. If the user does not provide a mask then all
         fields will be overwritten.
           */
         ...
         *
         * Create a request for the method "streams.pause".
         *
         * This request holds the parameters needed by the datastream server.  After setting any optional
         ...
         * @param content the {@link com.google.api.services.datastream.v1alpha1.model.PauseStreamRequest}
         * @return the request
         */
        public Pause pause(java.lang.String name, com.google.api.services.datastream.v1alpha1.model.PauseStreamRequest content) throws java.io.IOException {
          Pause result = new Pause(name, content);
          initialize(result);
          return result;
        }

        public class Pause extends DataStreamRequest<com.google.api.services.datastream.v1alpha1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Pause(java.lang.String name, com.google.api.services.datastream.v1alpha1.model.PauseStreamRequest content) {
            super(DataStream.this, "POST", REST_PATH, content, com.google.api.services.datastream.v1alpha1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         *
         * Create a request for the method "streams.resume".
         *
         * This request holds the parameters needed by the datastream server.  After setting any optional
         ...
         * @param content the {@link com.google.api.services.datastream.v1alpha1.model.ResumeStreamRequest}
         * @return the request
         */
        public Resume resume(java.lang.String name, com.google.api.services.datastream.v1alpha1.model.ResumeStreamRequest content) throws java.io.IOException {
          Resume result = new Resume(name, content);
          initialize(result);
          return result;
        }

        public class Resume extends DataStreamRequest<com.google.api.services.datastream.v1alpha1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Resume(java.lang.String name, com.google.api.services.datastream.v1alpha1.model.ResumeStreamRequest content) {
            super(DataStream.this, "POST", REST_PATH, content, com.google.api.services.datastream.v1alpha1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         *
         * Create a request for the method "streams.start".
         *
         * This request holds the parameters needed by the datastream server.  After setting any optional
         ...
         * @param content the {@link com.google.api.services.datastream.v1alpha1.model.StartStreamRequest}
         * @return the request
         */
        public Start start(java.lang.String name, com.google.api.services.datastream.v1alpha1.model.StartStreamRequest content) throws java.io.IOException {
          Start result = new Start(name, content);
          initialize(result);
          return result;
        }

        public class Start extends DataStreamRequest<com.google.api.services.datastream.v1alpha1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Start(java.lang.String name, com.google.api.services.datastream.v1alpha1.model.StartStreamRequest content) {
            super(DataStream.this, "POST", REST_PATH, content, com.google.api.services.datastream.v1alpha1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),

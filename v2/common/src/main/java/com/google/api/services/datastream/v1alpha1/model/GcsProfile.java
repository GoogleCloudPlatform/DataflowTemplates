...
public final class GcsProfile extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. The full project and resource path for Cloud Storage bucket including the name. The
   * value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String bucketName;

...
public class SchemaUtilsTest {
  ...
  private static final String PROTO_SCHEMA_FILE_PATH =
      Resources.getResource(RESOURCES_DIR + "generated/proto/schema.pb").getPath();
  ...
  public void testGetProtoDescriptor() {
    ...
    DescriptorProto actual =
        SchemaUtils.getProtoDescriptor(
                PROTO_SCHEMA_FILE_PATH, "proto_definition.proto", "MyMessage")
            .toProto();
  ...
  public void testGetProtoNested() {
    ...
    DescriptorProto actual =
        SchemaUtils.getProtoDescriptor(
                PROTO_SCHEMA_FILE_PATH, "proto_definition.proto", "MyMessage.NestedMessage")
            .toProto();

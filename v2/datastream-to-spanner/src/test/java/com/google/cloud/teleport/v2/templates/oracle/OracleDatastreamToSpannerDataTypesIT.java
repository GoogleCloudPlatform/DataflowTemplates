...
public class OracleDatastreamToSpannerDataTypesIT extends DataStreamToSpannerITBase {
  private static final Logger LOG = LoggerFactory.getLogger(OracleDatastreamToSpannerDataTypesIT.class);

  private static final String SPANNER_DDL_RESOURCE = "oracle/OracleDatastreamToSpannerDataTypesIT/oracle-google_standard_sql-spanner-schema.sql";
  ...
  private static final String[] ORACLE_DDL_COMMANDS = new String[] {
    ...
    synchronized (OracleDatastreamToSpannerDataTypesIT.class) {
      ...
      if (!initialized) {
        ...
        try (java.sql.Connection conn = java.sql.DriverManager.getConnection(
            ...
            throw new RuntimeException("Failed to efficiently upload Oracle DDL via single connection", e);
        }
  ...
  public void testOracleDataTypes() throws Exception {
    ...
    OracleSource oracleSource =
        OracleSource.builder(
            ...
            .setAllowedTables(
                Map.of(oracleResourceManager.getUsername().toUpperCase(), getAllowedTables(expectedData)))
            .build();

...
public class OracleSeparateShadowTableDatabaseFileOverridesIT extends DataStreamToSpannerITBase {
  private static final Logger LOG = LoggerFactory.getLogger(OracleSeparateShadowTableDatabaseFileOverridesIT.class);

  private static final String ORACLE_SCHEMA = "oracle/OracleSeparateShadowTableDatabaseFileOverridesIT/oracle-schema.sql";
  private static final String SPANNER_DDL_RESOURCE = "oracle/OracleSeparateShadowTableDatabaseFileOverridesIT/oracle-google_standard_sql-spanner-schema.sql";
  private static final String OVERRIDE_FILE = "oracle/OracleSeparateShadowTableDatabaseFileOverridesIT/override.json";
  ...
  private static HashSet<OracleSeparateShadowTableDatabaseFileOverridesIT> testInstances = new HashSet<>();
      ...
      protected CheckResult check() {
        try {
          ...
          try (java.sql.Connection conn = java.sql.DriverManager.getConnection(
                  "jdbc:oracle:thin:@" + System.getProperty("hostIp", "localhost") + ":1521/XE", "system", "TestPassword123");

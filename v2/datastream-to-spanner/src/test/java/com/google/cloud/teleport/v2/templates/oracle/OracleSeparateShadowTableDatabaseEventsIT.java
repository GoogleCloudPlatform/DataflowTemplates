...
public class OracleSeparateShadowTableDatabaseEventsIT extends DataStreamToSpannerITBase {
  ...
  public void setUp() throws IOException {
    ...
    synchronized (OracleSeparateShadowTableDatabaseEventsIT.class) {
      ...
      if (jobInfo == null) {
        ...
        executeSqlScript(cloudSqlResourceManager, "oracle/OracleSeparateShadowTableDatabaseEventsIT/oracle-schema.sql");
  ...
  private ConditionCheck writeUsersInitialData() {
    return new ConditionCheck() {
      ...
      @Override
      protected String getDescription() { return "Write initial Users data"; }
      @Override
      protected CheckResult check() {
        if (!executed) {
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Users\"(\"id\",\"name\",\"age\",\"subscribed\",\"plan\",\"startDate\") VALUES (1, 'Tester Kumar', 30, 0, 'A', TO_DATE('2023-01-01', 'YYYY-MM-DD'))");
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Users\"(\"id\",\"name\",\"age\",\"subscribed\",\"plan\",\"startDate\") VALUES (3, 'Tester Gupta', 50, 0, 'Z', TO_DATE('2023-06-07', 'YYYY-MM-DD'))");
  ...
  private ConditionCheck writeUsersNextData() {
    return new ConditionCheck() {
      boolean executed = false;
      @Override
      protected String getDescription() { return "Write next Users data"; }
      @Override
      protected CheckResult check() {
        if (!executed) {
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Users\"(\"id\",\"name\",\"age\",\"subscribed\",\"plan\",\"startDate\") VALUES (4, 'Tester', 38, 1, 'D', TO_DATE('2023-09-10', 'YYYY-MM-DD'))");
          cloudSqlResourceManager.runSQLUpdate("COMMIT");
          executed = true;
        }
  ...
  private ConditionCheck writeMovieInitialData() {
    return new ConditionCheck() {
      boolean executed = false;
      @Override
      protected String getDescription() { return "Write Movie data"; }
      @Override
      protected CheckResult check() {
        if (!executed) {
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Movie\"(\"id\",\"name\",\"startTime\",\"actor\") VALUES (1, 'movie1', TO_TIMESTAMP('2023-01-01 12:12:12', 'YYYY-MM-DD HH24:MI:SS'), 12345.09876)");
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Movie\"(\"id\",\"name\",\"startTime\",\"actor\") VALUES (2, 'movie2', TO_TIMESTAMP('2023-11-25 17:10:12', 'YYYY-MM-DD HH24:MI:SS'), 931.5123)");
          cloudSqlResourceManager.runSQLUpdate("COMMIT");
          executed = true;
        }
  ...
  private ConditionCheck writeArticlesInitialData() {
    return new ConditionCheck() {
      boolean executed = false;
      @Override
      protected String getDescription() { return "Write Articles data"; }
      @Override
      protected CheckResult check() {
        if (!executed) {
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Authors\"(\"author_id\",\"name\") VALUES (1, 'a1')");
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Authors\"(\"author_id\",\"name\") VALUES (2, 'a2')");
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Authors\"(\"author_id\",\"name\") VALUES (3, 'a3')");
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Authors\"(\"author_id\",\"name\") VALUES (4, 'a4')");
          
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Articles\"(\"id\",\"name\",\"published_date\",\"author_id\") VALUES (1, 'Article001', TO_DATE('2024-01-01', 'YYYY-MM-DD'), 1)");
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Articles\"(\"id\",\"name\",\"published_date\",\"author_id\") VALUES (2, 'Article002', TO_DATE('2024-01-01', 'YYYY-MM-DD'), 1)");
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Articles\"(\"id\",\"name\",\"published_date\",\"author_id\") VALUES (3, 'Article004', TO_DATE('2024-01-01', 'YYYY-MM-DD'), 4)");
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Articles\"(\"id\",\"name\",\"published_date\",\"author_id\") VALUES (4, 'Article005', TO_DATE('2024-01-01', 'YYYY-MM-DD'), 3)");

          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Books\"(\"id\",\"title\",\"author_id\") VALUES (1, 'Book005', 3)");
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Books\"(\"id\",\"title\",\"author_id\") VALUES (2, 'Book002', 3)");
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Books\"(\"id\",\"title\",\"author_id\") VALUES (3, 'Book004', 4)");
          cloudSqlResourceManager.runSQLUpdate("INSERT INTO \"Books\"(\"id\",\"title\",\"author_id\") VALUES (4, 'Book005', 2)");
          cloudSqlResourceManager.runSQLUpdate("COMMIT");
          executed = true;
        }
  ...
  private void assertUsersTableContents() {
    ...
    events.add(Map.of("id", 1, "name", "Tester Kumar", "age", 30, "subscribed", false, "plan", "A", "startDate", Date.parseDate("2023-01-01")));
    events.add(Map.of("id", 3, "name", "Tester Gupta", "age", 50, "subscribed", false, "plan", "Z", "startDate", Date.parseDate("2023-06-07")));
    events.add(Map.of("id", 4, "name", "Tester", "age", 38, "subscribed", true, "plan", "D", "startDate", Date.parseDate("2023-09-10")));
    SpannerAsserts.assertThatStructs(spannerResourceManager.runQuery("select * from Users where id in (1, 3, 4)"))
        .hasRecordsUnorderedCaseInsensitiveColumns(events);
  }

  private void assertMovieTableContents() {
    List<Map<String, Object>> events = new ArrayList<>();
    events.add(Map.of("id", 1, "name", "movie1", "startTime", Timestamp.parseTimestamp("2023-01-01T12:12:12Z")));
    events.add(Map.of("id", 2, "name", "movie2", "startTime", Timestamp.parseTimestamp("2023-11-25T17:10:12Z")));
    SpannerAsserts.assertThatStructs(spannerResourceManager.runQuery("select id, name, startTime from Movie where id in (1, 2)"))
        .hasRecordsUnorderedCaseInsensitiveColumns(events);
  ...
  private void assertBooksTable() {
    ...
    SpannerAsserts.assertThatStructs(spannerResourceManager.runQuery("select * from Books@{FORCE_INDEX=author_id_6}"))
        .hasRecordsUnorderedCaseInsensitiveColumns(events);
  }

  private void assertArticlesTable() {
    List<Map<String, Object>> events = new ArrayList<>();
    events.add(Map.of("id", 1, "name", "Article001", "published_date", Date.parseDate("2024-01-01"), "author_id", 1));
    events.add(Map.of("id", 2, "name", "Article002", "published_date", Date.parseDate("2024-01-01"), "author_id", 1));
    events.add(Map.of("id", 3, "name", "Article004", "published_date", Date.parseDate("2024-01-01"), "author_id", 4));
    events.add(Map.of("id", 4, "name", "Article005", "published_date", Date.parseDate("2024-01-01"), "author_id", 3));
    SpannerAsserts.assertThatStructs(spannerResourceManager.runQuery("select * from Articles@{FORCE_INDEX=author_id}"))
        .hasRecordsUnorderedCaseInsensitiveColumns(events);
  }
}

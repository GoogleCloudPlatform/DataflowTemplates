...
public class OracleDataStreamToSpannerFileOverridesIT extends DataStreamToSpannerITBase {
  private static final Logger LOG = LoggerFactory.getLogger(OracleDataStreamToSpannerFileOverridesIT.class);

  private static final String ORACLE_SCHEMA = "oracle/OracleDataStreamToSpannerFileOverridesIT/oracle-schema.sql";
  private static final String SPANNER_DDL_RESOURCE = "oracle/OracleDataStreamToSpannerFileOverridesIT/oracle-google_standard_sql-spanner-schema.sql";
  private static final String OVERRIDE_FILE = "oracle/OracleDataStreamToSpannerFileOverridesIT/override.json";

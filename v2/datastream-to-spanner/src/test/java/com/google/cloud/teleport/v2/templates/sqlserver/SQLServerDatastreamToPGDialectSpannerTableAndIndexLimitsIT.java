 ...
 * index data limits when migrating from a SQL Server database to PostgreSQL dialect Spanner.
 */
@Category({TemplateIntegrationTest.class, SkipDirectRunnerTest.class})
@TemplateIntegrationTest(DataStreamToSpanner.class)
@RunWith(JUnit4.class)
public class SQLServerDatastreamToPGDialectSpannerTableAndIndexLimitsIT
    extends DataStreamToSpannerITBase {

  private static final Logger LOG =
      LoggerFactory.getLogger(SQLServerDatastreamToPGDialectSpannerTableAndIndexLimitsIT.class);

  private static final String SQLSERVER_DDL_RESOURCE =
      "sqlserver/SQLServerDatastreamToPGDialectSpannerTableAndIndexLimitsIT/sqlserver-schema.sql";
  private static final String SPANNER_DDL_RESOURCE =
      "sqlserver/SQLServerDatastreamToPGDialectSpannerTableAndIndexLimitsIT/pg-dialect-spanner-schema.sql";
  private static final String SESSION_FILE =
      "sqlserver/SQLServerDatastreamToPGDialectSpannerTableAndIndexLimitsIT/pg-dialect-session.json";
  ...
  private static HashSet<SQLServerDatastreamToPGDialectSpannerTableAndIndexLimitsIT> testInstances =
      new HashSet<>();
  ...
  public void setUp() throws IOException {
    ...
    synchronized (SQLServerDatastreamToPGDialectSpannerTableAndIndexLimitsIT.class) {
      ...
      if (jobInfo == null) {
        ...
        jobInfo =
            launchDataflowJob(
                "sqlserver-table-index-limits-pg-dial",
                null,
                null,
                "sqlserver-datastream-to-pg-dialect-spanner-table-and-index-limits",
  ...
  public static void cleanUp() throws IOException {
    ...
    for (SQLServerDatastreamToPGDialectSpannerTableAndIndexLimitsIT instance : testInstances) {

 ...
 * template which multiple use-cases tested: 1. Foreign Keys. 2. Table Dropped. 3. Column Rename. 4.
 * DLQ Retry. 5. Missing PK 6. Indexes
 */
@Category({TemplateIntegrationTest.class, SkipDirectRunnerTest.class})
@TemplateIntegrationTest(DataStreamToSpanner.class)
@RunWith(JUnit4.class)
public class SeparateShadowTableDatabaseMixedIT extends DataStreamToSpannerITBase {
  ...
  private static HashSet<SeparateShadowTableDatabaseMixedIT> testInstances = new HashSet<>();
  ...
  public void setUp() throws IOException {
    ...
    synchronized (SeparateShadowTableDatabaseMixedIT.class) {
      ...
      if (jobInfo == null) {
        ...
        jobInfo =
            launchDataflowJob(
                ...
                null,
                "SeparateShadowTableDatabaseMixedIT",

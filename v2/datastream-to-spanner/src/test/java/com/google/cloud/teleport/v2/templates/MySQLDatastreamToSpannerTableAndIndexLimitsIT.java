...
public class MySQLDatastreamToSpannerTableAndIndexLimitsIT extends DataStreamToSpannerITBase {
  ...
  private static final Logger LOG =
      LoggerFactory.getLogger(MySQLDatastreamToSpannerTableAndIndexLimitsIT.class);

  private static final String MYSQL_DDL_RESOURCE = "MySQLTableAndIndexLimitsIT/mysql-schema.sql";
  private static final String SPANNER_DDL_RESOURCE =
      "MySQLTableAndIndexLimitsIT/spanner-schema.sql";
  private static final String SESSION_FILE = "MySQLTableAndIndexLimitsIT/session.json";
  ...
  private static HashSet<MySQLDatastreamToSpannerTableAndIndexLimitsIT> testInstances =
      new HashSet<>();
  ...
  public void setUp() throws IOException {
    ...
    synchronized (MySQLDatastreamToSpannerTableAndIndexLimitsIT.class) {
  ...
  public static void cleanUp() throws IOException {
    ...
    for (MySQLDatastreamToSpannerTableAndIndexLimitsIT instance : testInstances) {

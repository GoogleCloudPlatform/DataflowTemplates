...
public class DataStreamToSpannerShardedOracleRetryAllDLQIT extends DataStreamToSpannerITBase {
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    synchronized (DataStreamToSpannerShardedOracleRetryAllDLQIT.class) {
      ...
      if (jobInfo == null) {
        ...
        jdbcResourceManagerShardA = (org.apache.beam.it.gcp.cloudsql.CloudOracleResourceManager) org.apache.beam.it.gcp.cloudsql.CloudOracleResourceManager.builder(testName)
            ...
            .setPort(1521)
            .build();
        try { jdbcResourceManagerShardA.runSQLUpdate("DROP TABLE \"Customers\""); } catch (Exception e) {}
        try { jdbcResourceManagerShardA.runSQLUpdate("DROP TABLE \"Orders\""); } catch (Exception e) {}
        try { jdbcResourceManagerShardA.runSQLUpdate("DROP TABLE \"AllDataTypes\""); } catch (Exception e) {}
        executeSqlScript(jdbcResourceManagerShardA, ORACLE_SCHEMA_FILE_RESOURCE);
        
        jdbcResourceManagerShardA.runSQLUpdate("ALTER TABLE \"Customers\" ADD SUPPLEMENTAL LOG DATA (ALL) COLUMNS");
        jdbcResourceManagerShardA.runSQLUpdate("ALTER TABLE \"Orders\" ADD SUPPLEMENTAL LOG DATA (ALL) COLUMNS");
        jdbcResourceManagerShardA.runSQLUpdate("ALTER TABLE \"AllDataTypes\" ADD SUPPLEMENTAL LOG DATA (ALL) COLUMNS");
        
        gcsResourceManager = setUpSpannerITGcsResourceManager();

        datastreamResourceManager =
            org.apache.beam.it.gcp.datastream.DatastreamResourceManager.builder(testName, PROJECT, REGION)
        ...
        com.google.cloud.datastream.v1.DestinationConfig destinationConfig =
            datastreamResourceManager.buildGCSDestinationConfig(
                "gcs-profile", gcsResourceManager.getBucket(), GCS_PATH_PREFIX + "/cdc/", org.apache.beam.it.gcp.datastream.DatastreamResourceManager.DestinationOutputFormat.AVRO_FILE_FORMAT);

        com.google.cloud.datastream.v1.Stream stream =
            datastreamResourceManager.createStream(
                "test_stream_"+ org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(5).toLowerCase(),
                sourceConfig,
                destinationConfig);
        ...
        gcsResourceManager.createArtifact(
            "input/shardingConfig.conf", shardConfig.getBytes(java.nio.charset.StandardCharsets.UTF_8));
        gcsResourceManager.uploadArtifact(
            "input/overrides.json",
            com.google.common.io.Resources.getResource("oracle/DataStreamToSpannerShardedOracleRetryAllDLQIT/overrides.json").getPath());
        gcsResourceManager.uploadArtifact(
            "input/customShard.jar",
            getCustomShardJarPath());
        ...
        jobParameters.put("deadLetterQueueDirectory", getGcsPath(GCS_PATH_PREFIX + "/dlq/", gcsResourceManager));
        jobParameters.put("sourceConfigURL", getGcsPath("input/shardingConfig.conf", gcsResourceManager));
        // Explicitly set inputFilePattern for manual stream
        jobParameters.put("inputFilePattern", "gs://" + gcsResourceManager.getBucket() + "/" + GCS_PATH_PREFIX + "/cdc/");
  ...
  public void testDataStreamToSpannerShardedRetryAllDLQ() throws Exception {
    ...
    assertTrue("id=999 should NOT exist yet in AllDataTypes", !rowExistsInSpanner("AllDataTypes", "id", 999));
    assertTrue("id=2 should exist in Customers", rowExistsInSpanner("Customers", "CustomerId", 2));
    assertTrue("id=1 should NOT exist yet in Customers", !rowExistsInSpanner("Customers", "CustomerId", 1));
    assertTrue("id=102 should exist in Orders", rowExistsInSpanner("Orders", "OrderId", 102));
    assertTrue("id=101 should NOT exist yet in Orders", !rowExistsInSpanner("Orders", "OrderId", 101));
    assertTrue("id=103 should NOT exist yet in Orders", !rowExistsInSpanner("Orders", "OrderId", 103));
    ...
    retryParams.put("schemaOverridesFilePath", getGcsPath("input/overrides.json", gcsResourceManager));
    retryParams.put("transformationJarPath", getGcsPath("input/customShard.jar", gcsResourceManager));
    ...
    retryParams.put("deadLetterQueueDirectory", getGcsPath(GCS_PATH_PREFIX + "/dlq/", gcsResourceManager));
        ...
        DlqEventsCountCheck.builder(gcsResourceManager, GCS_PATH_PREFIX + "/dlq/retry/")
            ...
            .and(
                DlqEventsCountCheck.builder(gcsResourceManager, GCS_PATH_PREFIX + "/dlq/severe/")
                    .setMinEvents(1)
                    .build())
            .and(SpannerRowsCheck.builder(spannerResourceManager, "AllDataTypes").setMinRows(2).build())
    ...
    assertTrue("id=999 should exist in AllDataTypes", rowExistsInSpanner("AllDataTypes", "id", 999));
    assertTrue("id=3 should exist in Customers", rowExistsInSpanner("Customers", "CustomerId", 3));
    assertTrue("id=1 should NOT exist in Customers", !rowExistsInSpanner("Customers", "CustomerId", 1));

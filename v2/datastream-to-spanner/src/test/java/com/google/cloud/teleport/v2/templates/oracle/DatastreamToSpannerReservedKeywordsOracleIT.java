...
public class DatastreamToSpannerReservedKeywordsOracleIT extends DataStreamToSpannerITBase {
  ...
  public void testOracleReservedKeywords() throws Exception {
    ...
    oracleResourceManager.runSQLUpdate("ALTER TABLE \"true\" ADD SUPPLEMENTAL LOG DATA (ALL) COLUMNS");
    flushOracleLogs();
    ...
    OracleSource oracleSource =
        OracleSource.builder(
                ...
                oracleResourceManager.getDatabaseName())
            .setAllowedTables(Map.of(oracleResourceManager.getUsername().toUpperCase(), List.of("true")))
            .build();

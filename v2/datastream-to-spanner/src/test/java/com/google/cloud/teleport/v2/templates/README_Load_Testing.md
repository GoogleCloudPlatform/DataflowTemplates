...
4. Use [Gcloud Storage Compose](https://cloud.google.com/storage/docs/composing-objects#create-composite) to merge these CSV files and generate larger files of required row counts.
```shell

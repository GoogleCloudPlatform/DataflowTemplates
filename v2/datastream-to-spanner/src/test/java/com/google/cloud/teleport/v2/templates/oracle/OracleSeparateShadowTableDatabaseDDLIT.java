...
public class OracleSeparateShadowTableDatabaseDDLIT extends DataStreamToSpannerITBase {
  ...
  private static HashSet<OracleSeparateShadowTableDatabaseDDLIT> testInstances = new HashSet<>();
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    synchronized (OracleSeparateShadowTableDatabaseDDLIT.class) {
      ...
      if (jobInfo == null) {
        ...
        createAndUploadJarToGcs("OracleSeparateShadowTableDatabaseDDLIT", gcsResourceManager);
        ...
        jobInfo =
            launchDataflowJob(
                ...
                null,
                null,
                "OracleSeparateShadowTableDatabaseDDLIT",
  ...
  public static void cleanUp() throws IOException {
    for (OracleSeparateShadowTableDatabaseDDLIT instance : testInstances) {

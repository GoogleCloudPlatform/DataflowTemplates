...
public class OracleDataStreamToSpannerWideRowForMax16KeyTablePerDatabaseIT
  ...
  private static HashSet<OracleDataStreamToSpannerWideRowForMax16KeyTablePerDatabaseIT> testInstances =
      new HashSet<>();
    ...
    PipelineOperator.Result result =
        pipelineOperator()
            .waitForConditionAndCancel(
                PipelineOperator.Config.builder().setJobId(jobInfo.jobId()).setProject(PROJECT).setRegion(REGION).setTimeoutAfter(Duration.ofMinutes(45)).setCheckAfter(Duration.ofSeconds(5)).build(), conditionCheck);
  ...
  public static Map<String, Object> createSessionTemplate() {
    ...
    Map<String, Object> sessionTemplate = createSessionTemplate(NUM_TABLES, createColumnDefinitions(colIds), createPrimaryKeys(colIds));
      ...
      protected @NotNull CheckResult check() {
        ...
        for (String tableName : TABLE_NAMES) {
          ...
          try {
             ...
             org.slf4j.LoggerFactory.getLogger(OracleDataStreamToSpannerWideRowForMax16KeyTablePerDatabaseIT.class).error("FAILED TO EXECUTE SYSDBA SWITCH LOGFILE", e);
             e.printStackTrace();
          }

...
/**
 * Integration test for sharded data migration using a single Dataflow job for Oracle Source targeting Spanner.
 */
...
public class OracleDatastreamToSpannerSingleDFShardedMigrationIT extends DataStreamToSpannerITBase {
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    synchronized (OracleDatastreamToSpannerSingleDFShardedMigrationIT.class) {
      ...
      if (jobInfo == null) {
        ...
        jdbcResourceManagerShardA.runSQLUpdate("ALTER TABLE \"Users\" ADD SUPPLEMENTAL LOG DATA (ALL) COLUMNS");
        ...
        com.google.cloud.datastream.v1.DestinationConfig destinationConfig =
            datastreamResourceManager.buildGCSDestinationConfig(
                "gcs-profile", gcsResourceManager.getBucket(), "oracle-shard-cdc/cdc/", org.apache.beam.it.gcp.datastream.DatastreamResourceManager.DestinationOutputFormat.AVRO_FILE_FORMAT);
  ...
  private void insertDataInOracle() {
    ...
    // Force log file archive - needed so Datastream can see changes which are read from archived log files.
    // Explicit constraint: Hard-boot raw JDBC strictly mapping to FREE at " + System.getProperty("hostIp") + ":1521 (User: system, Pass: TestPassword123) calling ALTER SYSTEM SWITCH LOGFILE.
    try (java.sql.Connection conn = java.sql.DriverManager.getConnection("jdbc:oracle:thin:@" + System.getProperty("hostIp") + ":1521/XEPDB1", "system", "TestPassword123");

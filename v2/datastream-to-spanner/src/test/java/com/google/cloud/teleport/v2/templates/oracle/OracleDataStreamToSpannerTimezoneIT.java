...
public class OracleDataStreamToSpannerTimezoneIT extends DataStreamToSpannerITBase {
  private static final Logger LOG = LoggerFactory.getLogger(OracleDataStreamToSpannerTimezoneIT.class);
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    synchronized (OracleDataStreamToSpannerTimezoneIT.class) {
      ...
      if (jobInfo == null) {
        ...
        CloudOracleResourceManager.Builder sysBuilder = CloudOracleResourceManager.builder(testName);
        ...
        OracleSource oracleSource =
            OracleSource.builder(
                ...
                .setAllowedTables(Map.of(oracleResourceManager.getUsername().toUpperCase(), List.of("DateData")))
                .build();
  ...
  public static void cleanUp() throws IOException {
    ...
    ResourceManagerUtils.cleanResources(
        spannerResourceManager, pubsubResourceManager, gcsResourceManager, oracleResourceManager, cloudOracleSysUser, datastreamResourceManager);
  }

  @Test
  public void testTimezoneHandling() {
    ConditionCheck insertData = new ConditionCheck() {
      @Override
      ...
      protected CheckResult check() {
        try {
          oracleResourceManager.runSQLUpdate("INSERT INTO \"DateData\" (\"id\", \"timestamp_column\", \"datetime_column\") VALUES (1, TIMESTAMP '2024-02-02 10:00:00.000000', TIMESTAMP '2024-02-02 20:00:00.000000')");
          oracleResourceManager.runSQLUpdate("INSERT INTO \"DateData\" (\"id\", \"timestamp_column\", \"datetime_column\") VALUES (2, TIMESTAMP '2024-02-02 20:00:00.000000', TIMESTAMP '2024-02-03 06:00:00.000000')");

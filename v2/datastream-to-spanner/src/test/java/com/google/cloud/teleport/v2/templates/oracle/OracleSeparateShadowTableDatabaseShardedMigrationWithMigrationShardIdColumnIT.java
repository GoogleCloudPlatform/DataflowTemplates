...
public class OracleSeparateShadowTableDatabaseShardedMigrationWithMigrationShardIdColumnIT
    extends DataStreamToSpannerITBase {
  private static final Logger LOG =
      LoggerFactory.getLogger(
          OracleSeparateShadowTableDatabaseShardedMigrationWithMigrationShardIdColumnIT.class);
  ...
  private static HashSet<
          OracleSeparateShadowTableDatabaseShardedMigrationWithMigrationShardIdColumnIT>
  ...
  public static void cleanUp() throws IOException {
    for (OracleSeparateShadowTableDatabaseShardedMigrationWithMigrationShardIdColumnIT instance :
        testInstances) {

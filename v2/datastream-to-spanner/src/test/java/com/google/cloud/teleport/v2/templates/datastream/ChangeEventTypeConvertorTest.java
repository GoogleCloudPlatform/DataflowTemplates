...
public final class ChangeEventTypeConvertorTest {
  ...
  public void canConvertToBoolean() throws Exception {
    ...
    assertEquals(
        ChangeEventTypeConvertor.toBoolean(changeEvent, "bool_field1", /*requiredField=*/ true),
        new Boolean(true));
    assertEquals(
        ChangeEventTypeConvertor.toBoolean(changeEvent, "bool_field2", /*requiredField=*/ true),
        new Boolean(true));
    assertEquals(
        ChangeEventTypeConvertor.toBoolean(changeEvent, "bool_field3", /*requiredField=*/ true),
        new Boolean(true));
    assertEquals(
        ChangeEventTypeConvertor.toBoolean(changeEvent, "bool_field4", /*requiredField=*/ true),
        new Boolean(true));
    assertEquals(
        ChangeEventTypeConvertor.toBoolean(changeEvent, "bool_field5", /*requiredField=*/ true),
        new Boolean(true));
    assertEquals(
        ChangeEventTypeConvertor.toBoolean(changeEvent, "bool_field6", /*requiredField=*/ true),
        new Boolean(false));
    assertEquals(
        ChangeEventTypeConvertor.toBoolean(changeEvent, "bool_field7", /*requiredField=*/ true),
        new Boolean(false));
    assertEquals(
        ChangeEventTypeConvertor.toBoolean(changeEvent, "bool_field8", /*requiredField=*/ true),
        new Boolean(false));
    assertEquals(
        ChangeEventTypeConvertor.toBoolean(changeEvent, "bool_field9", /*requiredField=*/ true),
        new Boolean(false));
    assertEquals(
        ChangeEventTypeConvertor.toBoolean(changeEvent, "bool_field10", /*requiredField=*/ true),
        new Boolean(false));
    assertNull(
        ChangeEventTypeConvertor.toBoolean(changeEvent, "bool_field11", /*requiredField=*/ false));
    assertNull(
        ChangeEventTypeConvertor.toBoolean(changeEvent, "non_existent", /*requiredField=*/ false));
  }
  ...
  public void canConvertToLong() throws Exception {
    ...
    assertEquals(
        ChangeEventTypeConvertor.toLong(changeEvent, "field1", /*requiredField=*/ true),
        new Long(123456789));
    assertEquals(
        ChangeEventTypeConvertor.toLong(changeEvent, "field2", /*requiredField=*/ true),
        new Long(-123456789));
    assertEquals(
        ChangeEventTypeConvertor.toLong(changeEvent, "field3", /*requiredField=*/ true),
        new Long(123456));
    assertEquals(
        ChangeEventTypeConvertor.toLong(changeEvent, "field4", /*requiredField=*/ true),
        new Long(-123456));
    assertEquals(
        ChangeEventTypeConvertor.toLong(changeEvent, "field5", /*requiredField=*/ true),
        new Long(123456789));
    assertEquals(
        ChangeEventTypeConvertor.toLong(changeEvent, "field6", /*requiredField=*/ true),
        new Long(-123456789));
    assertEquals(
        ChangeEventTypeConvertor.toLong(changeEvent, "field7", /*requiredField=*/ true),
        new Long(123456));
    assertEquals(
        ChangeEventTypeConvertor.toLong(changeEvent, "field8", /*requiredField=*/ true),
        new Long(-123456));
  ...
  public void canConvertToDouble() throws Exception {
    ...
    assertEquals(
        ChangeEventTypeConvertor.toDouble(changeEvent, "field1", /*requiredField=*/ true),
        new Double(123456789));
    assertEquals(
        ChangeEventTypeConvertor.toDouble(changeEvent, "field2", /*requiredField=*/ true),
        new Double(-123456789));
    assertEquals(
        ChangeEventTypeConvertor.toDouble(changeEvent, "field3", /*requiredField=*/ true),
        new Double(123456.789));
    assertEquals(
        ChangeEventTypeConvertor.toDouble(changeEvent, "field4", /*requiredField=*/ true),
        new Double(-123456.789));
    assertEquals(
        ChangeEventTypeConvertor.toDouble(changeEvent, "field5", /*requiredField=*/ true),
        new Double(123456789));
    assertEquals(
        ChangeEventTypeConvertor.toDouble(changeEvent, "field6", /*requiredField=*/ true),
        new Double(-123456789));
    assertEquals(
        ChangeEventTypeConvertor.toDouble(changeEvent, "field7", /*requiredField=*/ true),
        new Double(123456.789));
    assertEquals(
        ChangeEventTypeConvertor.toDouble(changeEvent, "field8", /*requiredField=*/ true),
        new Double(-123456.789));
    assertEquals(
        ChangeEventTypeConvertor.toDouble(changeEvent, "field9", /*requiredField=*/ true),
  ...
  public void canConvertToString() throws Exception {
    ...
    assertEquals(
        ChangeEventTypeConvertor.toString(changeEvent, "field1", /*requiredField=*/ true),
        new String(";asidjf987asd"));
    assertEquals(
        ChangeEventTypeConvertor.toString(changeEvent, "field2", /*requiredField=*/ true),
        new String(""));
    assertEquals(
        ChangeEventTypeConvertor.toString(changeEvent, "field3", /*requiredField=*/ true),
        new String("1.2345678901234567E8"));
    assertEquals(
        ChangeEventTypeConvertor.toString(changeEvent, "field4", /*requiredField=*/ true),
        new String("123456789"));
    assertEquals(
        ChangeEventTypeConvertor.toString(changeEvent, "field5", /*requiredField=*/ true),
        new String("true"));
  ...
  public void canConvertToByteArray() throws Exception {
    ...
    assertEquals(
        ChangeEventTypeConvertor.toByteArray(changeEvent, "field1", /*requiredField=*/ true),
        ByteArray.copyFrom("asidjf987asd"));
    assertEquals(
        ChangeEventTypeConvertor.toByteArray(changeEvent, "field2", /*requiredField=*/ true),
        ByteArray.copyFrom(""));
    assertEquals(
        ChangeEventTypeConvertor.toByteArray(changeEvent, "field3", /*requiredField=*/ true),
        ByteArray.copyFrom("123456789"));
    assertEquals(
        ChangeEventTypeConvertor.toByteArray(changeEvent, "field4", /*requiredField=*/ true),
        ByteArray.copyFrom("true"));
    assertNull(
        ChangeEventTypeConvertor.toByteArray(changeEvent, "field5", /*requiredField=*/ false));
  }
  ...
  public void canConvertToTimestamp() throws Exception {
    ...
    assertEquals(
        ChangeEventTypeConvertor.toTimestamp(changeEvent, "field1", /*requiredField=*/ true),
        Timestamp.parseTimestamp("2020-12-30T12:12:12Z"));
    assertEquals(
        ChangeEventTypeConvertor.toTimestamp(changeEvent, "field2", /*requiredField=*/ true),
        Timestamp.parseTimestamp("2020-12-30T12:12:12.1Z"));
    assertEquals(
        ChangeEventTypeConvertor.toTimestamp(changeEvent, "field3", /*requiredField=*/ true),
        Timestamp.parseTimestamp("2020-12-30T12:12:12.123Z"));
    assertEquals(
        ChangeEventTypeConvertor.toTimestamp(changeEvent, "field4", /*requiredField=*/ true),
        Timestamp.parseTimestamp("2020-12-30T12:12:12Z"));
    assertEquals(
        ChangeEventTypeConvertor.toTimestamp(changeEvent, "field5", /*requiredField=*/ true),
        Timestamp.parseTimestamp("2020-12-30T12:12:12.1Z"));
    assertEquals(
        ChangeEventTypeConvertor.toTimestamp(changeEvent, "field6", /*requiredField=*/ true),
        Timestamp.parseTimestamp("2020-12-30T12:12:12.123Z"));
    assertNull(
        ChangeEventTypeConvertor.toTimestamp(changeEvent, "field7", /*requiredField=*/ false));
  }
  ...
  public void canConvertToDate() throws Exception {
    ...
    assertEquals(
        ChangeEventTypeConvertor.toDate(changeEvent, "field1", /*requiredField=*/ true),
        Date.parseDate("2020-12-30"));
    assertEquals(
        ChangeEventTypeConvertor.toDate(changeEvent, "field2", /*requiredField=*/ true),
        Date.parseDate("2020-12-30"));
    assertEquals(
        ChangeEventTypeConvertor.toDate(changeEvent, "field3", /*requiredField=*/ true),
        Date.parseDate("2020-12-30"));
    assertEquals(
        ChangeEventTypeConvertor.toDate(changeEvent, "field4", /*requiredField=*/ true),
        Date.parseDate("2020-12-30"));
    assertEquals(
        ChangeEventTypeConvertor.toDate(changeEvent, "field5", /*requiredField=*/ true),
        Date.parseDate("2020-12-30"));

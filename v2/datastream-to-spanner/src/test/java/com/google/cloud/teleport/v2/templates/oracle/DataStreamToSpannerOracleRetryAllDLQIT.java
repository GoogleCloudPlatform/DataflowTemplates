...
public class DataStreamToSpannerOracleRetryAllDLQIT extends DataStreamToSpannerITBase {
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    synchronized (DataStreamToSpannerOracleRetryAllDLQIT.class) {
      ...
      if (jobInfo == null) {
        ...
        List.of("Customers", "Orders", "AllDataTypes").forEach(
            tableName -> {
  ...
  public void testDataStreamToSpannerRetryAllDLQ() throws Exception {
    ...
    retryJobParameters.put("schemaOverridesFilePath", getGcsPath("input/overrides.json", gcsResourceManager));
    retryJobParameters.put("transformationJarPath", getGcsPath("input/customShard.jar", gcsResourceManager));
    ...
    retryJobParameters.put("deadLetterQueueDirectory", getGcsPath(GCS_PATH_PREFIX + "/dlq/", gcsResourceManager));

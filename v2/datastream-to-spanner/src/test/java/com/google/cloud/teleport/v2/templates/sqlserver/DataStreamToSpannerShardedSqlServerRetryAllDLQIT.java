...
/**
 * Integration test for live replication from SQL Server to Spanner using the retryAllDLQ mode for a
 * sharded setup.
 */
@Category({TemplateIntegrationTest.class, SkipDirectRunnerTest.class})
@TemplateIntegrationTest(DataStreamToSpanner.class)
@RunWith(JUnit4.class)
public class DataStreamToSpannerShardedSqlServerRetryAllDLQIT extends DataStreamToSpannerITBase {

  private static final Logger LOG =
      LoggerFactory.getLogger(DataStreamToSpannerShardedSqlServerRetryAllDLQIT.class);
  private static final String SPANNER_DDL_RESOURCE =
      "sqlserver/DataStreamToSpannerShardedSqlServerRetryAllDLQIT/spanner-schema.sql";
  private static final String SQLSERVER_SCHEMA_FILE_RESOURCE =
      "sqlserver/DataStreamToSpannerShardedSqlServerRetryAllDLQIT/sqlserver-schema.sql";
  private static final String OVERRIDES_FILE_RESOURCE =
      "sqlserver/DataStreamToSpannerShardedSqlServerRetryAllDLQIT/overrides.json";
  private static final String GCS_PATH_PREFIX =
      "sqlserver-datastream-to-spanner-sharded-retryall-test";

  private static final HashSet<DataStreamToSpannerShardedSqlServerRetryAllDLQIT> testInstances =
      new HashSet<>();
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    synchronized (DataStreamToSpannerShardedSqlServerRetryAllDLQIT.class) {
  ...
  public static void cleanUp() throws IOException {
    for (DataStreamToSpannerShardedSqlServerRetryAllDLQIT instance : testInstances) {
  ...
  public void testDataStreamToSpannerShardedRetryAllDLQ() throws Exception {
    LOG.info("Starting testDataStreamToSpannerShardedRetryAllDLQ");
    ...
    // 7. Wait for retry job completion

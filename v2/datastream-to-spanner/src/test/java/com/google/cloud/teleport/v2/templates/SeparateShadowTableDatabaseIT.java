...
public class SeparateShadowTableDatabaseIT extends DataStreamToSpannerITBase {
  private static final String SPANNER_DDL_RESOURCE =
      "SeparateShadowTableDatabaseIT/spanner-schema.sql";

  private static HashSet<SeparateShadowTableDatabaseIT> testInstances = new HashSet<>();
  ...
  public void setUp() throws IOException {
    ...
    synchronized (SeparateShadowTableDatabaseIT.class) {
  ...
  public static void cleanUp() throws IOException {
    for (SeparateShadowTableDatabaseIT instance : testInstances) {

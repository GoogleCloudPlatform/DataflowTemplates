...
/** Integration test for live replication from SQL Server to Spanner using the retryAllDLQ mode. */
@Category({TemplateIntegrationTest.class, SkipDirectRunnerTest.class})
@TemplateIntegrationTest(DataStreamToSpanner.class)
@RunWith(JUnit4.class)
public class DataStreamToSpannerSqlServerRetryAllDLQIT extends DataStreamToSpannerITBase {

  private static final Logger LOG =
      LoggerFactory.getLogger(DataStreamToSpannerSqlServerRetryAllDLQIT.class);
  private static final String SPANNER_DDL_RESOURCE =
      "sqlserver/DataStreamToSpannerSqlServerRetryAllDLQIT/spanner-schema.sql";
  private static final String SQLSERVER_SCHEMA_FILE_RESOURCE =
      "sqlserver/DataStreamToSpannerSqlServerRetryAllDLQIT/sqlserver-schema.sql";
  private static final String OVERRIDES_FILE_RESOURCE =
      "sqlserver/DataStreamToSpannerSqlServerRetryAllDLQIT/overrides.json";
  private static final String GCS_PATH_PREFIX = "sqlserver-datastream-to-spanner-retryalldlq-test";

  private static final HashSet<DataStreamToSpannerSqlServerRetryAllDLQIT> testInstances =
      new HashSet<>();
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    synchronized (DataStreamToSpannerSqlServerRetryAllDLQIT.class) {
  ...
  public static void cleanUp() throws IOException {
    for (DataStreamToSpannerSqlServerRetryAllDLQIT instance : testInstances) {
  ...
  public void testDataStreamToSpannerRetryAllDLQ() throws Exception {
    ...
    // 2. Insert test data into SQL Server source
    ...
    // 8. Verify target Spanner database
    assertTrue(

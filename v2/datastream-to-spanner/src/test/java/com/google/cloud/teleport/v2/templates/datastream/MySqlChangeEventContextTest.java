...
/**
 * Unit tests
 * 1) ChangeEventContextFactory methods for mysql change events.
 * 2) shadow table generation for mysql change events.
 */
public final class MySqlChangeEventContextTest {
  ...
  public void canGenerateShadowTableMutation() throws Exception {
    ...
    expected.put(DatastreamConstants.MYSQL_TIMESTAMP_SHADOW_INFO.getLeft(),
        Value.int64(eventTimestamp));
    expected.put(DatastreamConstants.MYSQL_LOGFILE_SHADOW_INFO.getLeft(),
        Value.string("file1.log"));
    expected.put(DatastreamConstants.MYSQL_LOGPOSITION_SHADOW_INFO.getLeft(),
        Value.int64(1));

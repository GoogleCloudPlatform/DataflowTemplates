...
/**
 * Integration test for live replication from MySQL to Spanner using the retryAllDLQ mode.
 *
...
public class DataStreamToSpannerMySQLRetryAllDLQIT extends DataStreamToSpannerITBase {

  private static final Logger LOG =
      LoggerFactory.getLogger(DataStreamToSpannerMySQLRetryAllDLQIT.class);
  private static final String SPANNER_DDL_RESOURCE =
      "DataStreamToSpannerMySQLRetryAllDLQIT/spanner-schema.sql";
  private static final String MYSQL_SCHEMA_FILE_RESOURCE =
      "DataStreamToSpannerMySQLRetryAllDLQIT/mysql-schema.sql";
  private static final String OVERRIDES_FILE_RESOURCE =
      "DataStreamToSpannerMySQLRetryAllDLQIT/overrides.json";
  private static final String GCS_PATH_PREFIX = "mysql-datastream-to-spanner-retryalldlq-test";

  private static final HashSet<DataStreamToSpannerMySQLRetryAllDLQIT> testInstances =
      new HashSet<>();
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    synchronized (DataStreamToSpannerMySQLRetryAllDLQIT.class) {
      ...
      if (jobInfo == null) {
        ...
        // Launch regular pipeline using ITBase method - CHECK THIS
        jobInfo =
            launchDataflowJob(
  ...
  public static void cleanUp() throws IOException {
    for (DataStreamToSpannerMySQLRetryAllDLQIT instance : testInstances) {
  ...
  public void testDataStreamToSpannerRetryAllDLQ() throws Exception {
    ...
    // Verify all datatypes for id=999

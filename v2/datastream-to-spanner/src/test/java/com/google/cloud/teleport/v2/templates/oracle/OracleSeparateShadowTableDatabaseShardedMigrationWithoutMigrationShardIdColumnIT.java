...
public class OracleSeparateShadowTableDatabaseShardedMigrationWithoutMigrationShardIdColumnIT extends DataStreamToSpannerITBase {
  private static final Logger LOG = LoggerFactory.getLogger(OracleSeparateShadowTableDatabaseShardedMigrationWithoutMigrationShardIdColumnIT.class);

  private static final String TABLE = "Users";
  private static final String SPANNER_DDL_RESOURCE =
      "oracle/OracleSeparateShadowTableDatabaseShardedMigrationWithoutMigrationShardIdColumnIT/oracle-google_standard_sql-spanner-schema.sql";
  private static final String SESSION_FILE_RESOURCE =
      "oracle/OracleSeparateShadowTableDatabaseShardedMigrationWithoutMigrationShardIdColumnIT/oracle-session.json";

  private static PipelineLauncher.LaunchInfo jobInfo;
  private static HashSet<OracleSeparateShadowTableDatabaseShardedMigrationWithoutMigrationShardIdColumnIT> testInstances = new HashSet<>();
  ...
  public void setUp() throws Exception {
    ...
    synchronized (OracleSeparateShadowTableDatabaseShardedMigrationWithoutMigrationShardIdColumnIT.class) {
      ...
      if (jobInfo == null) {
        ...
        executeSqlScript(jdbcResourceManagerShardA, "oracle/OracleSeparateShadowTableDatabaseShardedMigrationWithoutMigrationShardIdColumnIT/oracle-schema.sql");
  ...
  public static void cleanUp() throws IOException {
    for (OracleSeparateShadowTableDatabaseShardedMigrationWithoutMigrationShardIdColumnIT instance : testInstances) {
  ...
  private void assertUsersTableContents() {
    ...
    events.add(Map.of("id", 1, "name", "Tester1", "age", 20));
    events.add(Map.of("id", 3, "name", "Tester3", "age", 103));
    events.add(Map.of("id", 13, "name", "Tester13", "age", 113));
    events.add(Map.of("id", 4, "name", "Tester4", "age", 104));
    events.add(Map.of("id", 5, "name", "Tester5", "age", 105));
    events.add(Map.of("id", 6, "name", "Tester6", "age", 106));
    events.add(Map.of("id", 7, "name", "Tester7", "age", 107));
    events.add(Map.of("id", 8, "name", "Tester8", "age", 108));
    events.add(Map.of("id", 9, "name", "Tester9", "age", 109));
    events.add(Map.of("id", 10, "name", "Tester10", "age", 110));
    events.add(Map.of("id", 11, "name", "Tester11", "age", 111));
    events.add(Map.of("id", 12, "name", "Tester12", "age", 112));

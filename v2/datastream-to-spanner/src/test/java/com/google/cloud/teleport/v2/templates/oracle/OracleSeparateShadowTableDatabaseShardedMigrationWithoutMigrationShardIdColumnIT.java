...
public class OracleSeparateShadowTableDatabaseShardedMigrationWithoutMigrationShardIdColumnIT
    extends DataStreamToSpannerITBase {
  private static final Logger LOG =
      LoggerFactory.getLogger(
          OracleSeparateShadowTableDatabaseShardedMigrationWithoutMigrationShardIdColumnIT.class);
  ...
  private static HashSet<
          OracleSeparateShadowTableDatabaseShardedMigrationWithoutMigrationShardIdColumnIT>
  ...
  public void setUp() throws Exception {
    ...
    synchronized (
      ...
      if (jobInfo == null) {
        ...
        String uniqueCdcPrefix =
            "oracle-shard-cdc_"
                + org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(5).toLowerCase()
                + "/cdc/";
        ...
        com.google.cloud.datastream.v1.Stream stream =
            datastreamResourceManager.createStream(
                "test_stream_" + RandomStringUtils.randomAlphanumeric(5).toLowerCase(),
                sourceConfig,
                destinationConfig);
        ...
        jobParams.put(
            "inputFilePattern", "gs://" + gcsResourceManager.getBucket() + "/" + uniqueCdcPrefix);
  ...
  public void multiShardMigration() throws Exception {
    ...
    PipelineOperator.Result result =
        pipelineOperator()
            .waitForCondition(createConfig(jobInfo, Duration.ofMinutes(15)), rowsConditionCheck);

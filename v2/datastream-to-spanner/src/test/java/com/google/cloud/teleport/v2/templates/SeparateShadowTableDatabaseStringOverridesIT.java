 ...
 * template which test use-cases where an override is provided by string parameters.
 */
...
public class SeparateShadowTableDatabaseStringOverridesIT extends DataStreamToSpannerITBase {
  ...
  private static HashSet<SeparateShadowTableDatabaseStringOverridesIT> testInstances =
      new HashSet<>();
  ...
  public void setUp() throws IOException {
    ...
    synchronized (SeparateShadowTableDatabaseStringOverridesIT.class) {
  ...
  public static void cleanUp() throws IOException {
    for (SeparateShadowTableDatabaseStringOverridesIT instance : testInstances) {

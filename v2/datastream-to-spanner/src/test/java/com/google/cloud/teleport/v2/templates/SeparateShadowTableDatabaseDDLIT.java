...
/**
 * Integration test using separate shadow table database for datatype conversions for {@link
 * DataStreamToSpanner} Flex template.
 */
@Category({TemplateIntegrationTest.class, SkipDirectRunnerTest.class})
@TemplateIntegrationTest(DataStreamToSpanner.class)
@RunWith(JUnit4.class)
public class SeparateShadowTableDatabaseDDLIT extends DataStreamToSpannerITBase {
  private static final Logger LOG = LoggerFactory.getLogger(SeparateShadowTableDatabaseDDLIT.class);
  ...
  private static HashSet<SeparateShadowTableDatabaseDDLIT> testInstances = new HashSet<>();
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    synchronized (SeparateShadowTableDatabaseDDLIT.class) {
      ...
      if (jobInfo == null) {
        ...
        createAndUploadJarToGcs(gcsResourceManager, "SeparateShadowTableDatabaseDDLIT");
        ...
        jobInfo =
            launchDataflowJob(
                ...
                null,
                null,
                "SeparateShadowTableDatabaseDDLIT",

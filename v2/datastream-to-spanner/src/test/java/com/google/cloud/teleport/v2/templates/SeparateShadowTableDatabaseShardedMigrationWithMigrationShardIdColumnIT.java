...
/**
 * Sharded data migration Integration test using separate shadow table database with addition of
 * migration_shard_id column in the schema for each table in the {@link DataStreamToSpanner} Flex
 * template.
 */
@Category({TemplateIntegrationTest.class, SkipDirectRunnerTest.class})
@TemplateIntegrationTest(DataStreamToSpanner.class)
@RunWith(JUnit4.class)
public class SeparateShadowTableDatabaseShardedMigrationWithMigrationShardIdColumnIT
    extends DataStreamToSpannerITBase {

  private static final Logger LOG =
      LoggerFactory.getLogger(
          SeparateShadowTableDatabaseShardedMigrationWithMigrationShardIdColumnIT.class);
  ...
  private static HashSet<SeparateShadowTableDatabaseShardedMigrationWithMigrationShardIdColumnIT>
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    synchronized (SeparateShadowTableDatabaseShardedMigrationWithMigrationShardIdColumnIT.class) {
  ...
  public static void cleanUp() throws IOException {
    for (SeparateShadowTableDatabaseShardedMigrationWithMigrationShardIdColumnIT instance :
        testInstances) {

...
public class OracleDataStreamToSpannerIT extends SpannerTemplateITBase {
  ...
  private void simpleOracleToSpannerTest(
    ...
    cloudOracleSysUser = (CloudOracleResourceManager) CloudOracleResourceManager.builder(testName)
        .setUsername("sys as sysdba")
        .setPassword(System.getProperty("cloudProxyPassword"))
        .setDatabaseName("XE").setHost(System.getProperty("hostIp")).setPort(1521)
        .build();
...
//     setUpOracleUser(oracleUser, oraclePassword);
    ...
    cloudSqlResourceManager = (CloudOracleResourceManager) CloudOracleResourceManager.builder(testName)
        ...
        .setDatabaseName("XEPDB1").setHost(System.getProperty("hostIp")).setPort(1521)
        .build();

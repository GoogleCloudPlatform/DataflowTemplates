...
public final class OracleChangeEventSequenceTest {
  ...
  public void canOrderBasedOnTimestamp() {
    OracleChangeEventSequence oldEvent =
        new OracleChangeEventSequence(previousEventTimestamp, 2L);
    OracleChangeEventSequence newEvent =
        new OracleChangeEventSequence(eventTimestamp, 2L);
  ...
  public void canOrderBasedOnScn() {
    OracleChangeEventSequence oldEvent =
        new OracleChangeEventSequence(eventTimestamp, 2L);
    OracleChangeEventSequence newEvent =
        new OracleChangeEventSequence(eventTimestamp, 3L);
  ...
  public void canOrderDumpEventAndCDCEventAtSameTimestamp() {
    OracleChangeEventSequence dumpEvent =
        new OracleChangeEventSequence(eventTimestamp, -1L);
    OracleChangeEventSequence cdcEvent =
        new OracleChangeEventSequence(eventTimestamp, 3L);

...
public class DataStreamToSpannerOracleStringOverridesIT extends DataStreamToSpannerITBase {
  ...
  private static HashSet<DataStreamToSpannerOracleStringOverridesIT> testInstances = new HashSet<>();
  ...
  public void setUp() throws IOException {
    ...
    synchronized (DataStreamToSpannerOracleStringOverridesIT.class) {
      ...
      if (jobInfo == null) {
        ...
        try { oracleResourceManager.runSQLUpdate("DROP TABLE \"person1\""); } catch(Exception e) {} 
        executeSqlScript(oracleResourceManager, ORACLE_DDL_RESOURCE);
        
        try {
            oracleResourceManager.runSQLUpdate("GRANT EXECUTE_CATALOG_ROLE TO c##datastream CONTAINER=ALL");
        } catch(Exception e) {
        ...
        OracleSource oracleSource = OracleSource.builder(
            ...
            .setAllowedTables(Map.of(oracleResourceManager.getUsername().toUpperCase(), List.of("person1")))
            .build();
  ...
  public static void cleanUp() throws IOException {
    ...
    ResourceManagerUtils.cleanResources(
        spannerResourceManager, pubsubResourceManager, gcsResourceManager, oracleResourceManager, datastreamResourceManager);
  }

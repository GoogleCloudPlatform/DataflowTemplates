...
output "resource_ids" {
  ...
  value = {
    datastream_source_connection_profile = google_datastream_connection_profile.source_mysql.connection_profile_id
    ...
    dataflow_job                         = var.dataflow_params.skip_dataflow ? "Dataflow job creation skipped" : google_dataflow_flex_template_job.live_migration_job[0].job_id
  }
}
...
output "resource_urls" {
  ...
  value = {
    datastream_source_connection_profile = "https://console.cloud.google.com/datastream/connection-profiles/locations/${var.common_params.region}/instances/${google_datastream_connection_profile.source_mysql.connection_profile_id}?project=${var.common_params.project}"
    ...
    dataflow_job                         = var.dataflow_params.skip_dataflow ? "Dataflow job creation skipped" : "https://console.cloud.google.com/dataflow/jobs/${var.common_params.region}/${google_dataflow_flex_template_job.live_migration_job[0].job_id}?project=${var.common_params.project}"
  }
  depends_on = [

...
resource "google_datastream_private_connection" "datastream_private_connection" {
  ...
  vpc_peering_config {
    vpc    = "projects/${var.common_params.project}/global/networks/${var.common_params.datastream_params.private_connectivity.vpc_name}"
...
resource "google_dataflow_flex_template_job" "live_migration_job" {
  ...
  parameters = {
    ...
    transformationContextFilePath   = var.shard_list[count.index].dataflow_params.template_params.local_transformation_context_path != null ? "gs://${google_storage_bucket_object.transformation_context_file_object[count.index].bucket}/${google_storage_bucket_object.transformation_context_file_object[count.index].name}" : null
  ...
  subnetwork                   = var.common_params.dataflow_params.runner_params.subnetwork

 ...
 * the License.
 */
package com.google.cloud.teleport.v2.spanner.endToEnd;
...
/**
 * Integration test for End To End Migrations Flex template for basic run including new spanner
 * tables and column rename use-case.
 */
@Category({TemplateIntegrationTest.class, SkipDirectRunnerTest.class})
@TemplateIntegrationTest(Schema.class)

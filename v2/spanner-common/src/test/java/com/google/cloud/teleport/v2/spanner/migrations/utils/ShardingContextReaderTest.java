...
public class ShardingContextReaderTest {
  ...
  public void readShardingContextFileInvalidPath() {
    String filePath = "path/to/sharding/context/file";
    ShardingContext shardingContext = ShardingContextReader.getShardingContext(filePath);
  }
}

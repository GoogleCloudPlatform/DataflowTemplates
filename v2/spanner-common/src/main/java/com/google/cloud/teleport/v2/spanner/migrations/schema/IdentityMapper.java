...
/**
 * This mapper directly maps table and column names without any modification. For fetching destination data types, it uses {@link Ddl}.
 */
public class IdentityMapper implements ISchemaMapper {
    ...
    public String getSpannerColumnName(String srcTable, String srcColumn) throws NoSuchElementException {
        ...
        if (spTable.column(srcColumn) == null) {
            throw new NoSuchElementException(String.format("Spanner column '%s' not found for table '%s'", srcColumn, srcTable));
        }
        return srcColumn;
    }

      ...
      case POSTGRESQL:
        {
          ...
          if (spannerType.equals(Type.Code.PG_FLOAT8.getName()) || spannerType.equalsIgnoreCase("float8")) {
            return t(Type.pgFloat8(), null);
          }
          if (spannerType.equals(Type.Code.PG_FLOAT4.getName()) || spannerType.equalsIgnoreCase("float4")) {

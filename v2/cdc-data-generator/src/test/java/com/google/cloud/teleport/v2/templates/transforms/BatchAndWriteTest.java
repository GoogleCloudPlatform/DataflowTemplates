...
/** Unit tests for {@link BatchAndWrite}. */
...
public class BatchAndWriteTest {
  ...
  @Test
  public void testBatchAndWriteExpansion() {
    ...
    PCollection<String> output = input.apply("BatchAndWriteTransform", transform);

    assertNotNull(output);
    assertNotNull(output.getCoder());

...
1.  **Generate YAML Template:**
    ...
    If desired, you can create the Java YAML template with the help of the generation script.

    ```shell
    python yaml/src/main/python/generate_yaml_java_templates.py yaml/src/main/yaml/YAML_TEMPLATE_FILE_NAME.yaml
    ```

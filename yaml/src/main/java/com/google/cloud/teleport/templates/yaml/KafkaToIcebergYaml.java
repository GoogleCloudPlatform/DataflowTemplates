...
@Template(
    ...
    description = "The Kafka to Iceberg template is a streaming pipeline that reads data from Kafka and writes to an Iceberg table.",
    flexContainerName = "pipeline-yaml",
    yamlTemplateFile = "KafkaToIceberg.yaml",
    filesToCopy = {"main.py", "requirements.txt", "options/kafka_options.yaml", "options/iceberg_options.yaml"},
    documentation = "",
    contactInformation = "https://cloud.google.com/support",
    requirements = {"The Input Kafka topic must exist.",

...
@Template(
    name = "Iceberg_To_AlloyDB_Yaml",
    category = TemplateCategory.BATCH,
    type = Template.TemplateType.YAML,
    displayName = "Iceberg to AlloyDB (YAML)",
    description = "The Iceberg to AlloyDB template is a batch pipeline that reads data from an Iceberg table and outputs the records to an AlloyDB database table.",
    flexContainerName = "pipeline-yaml",
    yamlTemplateFile = "IcebergToAlloyDB.yaml",
    filesToCopy = {"main.py", "requirements.txt", "options/iceberg_options.yaml", "options/alloydb_options.yaml"},
    documentation = "",
    contactInformation = "https://cloud.google.com/support",
    requirements = {"The Input Iceberg table must exist and be accessible through the provided catalog.",
      "The Output AlloyDB instance must exist and the target table must exist or be created."
    },
    streaming = false,
    hidden = false)
public interface IcebergToAlloyDBYaml {

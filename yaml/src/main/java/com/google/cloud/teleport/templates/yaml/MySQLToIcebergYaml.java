...
@Template(
    ...
    description = "The MySQL to Iceberg template is a batch pipeline executes the user provided SQL query to read data from MySQL table and outputs the records to Iceberg table.",
    ...
    requirements = {"The Input MySQL instance and table must exist.",

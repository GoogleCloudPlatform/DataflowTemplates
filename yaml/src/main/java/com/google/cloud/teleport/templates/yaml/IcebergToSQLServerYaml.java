...
@Template(
    ...
    description = "The Iceberg to SqlServer template is a batch pipeline that reads data from an Iceberg table and outputs the records to a SqlServer database table.",
    flexContainerName = "pipeline-yaml",
    yamlTemplateFile = "IcebergToSQLServer.yaml",
    filesToCopy = {"main.py", "requirements.txt", "options/iceberg_options.yaml", "options/sqlserver_options.yaml"},
    documentation = "",
...
public interface IcebergToSQLServerYaml {
  ...
  @TemplateParameter.Text(
      ...
      optional = true,
      description = "The fully-qualified class name of the JDBC driver. Default: com.microsoft.sqlserver.jdbc.SQLServerDriverr",

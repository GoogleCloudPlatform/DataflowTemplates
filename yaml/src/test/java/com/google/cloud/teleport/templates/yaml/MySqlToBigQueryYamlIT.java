...
public class MySqlToBigQueryYamlIT extends JdbcToBigQueryYamlBase {

  @Test
  public void testMySqlToBigQueryYaml() throws IOException {
    ...
    // Run a simple IT
    simpleJdbcToBigQueryTest(schema, mySQLResourceManager, true, Map.of("query", getQueryString()));
  }
}

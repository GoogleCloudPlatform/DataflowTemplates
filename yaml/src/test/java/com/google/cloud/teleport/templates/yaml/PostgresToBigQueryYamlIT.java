...
public class PostgresToBigQueryYamlIT extends JdbcToBigQueryYamlBase {

  @Test
  public void testPostgresToBigQueryYaml() throws IOException {
    ...
    simpleJdbcToBigQueryTest(
        schema, postgresResourceManager, true, Map.of("query", getQueryString()));
  }
}

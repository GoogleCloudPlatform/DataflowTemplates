 ...
 * -Dexec.mainClass=com.infusionsoft.dataflow.templates.PubsubMarkEmailsOpened
 * -Dexec.args="--project=is-email-history-api-sand
 * --stagingLocation=gs://dataflow-is-email-history-api-sand/staging
 * --templateLocation=gs://dataflow-is-email-history-api-sand/templates/ps_mark_email_opened
 ...
 * --templateLocation=gs://dataflow-is-email-history-api-prod/templates/ps_mark_email_opened
...
public class PubsubMarkEmailsOpened {
  ...
  public static class ExtractAndHandleEventsFn extends DoFn<String, String> {
    ...
    private List<Entity> findEmails(
        Datastore datastore, String accountId, String pixelId, String contactId) {
      ...
      final StringBuilder gql =
          new StringBuilder("SELECT * FROM Email")
              ...
              .append(" AND ")
              .append(String.format("pixelId = '%s'", pixelId))
              .append(" AND ")

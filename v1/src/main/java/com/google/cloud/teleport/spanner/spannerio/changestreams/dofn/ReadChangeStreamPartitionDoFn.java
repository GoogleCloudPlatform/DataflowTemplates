...
import com.google.cloud.teleport.spanner.spannerio.changestreams.action.ChildPartitionsRecordAction;
import com.google.cloud.teleport.spanner.spannerio.changestreams.action.DataChangeRecordAction;
import com.google.cloud.teleport.spanner.spannerio.changestreams.action.HeartbeatRecordAction;
import com.google.cloud.teleport.spanner.spannerio.changestreams.action.QueryChangeStreamAction;
...
import com.google.cloud.teleport.spanner.spannerio.changestreams.estimator.NullThroughputEstimator;
...
import com.google.cloud.teleport.spanner.spannerio.changestreams.restriction.ReadChangeStreamPartitionRangeTracker;
import com.google.cloud.teleport.spanner.spannerio.changestreams.restriction.TimestampRange;
import com.google.cloud.teleport.spanner.spannerio.changestreams.restriction.TimestampUtils;
...
public class ReadChangeStreamPartitionDoFn extends DoFn<PartitionMetadata, DataChangeRecord>
   ...
   * com.google.cloud.teleport.spanner.spannerio.changestreams.model.ChangeStreamRecord} model. It
   * uses the {@link ActionFactory} to construct the action dispatchers, which will perform the
   * change stream query and process each type of record received. It emits metrics for the
   * partition using the {@link ChangeStreamMetrics}.
   *

...
import static com.google.cloud.teleport.spanner.spannerio.changestreams.ChangeStreamsConstants.DEFAULT_CHANGE_STREAM_NAME;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.ChangeStreamsConstants.DEFAULT_INCLUSIVE_END_AT;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.ChangeStreamsConstants.DEFAULT_INCLUSIVE_START_AT;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.ChangeStreamsConstants.DEFAULT_RPC_PRIORITY;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.ChangeStreamsConstants.DEFAULT_WATERMARK_REFRESH_RATE;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.ChangeStreamsConstants.MAX_INCLUSIVE_END_AT;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.ChangeStreamsConstants.THROUGHPUT_WINDOW_SECONDS;
...
import com.google.cloud.teleport.spanner.spannerio.changestreams.ChangeStreamsConstants;
import com.google.cloud.teleport.spanner.spannerio.changestreams.MetadataSpannerConfigFactory;
import com.google.cloud.teleport.spanner.spannerio.changestreams.action.ActionFactory;
import com.google.cloud.teleport.spanner.spannerio.changestreams.cache.CacheFactory;
import com.google.cloud.teleport.spanner.spannerio.changestreams.dao.DaoFactory;
import com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataTableNames;
import com.google.cloud.teleport.spanner.spannerio.changestreams.dofn.CleanUpReadChangeStreamDoFn;
import com.google.cloud.teleport.spanner.spannerio.changestreams.dofn.DetectNewPartitionsDoFn;
import com.google.cloud.teleport.spanner.spannerio.changestreams.dofn.InitializeDoFn;
import com.google.cloud.teleport.spanner.spannerio.changestreams.dofn.PostProcessingMetricsDoFn;
import com.google.cloud.teleport.spanner.spannerio.changestreams.dofn.ReadChangeStreamPartitionDoFn;
import com.google.cloud.teleport.spanner.spannerio.changestreams.estimator.BytesThroughputEstimator;
import com.google.cloud.teleport.spanner.spannerio.changestreams.estimator.SizeEstimator;
import com.google.cloud.teleport.spanner.spannerio.changestreams.mapper.MapperFactory;
...
public class SpannerIO {
  ...
  public abstract static class ReadAll
    ...
    public ReadAll withTransaction(
        PCollectionView<com.google.cloud.teleport.spanner.spannerio.Transaction> transaction) {
  ...
  public abstract static class Read extends PTransform<PBegin, PCollection<Struct>> {
    ...
    private com.google.cloud.teleport.spanner.spannerio.SpannerSourceDef createSourceDef() {
    ...
    public PCollection<Struct> expand(PBegin input) {
      ...
      final com.google.cloud.teleport.spanner.spannerio.SpannerSourceDef sourceDef =
          createSourceDef();
  ...
  public abstract static class CreateTransaction
      extends PTransform<
          PInput, PCollectionView<com.google.cloud.teleport.spanner.spannerio.Transaction>> {
      ...
      input
          .apply(
              MapElements.into(TypeDescriptor.of(Mutation.class))
                  .via(
                      com.google.cloud.teleport.spanner.spannerio.MutationUtils.beamRowToMutationFn(
                          operation, table)))
          .apply(write);

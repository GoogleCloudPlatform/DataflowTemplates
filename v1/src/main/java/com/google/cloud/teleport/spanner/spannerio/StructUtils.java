...
final class StructUtils {
  ...
  private static final com.google.cloud.teleport.spanner.spannerio.SpannerIO.Read.ToBeamRowFunction
      STRUCT_TO_BEAM_ROW_FUNCTION = schema -> (Struct struct) -> structToBeamRow(struct, schema);

  public static com.google.cloud.teleport.spanner.spannerio.SpannerIO.Read.ToBeamRowFunction
      structToBeamRow() {
    return STRUCT_TO_BEAM_ROW_FUNCTION;
  }

  private static final com.google.cloud.teleport.spanner.spannerio.SpannerIO.Read
          .FromBeamRowFunction

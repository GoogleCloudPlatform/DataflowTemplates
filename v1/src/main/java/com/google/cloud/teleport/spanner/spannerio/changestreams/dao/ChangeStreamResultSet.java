...
public class ChangeStreamResultSet implements AutoCloseable {
   ...
   *
   * @return a {@link
   *     com.google.cloud.teleport.spanner.spannerio.changestreams.dao.ChangeStreamResultSetMetadata}
   *     contained telemetry information for the query so far
   */
  public com.google.cloud.teleport.spanner.spannerio.changestreams.dao.ChangeStreamResultSetMetadata
      getMetadata() {

...
public class SpannerVectorEmbeddingExport {
  ...
  public interface SpannerToVectorEmbeddingJsonOptions extends PipelineOptions {
    ...
    @TemplateParameter.Text(
        ...
        helpText =
            "Optional: The Spanner endpoint to call in the template. The default value is https://batch-spanner.googleapis.com.",
    ...
    @TemplateParameter.Enum(
        ...
        helpText =
            "Optional: The request priority for Spanner calls. The allowed values are HIGH, MEDIUM, and LOW. The default value is MEDIUM.")

...
public abstract class Placement implements Serializable {
  ...
  @Nullable
  public abstract String instancePartition();

  @Nullable
  public abstract String defaultLeader();
  ...
  public void prettyPrint(Appendable appendable) throws IOException {
    ...
    appendable.append("instance_partition = ")
              .append(String.format("'%s'", instancePartition()));
    if (defaultLeader() != null) {
      appendable.append(", default_leader = ")
                .append(String.format("'%s'", defaultLeader()));
    }
    appendable.append(")");
  }
  ...
  public abstract static class Builder {
    ...
    public abstract Builder instancePartition(String instancePartition);

    public abstract Builder defaultLeader(String defaultLeader);

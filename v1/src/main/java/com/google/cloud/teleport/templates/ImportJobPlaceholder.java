...
public class ImportJobPlaceholder {
  ...
  protected interface ImportJobPlaceholderOptions {
    ...
    @TemplateParameter.Text(
        ...
        helpText = "The ID of the Bigtable application profile to use for the import. If you don't specify an app profile, Bigtable uses the instance's default app profile (https://cloud.google.com/bigtable/docs/app-profiles#default-app-profile).")

...
abstract class NaiveSpannerRead
  ...
  private static class NaiveSpannerReadFn extends DoFn<ReadOperation, Struct> {
    ...
    private final @Nullable PCollectionView<com.google.cloud.teleport.spanner.spannerio.Transaction>
        txView;
    ...
    NaiveSpannerReadFn(
        ...
        @Nullable PCollectionView<com.google.cloud.teleport.spanner.spannerio.Transaction>
            transaction) {
      this.config = config;
    ...
    public void setup() throws Exception {
      ...
      projectId =
          com.google.cloud.teleport.spanner.spannerio.SpannerIO.resolveSpannerProjectId(config);
    }

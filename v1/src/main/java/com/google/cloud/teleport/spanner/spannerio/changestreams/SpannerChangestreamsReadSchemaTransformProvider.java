...
import com.google.cloud.teleport.spanner.spannerio.ReadSpannerSchema;
...
import com.google.cloud.teleport.spanner.spannerio.SpannerSchema;
...
public class SpannerChangestreamsReadSchemaTransformProvider
  ...
  @Override
  public SchemaTransform from(SpannerChangestreamsReadConfiguration configuration) {
  ...
  public static final class DataChangeRecordToRow extends DoFn<DataChangeRecord, Row> {
    ...
    @ProcessElement
    public void process(@Element DataChangeRecord record, MultiOutputReceiver receiver) {
        ...
        .apply(
            ParDo.of(
                new DoFn<SpannerSchema, String>() {
                  @ProcessElement
                  public void process(@Element SpannerSchema schema) {

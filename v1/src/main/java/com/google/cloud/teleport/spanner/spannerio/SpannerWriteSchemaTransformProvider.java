 ...
 *
 * <p>The transformation uses the {@link com.google.cloud.teleport.spanner.spannerio.SpannerIO} to
          ...
          input
              ...
              .apply(
                  MapElements.into(TypeDescriptor.of(Mutation.class))
                      .via(
                          (Row row) ->
                              com.google.cloud.teleport.spanner.spannerio.MutationUtils
                                  .createMutationFromBeamRows(
                                  ...
                                  .map(
                                      mutation ->
                                          Row.withSchema(failureSchema)
                                              ...
                                              .withFieldValue(
                                                  "failed_row",
                                                  com.google.cloud.teleport.spanner.spannerio

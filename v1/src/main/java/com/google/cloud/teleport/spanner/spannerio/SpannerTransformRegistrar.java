...
public class SpannerTransformRegistrar implements ExternalTransformRegistrar {
  ...
  public static class ReadBuilder
    ...
    public static class Configuration extends CrossLanguageConfiguration {
      ...
      public com.google.cloud.teleport.spanner.spannerio.ReadOperation getReadOperation() {
        if (sql != null && table != null) {
          throw new IllegalStateException(
              "Query and table params are mutually exclusive. Set just one of them.");
        }
        com.google.cloud.teleport.spanner.spannerio.ReadOperation readOperation =
    ...
    public PTransform<PBegin, PCollection<Row>> buildExternal(Configuration configuration) {
      ...
      com.google.cloud.teleport.spanner.spannerio.SpannerIO.Read readTransform =
          com.google.cloud.teleport.spanner.spannerio.SpannerIO.read()
      ...
      return new com.google.cloud.teleport.spanner.spannerio.SpannerIO.ReadRows(
          readTransform, configuration.schema);
    }
  }
  ...
  private abstract static class WriteBuilder
    ...
    public PTransform<PCollection<Row>, PDone> buildExternal(Configuration configuration) {
      ...
      com.google.cloud.teleport.spanner.spannerio.SpannerIO.Write writeTransform =
          com.google.cloud.teleport.spanner.spannerio.SpannerIO.write()
              .withProjectId(configuration.projectId)
              .withDatabaseId(configuration.databaseId)
              .withInstanceId(configuration.instanceId);
      ...
      if (configuration.failureMode != null) {
        writeTransform =
            writeTransform.withFailureMode(
                com.google.cloud.teleport.spanner.spannerio.SpannerIO.FailureMode.valueOf(

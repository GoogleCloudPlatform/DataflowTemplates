...
public class DatastoreSchemasCountToText {
  ...
  /**
   * Runs a pipeline which reads in Entities from datastore, parses the Entity's schema, and counts
   * the unique number of schemas.
   *
   * @param args arguments to the pipeline
   */
  public static void main(String[] args) {
    DatastoreSchemaCountToTextOptions options =
    ...
    pipeline
        .apply(
            DatastoreReadSchemaCount.newBuilder()

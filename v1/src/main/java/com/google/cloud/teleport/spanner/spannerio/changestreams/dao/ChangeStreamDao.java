...
public class ChangeStreamDao {
   ...
   * "job=<jobName>"}. The result will be given as a {@link
   * com.google.cloud.teleport.spanner.spannerio.changestreams.dao.ChangeStreamResultSet} which can
   * be consumed as a stream, yielding records until no more are available for the query made. Note
   * that one needs to call {@link
   * com.google.cloud.teleport.spanner.spannerio.changestreams.dao.ChangeStreamResultSet#next()} to
   * initiate the change stream query.
   *
   ...
   * @return a {@link
   *     com.google.cloud.teleport.spanner.spannerio.changestreams.dao.ChangeStreamResultSet} that
   *     will produce a stream of records for the change stream query
   */
  public com.google.cloud.teleport.spanner.spannerio.changestreams.dao.ChangeStreamResultSet
      changeStreamQuery(

 ...
 * the License.
 */
package com.google.cloud.teleport.spanner.spannerio.changestreams.dao;

import static com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataAdminDao.COLUMN_CREATED_AT;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataAdminDao.COLUMN_END_TIMESTAMP;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataAdminDao.COLUMN_FINISHED_AT;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataAdminDao.COLUMN_HEARTBEAT_MILLIS;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataAdminDao.COLUMN_PARENT_TOKENS;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataAdminDao.COLUMN_PARTITION_TOKEN;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataAdminDao.COLUMN_RUNNING_AT;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataAdminDao.COLUMN_SCHEDULED_AT;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataAdminDao.COLUMN_START_TIMESTAMP;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataAdminDao.COLUMN_STATE;
import static com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataAdminDao.COLUMN_WATERMARK;
...
public class PartitionMetadataDao {
  ...
  /**
   * Fetches all partitions with a {@link
   * com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataAdminDao#COLUMN_CREATED_AT}
   * less than the given timestamp. The results are ordered by the {@link
   * com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataAdminDao#COLUMN_CREATED_AT}
   * and {@link
   * com.google.cloud.teleport.spanner.spannerio.changestreams.dao.PartitionMetadataAdminDao#COLUMN_START_TIMESTAMP}

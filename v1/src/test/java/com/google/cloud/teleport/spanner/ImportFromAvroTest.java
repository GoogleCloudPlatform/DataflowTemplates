...
public class ImportFromAvroTest {
  ...
  public void identityColumns() throws Exception {
    SchemaBuilder.RecordBuilder<Schema> record = SchemaBuilder.record("identityColumns");
    SchemaBuilder.FieldAssembler<Schema> fieldAssembler = record.fields();
    ...
    fieldAssembler
        ...
        .requiredLong("id")
        // Integer columns.
        .optionalLong("optional_identity")
        .optionalLong("value");
    Schema schema = fieldAssembler.endRecord();
    String spannerSchema =
        "CREATE TABLE `AvroTable` ("
            ...
            + "`optional_identity` INT64 GENERATED BY DEFAULT AS IDENTITY ("
    ...
    runTest(
        schema,
        spannerSchema,
        Arrays.asList(new GenericRecordBuilder(schema).set("value", 1L).build()));
  }
  ...
  public void pgIdentityColumns() throws Exception {
    ...
    String spannerSchema =
        "CREATE TABLE \"AvroTable\" ("
            ...
            + "  SKIP RANGE 2000 3000 START COUNTER WITH 1000),"
            + "\"optional_identity\" bigint GENERATED BY DEFAULT AS IDENTITY ("
            + "  BIT_REVERSED_POSITIVE SKIP RANGE 2000 3000 START COUNTER WITH 1000),"
            + "\"value\" bigint,"
            + "PRIMARY KEY (\"id\")"
            + ")";
  ...
  public void sequences() throws Exception {
    ...
    String sequence3Def = "CREATE SEQUENCE `Sequence4` SKIP RANGE 0, 1000 START COUNTER WITH 50";
    String sequence4Def =
        "CREATE SEQUENCE `Sequence5` BIT_REVERSED_POSITIVE "
    ...
    SPANNER_SERVER.createDatabase(
        dbName, Arrays.asList(sequenceDef, sequence2Def, sequence3Def, sequence4Def, tableDef));
  ...
  public void pgSequences() throws Exception {
    ...
    String sequenceDef =
        "CREATE SEQUENCE \"PGSequence2\" BIT_REVERSED_POSITIVE"
            + " SKIP RANGE 0 1000 START COUNTER WITH 50";
    String sequence2Def =
        "CREATE SEQUENCE \"PGSequence3\"" + " SKIP RANGE 0 1000 START COUNTER WITH 50";
    String tableDef =
        "CREATE TABLE \"T\" ("
    ...
    SPANNER_SERVER.createPgDatabase(dbName, Arrays.asList(sequenceDef, sequence2Def, tableDef));

  ...
  public void identityColumns() throws Exception {
    ...
    String spannerSchema =
        "CREATE TABLE `AvroTable` ("
            ...
            + "`optional_identity` INT64 GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE),"
            + "`value` INT64,"
            + ") PRIMARY KEY (`id`)";
  ...
  public void pgIdentityColumns() throws Exception {
    ...
    String spannerSchema =
        "CREATE TABLE \"AvroTable\" ("
            ...
            + "\"optional_identity\" bigint GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE),"
            + "\"value\" bigint,"
            + "PRIMARY KEY (\"id\")"
            + ")";

...
public class OrderedCodeTest {
  ...
  abstract static class CodingTestCase<T> {
    ...
    T decodeIncreasing() {
      return decodeIncreasing(
          new com.google.cloud.teleport.spanner.spannerio.OrderedCode(
              bytesFromHexString(increasingBytes())));
    }

    T decodeDecreasing() {
      return decodeDecreasing(
          new com.google.cloud.teleport.spanner.spannerio.OrderedCode(
              bytesFromHexString(decreasingBytes())));
    }

    abstract T decodeIncreasing(
        com.google.cloud.teleport.spanner.spannerio.OrderedCode orderedCode);

    abstract T decodeDecreasing(
        com.google.cloud.teleport.spanner.spannerio.OrderedCode orderedCode);
  }
  ...
  abstract static class UnsignedNumber extends CodingTestCase<Long> {
    ...
    @Override
    Long decodeIncreasing(com.google.cloud.teleport.spanner.spannerio.OrderedCode orderedCode) {
      return orderedCode.readNumIncreasing();
    }

    @Override
    Long decodeDecreasing(com.google.cloud.teleport.spanner.spannerio.OrderedCode orderedCode) {
  ...
  abstract static class BytesTest extends CodingTestCase<String> {
    ...
    @Override
    String decodeIncreasing(com.google.cloud.teleport.spanner.spannerio.OrderedCode orderedCode) {
      return bytesToHexString(orderedCode.readBytes());
    }

    @Override
    String decodeDecreasing(com.google.cloud.teleport.spanner.spannerio.OrderedCode orderedCode) {
  ...
  public void testWriteBytes() {
    ...
    orderedCode = new com.google.cloud.teleport.spanner.spannerio.OrderedCode(firstEncoded);
    orderedCode.writeBytes(second);
    orderedCode.writeBytes(last);
    ...
    orderedCode = new com.google.cloud.teleport.spanner.spannerio.OrderedCode(allEncoded);
    assertArrayEquals(orderedCode.readBytes(), first);
    assertArrayEquals(orderedCode.readBytes(), second);
    assertArrayEquals(orderedCode.readBytes(), last);
  }
  ...
  private static void assertDecodedSignedNumIncreasingEquals(
    ...
    com.google.cloud.teleport.spanner.spannerio.OrderedCode orderedCode =
        new com.google.cloud.teleport.spanner.spannerio.OrderedCode(
            bytesFromHexString(encodedHexString));
    assertEquals(
  ...
  public void testDecreasing() {
    ...
    orderedCode = new com.google.cloud.teleport.spanner.spannerio.OrderedCode();
  ...
  public void testWriteTrailingBytes() {
    byte[] escapeChars =
        new byte[] {
          com.google.cloud.teleport.spanner.spannerio.OrderedCode.ESCAPE1,
          com.google.cloud.teleport.spanner.spannerio.OrderedCode.NULL_CHARACTER,
          com.google.cloud.teleport.spanner.spannerio.OrderedCode.SEPARATOR,
          com.google.cloud.teleport.spanner.spannerio.OrderedCode.ESCAPE2,
          com.google.cloud.teleport.spanner.spannerio.OrderedCode.INFINITY,
          com.google.cloud.teleport.spanner.spannerio.OrderedCode.FF_CHARACTER
        };
  ...
  public void testEdgeCases() {
    byte[] ffChar = {com.google.cloud.teleport.spanner.spannerio.OrderedCode.FF_CHARACTER};
    byte[] nullChar = {com.google.cloud.teleport.spanner.spannerio.OrderedCode.NULL_CHARACTER};

    byte[] separatorEncoded = {
      com.google.cloud.teleport.spanner.spannerio.OrderedCode.ESCAPE1,
      com.google.cloud.teleport.spanner.spannerio.OrderedCode.SEPARATOR
    };
    byte[] ffCharEncoded = {
    ...
    byte[] nullCharEncoded = {
      com.google.cloud.teleport.spanner.spannerio.OrderedCode.ESCAPE2,
      com.google.cloud.teleport.spanner.spannerio.OrderedCode.FF_CHARACTER
    };
    byte[] infinityEncoded = {
      com.google.cloud.teleport.spanner.spannerio.OrderedCode.ESCAPE2,
      com.google.cloud.teleport.spanner.spannerio.OrderedCode.INFINITY
    };
    ...
    orderedCode =
        new com.google.cloud.teleport.spanner.spannerio.OrderedCode(invalidEncodingForRead);
    try {
  ...
  public void testOrderingInfinity() {
    com.google.cloud.teleport.spanner.spannerio.OrderedCode inf =
        new com.google.cloud.teleport.spanner.spannerio.OrderedCode();
    inf.writeInfinity();

    com.google.cloud.teleport.spanner.spannerio.OrderedCode negInf =
        new com.google.cloud.teleport.spanner.spannerio.OrderedCode();
    negInf.writeInfinityDecreasing();

    com.google.cloud.teleport.spanner.spannerio.OrderedCode longValue =
        new com.google.cloud.teleport.spanner.spannerio.OrderedCode();

...
import com.google.cloud.teleport.spanner.spannerio.SpannerIO.BatchableMutationFilterFn;
import com.google.cloud.teleport.spanner.spannerio.SpannerIO.FailureMode;
import com.google.cloud.teleport.spanner.spannerio.SpannerIO.GatherSortCreateBatchesFn;
import com.google.cloud.teleport.spanner.spannerio.SpannerIO.Write;
import com.google.cloud.teleport.spanner.spannerio.SpannerIO.WriteToSpannerFn;
...
public class SpannerIOWriteTest implements Serializable {
  ...
  private static final String FQ_NAME =
      "spanner:"
          + PROJECT_NAME
          + "."
  ...
  private static final String DEFAULT_FQ_NAME =
      "spanner:"
          + DEFAULT_PROJECT
          + "."
          + INSTANCE_CONFIG_NAME
  ...
  public void emptyInstanceId() throws Exception {
    Write write = SpannerIO.write().withDatabaseId("123");
    thrown.expect(NullPointerException.class);
    thrown.expectMessage("requires instance id to be set with");
    write.expand(null);
  }
  ...
  public void emptyDatabaseId() throws Exception {
    Write write = SpannerIO.write().withInstanceId("123");
    thrown.expect(NullPointerException.class);
  ...
  public void singleMutationPipeline() throws Exception {
    ...
    assertThat(Lineage.query(result.metrics(), Lineage.Type.SINK), hasItem(FQ_NAME));
  }
  ...
  public void singleMutationPipelineNoProjectId() throws Exception {
    ...
    assertThat(Lineage.query(result.metrics(), Lineage.Type.SINK), hasItem(DEFAULT_FQ_NAME));
  }
  ...
  public void testRefCountedSpannerAccessorOnlyOnce() {
    ...
    WriteToSpannerFn test1Fn =
        new WriteToSpannerFn(config1, FailureMode.REPORT_FAILURES, null /* failedTag */);
    WriteToSpannerFn test2Fn =
        new WriteToSpannerFn(config1, FailureMode.REPORT_FAILURES, null /* failedTag */);
    WriteToSpannerFn test3Fn =
        new WriteToSpannerFn(config1, FailureMode.REPORT_FAILURES, null /* failedTag */);
  ...
  public void testRefCountedSpannerAccessorDifferentDbsOnlyOnce() {
    ...
    WriteToSpannerFn test3Fn =
        new WriteToSpannerFn(config2, FailureMode.REPORT_FAILURES, null /* failedTag */);
    WriteToSpannerFn test4Fn =
        new WriteToSpannerFn(config2, FailureMode.REPORT_FAILURES, null /* failedTag */);

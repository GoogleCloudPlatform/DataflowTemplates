...
/** Unit tests for {@link PubSubToDatadog}. */
public class PubsubToDatadogTest {
  ...
  public void testStringPubsubMessage() {
    ...
    String formattedPubsubMessage = PubSubToDatadog.formatPubsubMessage(pubsubMessage);

    assertThat(formattedPubsubMessage).contains(PubSubToDatadog.PUBSUB_MESSAGE_DATA_FIELD);
    assertThat(formattedPubsubMessage).contains(PubSubToDatadog.PUBSUB_MESSAGE_ATTRIBUTE_FIELD);

    JsonObject messageJson = GSON.fromJson(formattedPubsubMessage, JsonObject.class);
    assertThat(messageJson.get(PubSubToDatadog.PUBSUB_MESSAGE_DATA_FIELD).getAsString())
        .isEqualTo(payload);
  }
  ...
  public void testJsonPubsubMessage() {
    ...
    JsonObject messageJson = GSON.fromJson(formattedPubsubMessage, JsonObject.class);
    assertThat(messageJson.getAsJsonObject(PubSubToDatadog.PUBSUB_MESSAGE_DATA_FIELD).toString())
        .isEqualTo(payload);
  }
  ...
  public void testPubsubMessageWithComplexAttributes() {
    ...
    JsonObject attributesJson =
        messageJson.getAsJsonObject(PubSubToDatadog.PUBSUB_MESSAGE_ATTRIBUTE_FIELD);

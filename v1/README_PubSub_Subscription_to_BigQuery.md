...
```shell
cd v1/terraform/PubSub_Subscription_to_BigQuery
terraform init
terraform apply
```
...
resource "google_dataflow_job" "pubsub_subscription_to_bigquery" {

  provider          = google-beta
  template_gcs_path = "gs://dataflow-templates-${var.region}/latest/PubSub_Subscription_to_BigQuery"
  name              = "pubsub-subscription-to-bigquery"
  region            = var.region

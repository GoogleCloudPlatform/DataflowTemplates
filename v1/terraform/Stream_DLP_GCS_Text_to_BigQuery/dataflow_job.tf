...
variable "inputFilePattern" {
  type        = string
  description = "The CSV files to read input data records from. Wildcards are also accepted. (Example: gs://mybucket/my_csv_filename.csv or gs://mybucket/file-*.csv)"

}

variable "deidentifyTemplateName" {
  type        = string
  description = "The Sensitive Data Protection de-identification template to use for API requests, specified with the pattern projects/<PROJECT_ID>/deidentifyTemplates/<TEMPLATE_ID>. (Example: projects/your-project-id/locations/global/deidentifyTemplates/generated_template_id)"

}

variable "inspectTemplateName" {
  type        = string
  description = "The Sensitive Data Protection inspection template to use for API requests, specified with the pattern projects/<PROJECT_ID>/identifyTemplates/<TEMPLATE_ID>. (Example: projects/your-project-id/locations/global/inspectTemplates/generated_template_id)"
  default     = null
}

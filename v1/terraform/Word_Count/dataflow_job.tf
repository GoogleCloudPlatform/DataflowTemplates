...
variable "inputFile" {
  type = string
  description = "The input file pattern Dataflow reads from. Use the example file (gs://dataflow-samples/shakespeare/kinglear.txt) or enter the path to your own using the same format: gs://your-bucket/your-file.txt"
}

variable "output" {
  type = string
  description = "Path and filename prefix for writing output files. Ex: gs://your-bucket/counts"
}

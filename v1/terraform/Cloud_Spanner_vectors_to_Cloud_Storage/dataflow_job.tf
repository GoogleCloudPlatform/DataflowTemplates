...
variable "spannerInstanceId" {
  type = string
  description = "The instance ID of the Cloud Spanner from which you want to export the vector embeddings."
}

variable "spannerDatabaseId" {
  type = string
  description = "The database ID of the Cloud Spanner from which you want to export the vector embeddings."
}

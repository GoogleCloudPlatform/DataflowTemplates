...
variable "firestoreDeleteProjectId" {
  type = string
  description = "Google Cloud Project Id of where to delete the firestore entities"
}

variable "firestoreHintNumWorkers" {
  type = number
  description = "Hint for the expected number of workers in the Firestore ramp-up throttling step. Defaults to: 500."
  default = 500
}
...
resource "google_dataflow_job" "generated" {
  parameters = {
    ...
    firestoreDeleteProjectId = var.firestoreDeleteProjectId

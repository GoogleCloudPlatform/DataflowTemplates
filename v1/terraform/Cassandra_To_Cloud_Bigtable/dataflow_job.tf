...
variable "defaultColumnFamily" {
  type = string
  description = "This specifies the default column family to write data into. If no columnFamilyMapping is specified all Columns will be written into this column family. Default value is "default""
  default = "default"
}

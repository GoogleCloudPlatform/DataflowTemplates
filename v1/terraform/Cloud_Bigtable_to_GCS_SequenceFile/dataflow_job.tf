...
variable "bigtableStartRow" {
  type        = string
  description = "The row where to start the export from, defaults to the first row."
  default     = null
}

variable "bigtableStopRow" {
  type        = string
  description = "The row where to stop the export, defaults to the last row."
  default     = null
}

variable "bigtableMaxVersions" {
  type        = number
  description = "Maximum number of cell versions. Defaults to: 2147483647."
  default     = null
}

variable "bigtableFilter" {
  type        = string
  description = "Filter string. See: http://hbase.apache.org/book.html#thrift. Defaults to empty."
  default     = null
}
...
resource "google_dataflow_job" "generated" {
  ...
  parameters = {
    bigtableProject      = var.bigtableProject
    ...
    bigtableStartRow     = var.bigtableStartRow
    bigtableStopRow      = var.bigtableStopRow
    bigtableMaxVersions  = tostring(var.bigtableMaxVersions)
    bigtableFilter       = var.bigtableFilter
    destinationPath      = var.destinationPath

...
variable "inputFilePattern" {
  type        = string
  description = "The Cloud Storage path to the CSV file that contains the text to process. (Example: gs://your-bucket/path/*.csv)"
...
variable "bigQueryLoadingTemporaryDirectory" {
  type        = string
  description = "The temporary directory to use during the BigQuery loading process. (Example: gs://your-bucket/your-files/temp_dir)"
...
variable "delimiter" {
  type        = string
  description = "The column delimiter that the CSV file uses. (Example: ,)"

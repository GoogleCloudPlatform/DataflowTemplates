...
variable "importManifest" {
  type        = string
  description = "The path in Cloud Storage to use when importing manifest files. (Example: gs://your-bucket/your-folder/your-manifest.json)"

}

variable "columnDelimiter" {
  type        = string
  description = "The column delimiter that the source file uses. The default value is ','. (Example: ,)"
  default     = null
}
...
variable "fieldQualifier" {
  type        = string
  description = <<EOT
The character that must surround any value in the source file that contains the columnDelimiter. The default value is ".
EOT
  default     = null
}
...
variable "invalidOutputPath" {
  type        = string
  description = "The Cloud Storage path to use when writing rows that cannot be imported. (Example: gs://your-bucket/your-path). Defaults to empty."
  default     = null
}

...
variable "csvTempDirectory" {
  type        = string
  description = "The Cloud Storage path where temporary CSV files are written. For example, `gs://your-bucket/your-path`"
  default     = null
}
...
resource "google_dataflow_job" "generated" {
  ...
  parameters = {
    csvTempDirectory    = var.csvTempDirectory
    ...
    spannerSnapshotTime = var.spannerSnapshotTime

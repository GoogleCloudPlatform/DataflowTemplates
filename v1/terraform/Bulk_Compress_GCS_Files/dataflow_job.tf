...
variable "compression" {
  type        = string
  description = "The compression algorithm used to compress the matched files. Valid algorithms: BZIP2, DEFLATE, GZIP"

}

variable "outputFilenameSuffix" {
  type        = string
  description = "Output filename suffix of the files to write. Defaults to .bzip2, .deflate or .gz depending on the compression algorithm."
  default     = null
}
...
resource "google_dataflow_job" "generated" {
  ...
  parameters = {
    ...
    outputFailureFile    = var.outputFailureFile

...
variable "firestoreWriteEntityKind" {
  type = string
  description = "Firestore kind under which entities will be written in the output Google Cloud project"
  default = ""
}

variable "firestoreWriteNamespace" {
  type = string
  description = "Firestore namespace under which entities will be written in the output Google Cloud project"
  default = ""
}
...
resource "google_dataflow_job" "generated" {
  parameters = {
    ...
    firestoreWriteEntityKind = var.firestoreWriteEntityKind
    firestoreWriteNamespace = var.firestoreWriteNamespace

...
variable "datastoreWriteEntityKind" {
  type = string
  description = "Datastore kind under which entities will be written in the output Google Cloud project"
  default = ""
}

variable "datastoreWriteNamespace" {
  type = string
  description = "Datastore namespace under which entities will be written in the output Google Cloud project"
  default = ""
}

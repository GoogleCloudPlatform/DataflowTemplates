...
export CASSANDRA_COLUMN_SCHEMA=<cassandraColumnSchema>
...
gcloud dataflow jobs run "cassandra-to-cloud-bigtable-job" \
  ...
  --parameters "cassandraColumnSchema=$CASSANDRA_COLUMN_SCHEMA" \
...
resource "google_dataflow_job" "cassandra_to_cloud_bigtable" {
  ...
  parameters        = {
    ...
    # cassandraColumnSchema = "<cassandraColumnSchema>"
